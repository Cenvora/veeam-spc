...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/users/serviceProvider/localUserRule/{win_principal_id}".format(
            win_principal_id=quote(str(win_principal_id), safe=""),
        ),
        "params": params,
    }
...
) -> Any | ErrorResponse | PatchLocalUserRuleResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchLocalUserRuleResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchLocalUserRuleResponse200 | None:
    """Modify Administrator Portal User or Group
