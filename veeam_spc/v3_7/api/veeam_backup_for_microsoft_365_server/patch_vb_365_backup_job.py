...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/jobs/backup/{vb_365_backup_job_uid}".format(
...
) -> Any | ErrorResponse | PatchVb365BackupJobResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchVb365BackupJobResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchVb365BackupJobResponse200 | None:
    """Modify Veeam Backup for Microsoft 365 Backup Job
