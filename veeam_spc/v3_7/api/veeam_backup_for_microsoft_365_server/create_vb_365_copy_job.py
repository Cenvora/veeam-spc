...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/jobs/copy".format(
...
) -> Any | CreateVb365CopyJobResponse200 | ErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CreateVb365CopyJobResponse200 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (Vb365CopyJob):  Example: {'sourceBackupJobUid':
            '666435cf-38fe-462d-9767-f610d5654d35', 'repositoryUid':
            '686085db-0a20-46b9-8cb6-3cbdf1a2a86f', 'isEnabled': True, 'schedulePolicy':
            {'schedulePolicyType': 'Periodically', 'periodicallyEvery': 'Hours4', 'dailyType':
            'Everyday', 'backupWindowEnabled': False, 'backupWindowSettings': {'backupWindow': [True,
            ...
            True, True, True, True, True, True, True, True, True, True, True, True, True, True, True,
            True, True, True, True, True, True, True, True, True, True, True, True, True, True, True,
            True, True], 'minuteOffset': 0}, 'dailyTime': '07:00'}}.
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | CreateVb365CopyJobResponse200 | ErrorResponse | None:
    """Create Veeam Backup for Microsoft 365 Backup Copy Job
