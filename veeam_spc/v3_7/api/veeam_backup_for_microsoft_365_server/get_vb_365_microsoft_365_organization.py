...
def _get_kwargs(
    ...
    *,
    expand: list[Vb365Microsoft365OrganizationExpand] | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/Microsoft365/{vb_365_organization_uid}".format(
...
) -> Any | ErrorResponse | GetVb365Microsoft365OrganizationResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetVb365Microsoft365OrganizationResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        vb_365_server_uid (UUID):
        vb_365_organization_uid (UUID):
        expand (list[Vb365Microsoft365OrganizationExpand] | Unset):
        select (str | Unset):
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetVb365Microsoft365OrganizationResponse200 | None:
    """Get Microsoft 365 Organization
