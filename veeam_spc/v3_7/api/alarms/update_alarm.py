...
from ...models.update_alarm_response_200 import UpdateAlarmResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/alarms/templates/{alarm_uid}".format(
...
) -> Any | ErrorResponse | UpdateAlarmResponse200:
    if response.status_code == 200:
        response_200 = UpdateAlarmResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | UpdateAlarmResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | UpdateAlarmResponse200 | None:
    """Modify Alarm Template
