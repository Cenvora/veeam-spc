...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/discovery/computers/{computer_uid}/installBackupServer".format(
...
) -> Any | ErrorResponse | InstallBackupServerOnDiscoveryComputerResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | InstallBackupServerOnDiscoveryComputerResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Install Veeam Backup & Replication on Discovered Computer
    ...
    Args:
        ...
        body (VbrDeploymentConfigurationWithCredentials):  Example: {'configuration':
            ...
            'alphaadmin', 'tenantPassword': 'Password1'}}.
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | InstallBackupServerOnDiscoveryComputerResponse200 | None:
    r"""Install Veeam Backup & Replication on Discovered Computer
