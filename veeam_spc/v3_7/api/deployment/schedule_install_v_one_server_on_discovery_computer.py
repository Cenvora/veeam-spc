...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/discovery/computers/{computer_uid}/scheduledTasks/installVOneServer".format(
...
) -> Any | ErrorResponse | ScheduleInstallVOneServerOnDiscoveryComputerResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | ScheduleInstallVOneServerOnDiscoveryComputerResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Schedule Veeam ONE Installation on Discovered Computer
    ...
    Args:
        ...
        body (VOneScheduledDeploymentConfigurationWithCredentials):  Example: {'configuration':
            ...
            'licenseSource': 'LicenseFileContent'}}, 'schedule': {'dateTime':
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | ScheduleInstallVOneServerOnDiscoveryComputerResponse200 | None:
    r"""Schedule Veeam ONE Installation on Discovered Computer
