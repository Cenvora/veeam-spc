...
) -> Any | ErrorResponse | GetBackupServerDeploymentConfigurationXmlResponse200:
    if response.status_code == 200:
        response_200 = GetBackupServerDeploymentConfigurationXmlResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetBackupServerDeploymentConfigurationXmlResponse200]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetBackupServerDeploymentConfigurationXmlResponse200 | None:
    """Get Example for Veeam Backup & Replication Server Deployment Configuration
