...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/voneServers/{v_one_server_uid}/upgrade".format(
...
) -> Any | ErrorResponse | UpgradeVOneServerResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | UpgradeVOneServerResponse200]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        body (VOneDeploymentConfiguration): Deployment configuration.
            ...
            'vspc\\administrator', 'password': 'Password1'}}.
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | UpgradeVOneServerResponse200 | None:
    r"""Update Veeam ONE on Server
