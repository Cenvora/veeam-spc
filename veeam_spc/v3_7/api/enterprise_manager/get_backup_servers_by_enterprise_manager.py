...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/enterpriseManagers/{enterprise_manager_uid}/backupServers".format(
...
) -> Any | ErrorResponse | GetBackupServersByEnterpriseManagerResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetBackupServersByEnterpriseManagerResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetBackupServersByEnterpriseManagerResponse200 | None:
    """Get Backup Servers Managed by Veeam Backup Enterprise Manager Server
