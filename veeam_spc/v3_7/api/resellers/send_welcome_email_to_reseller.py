...
def _get_kwargs(
    reseller_uid: UUID,
    *,
    body: WelcomeEmailOptions | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/resellers/{reseller_uid}/welcomeEmail".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (WelcomeEmailOptions | Unset):  Example: {'password': 'Password1'}.
