...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organizations/resellers/{reseller_uid}/licenseResource".format(
...
) -> Any | ErrorResponse | PatchResellerLicenseResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchResellerLicenseResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchResellerLicenseResourceResponse200 | None:
    """Modify License Management Resource Allocated to Reseller
