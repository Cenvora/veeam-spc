...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organizations/resellers/{reseller_uid}/hostedResources/vb365/{resource_uid}".format(
...
) -> Any | ErrorResponse | PatchResellerVb365ResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchResellerVb365ResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchResellerVb365ResourceResponse200 | None:
    """Modify Reseller Veeam Backup for Microsoft 365 Resource
