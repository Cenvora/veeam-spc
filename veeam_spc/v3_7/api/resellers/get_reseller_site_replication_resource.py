...
) -> Any | ErrorResponse | GetResellerSiteReplicationResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetResellerSiteReplicationResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetResellerSiteReplicationResourceResponse200 | None:
    """Get Reseller Replication Resource
