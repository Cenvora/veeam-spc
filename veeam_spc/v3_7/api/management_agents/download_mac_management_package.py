...
def _get_kwargs(
    *,
    ...
    package_type: DownloadMacManagementPackagePackageType | Unset = DownloadMacManagementPackagePackageType.ZIP,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        package_type (DownloadMacManagementPackagePackageType | Unset):  Default:
