...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/{organization_uid}/configuration/alarms/enable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Enable Organization Alarm Templates
     ...
     Enables all alarm templates, except those preliminarily disabled, for an organization with the
    specified UID.
