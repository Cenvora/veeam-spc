...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/{organization_uid}/configuration/notification/test".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (TestEmailOptions):  Example: {'senderName': None, 'from':
            'notifications@mycompany.com', 'to': 'admin@mycompany.com'}.
