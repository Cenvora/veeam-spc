...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/{organization_uid}/configuration/notification/smtp/test".format(
...
) -> Any | ErrorResponse | TestNotificationSmtpSettingsResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | TestNotificationSmtpSettingsResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (SmtpSettings):  Example: {'serverAddress': 'smtp://smtp1.tech.local:25', 'tlsMode':
            'auto', 'timeout': '00:05:00', 'passwordCredential': None, 'oAuth2Credential': None,
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | TestNotificationSmtpSettingsResponse200 | None:
    """Test SMTP Server Settings
