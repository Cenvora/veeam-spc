...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/sites/publicCloud/appliances/{appliance_uid}/certificate".format(
...
) -> Any | ErrorResponse | GetPublicCloudApplianceCertificateResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetPublicCloudApplianceCertificateResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetPublicCloudApplianceCertificateResponse200 | None:
    """Get Veeam Backup for Public Clouds Appliance Certificate
