...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/voneServers/{v_one_server_uid}/patch/upload/multipart/create".format(
...
) -> Any | CreateVOneServerMultipartPatchResponse200 | ErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CreateVOneServerMultipartPatchResponse200 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreateVOneServerMultipartPatchInput):  Example: {'files': [{'name':
            'Veeam.One.Core.dll', 'fileSize': 180605200}], 'stopAllActivities': True,
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | CreateVOneServerMultipartPatchResponse200 | ErrorResponse | None:
    """Start Veeam ONE Patch Upload to Server
