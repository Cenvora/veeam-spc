...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/infrastructure/sites/{site_uid}/publicCloud/google/appliances/{appliance_uid}".format(
...
) -> Any | ErrorResponse | PatchPublicCloudGoogleApplianceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchPublicCloudGoogleApplianceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchPublicCloudGoogleApplianceResponse200 | None:
    """Modify Veeam Backup for Google Cloud Appliance
