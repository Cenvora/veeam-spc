...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/sites/{site_uid}/vcdServers/vcdOrganizations/vDCs/{vdc_uid}".format(
...
) -> Any | ErrorResponse | GetSiteVcdOrganizationVDCResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetSiteVcdOrganizationVDCResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetSiteVcdOrganizationVDCResponse200 | None:
    """Get Organization VDC Managed by Veeam Cloud Connect Site
