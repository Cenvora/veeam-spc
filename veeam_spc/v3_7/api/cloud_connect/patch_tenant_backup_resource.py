...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/infrastructure/sites/tenants/{tenant_uid}/backupResources/{resource_uid}".format(
...
) -> Any | ErrorResponse | PatchTenantBackupResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchTenantBackupResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchTenantBackupResourceResponse200 | None:
    """Modify Tenant Backup Resource
