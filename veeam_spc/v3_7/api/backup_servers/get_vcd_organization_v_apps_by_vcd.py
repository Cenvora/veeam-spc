...
def _get_kwargs(
    ...
    *,
    ...
    name_sorting_direction: GetVcdOrganizationVAppsByVcdNameSortingDirection
    | Unset = GetVcdOrganizationVAppsByVcdNameSortingDirection.ASCENDING,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/backupServers/{backup_server_uid}/vcdServers/{vcd_server_uid}/vcdOrganizations/vDCs/vApps".format(
...
) -> Any | ErrorResponse | GetVcdOrganizationVAppsByVcdResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetVcdOrganizationVAppsByVcdResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        name_sorting_direction (GetVcdOrganizationVAppsByVcdNameSortingDirection | Unset):
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetVcdOrganizationVAppsByVcdResponse200 | None:
    """Get vApps Configured on VMware Cloud Director Server
