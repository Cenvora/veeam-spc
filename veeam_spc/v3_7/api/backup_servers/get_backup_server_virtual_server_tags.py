...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/backupServers/{backup_server_uid}/servers/virtualCenter/{virtual_center_uid}/tags".format(
...
) -> Any | ErrorResponse | GetBackupServerVirtualServerTagsResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetBackupServerVirtualServerTagsResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Tags from Connected vCenter Server
     ...
     Returns a collection resource representation of all tags collected from a vCenter Server with the
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetBackupServerVirtualServerTagsResponse200 | None:
    """Get Tags from Connected vCenter Server
