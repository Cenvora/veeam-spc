...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/backupServers/{backup_server_uid}/repositories/{repository_uid}".format(
...
) -> Any | ErrorResponse | GetBackupRepositoryResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetBackupRepositoryResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetBackupRepositoryResponse200 | None:
    """Get Backup Repository
