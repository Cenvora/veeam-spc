...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/plugins/{plugin_id}/organizations".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdatePluginOrganizationRulesRequest):  Example: {'allowOrganizationIds':
            ['7f6e5d4c-3b2a-4190-8877-665544332211'], 'denyOrganizationIds': [],
