...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/discovery/rules/windows/networkBased/{rule_uid}".format(
...
) -> Any | ErrorResponse | PatchWindowsNetworkBasedDiscoveryRuleResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchWindowsNetworkBasedDiscoveryRuleResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchWindowsNetworkBasedDiscoveryRuleResponse200 | None:
    """Modify Network-Based Discovery Rule for Windows
