...
def _get_kwargs(
    ...
    *,
    body: DiscoverActiveDirectoryTreeInput | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/managementAgents/{management_agent_uid}/adTree/discover".format(
...
) -> Any | DiscoverActiveDirectoryTreeResponse200 | ErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DiscoverActiveDirectoryTreeResponse200 | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DiscoverActiveDirectoryTreeInput | Unset):  Example: {'discoveryRuleUid':
            'ae61e533-82c7-4cb6-a030-78ae589cf49d', 'serviceAccount': {'userName': 'admin',
            'password': 'Password1'}}.
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | DiscoverActiveDirectoryTreeResponse200 | ErrorResponse | None:
    """Get Active Directory Infrastructure
