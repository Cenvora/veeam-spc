...
from ...models.get_entity_permissions_entity_type import GetEntityPermissionsEntityType
...
def _get_kwargs(
    ...
    *,
    ...
    entity_type: GetEntityPermissionsEntityType,
...
) -> Any | ErrorResponse | GetEntityPermissionsResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetEntityPermissionsResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetEntityPermissionsResponse200 | None:
    """Get Permissions of Veeam Service Provider Console Entity
