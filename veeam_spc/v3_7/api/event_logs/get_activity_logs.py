...
from ...models.get_activity_logs_activity_log_kind import GetActivityLogsActivityLogKind
...
def _get_kwargs(
    *,
    ...
    activity_log_kind: GetActivityLogsActivityLogKind | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        user_uid (UUID | Unset):
        activity_log_kind (GetActivityLogsActivityLogKind | Unset):
