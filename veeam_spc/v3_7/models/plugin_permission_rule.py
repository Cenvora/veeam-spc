...
class PluginPermissionRule:
    """
    Attributes:
        id (str | Unset): ID assigned to an organization or management agent.
        allowed (bool | Unset): Indicates whether an organization or management agent is allowed to access a plugin.
    """
