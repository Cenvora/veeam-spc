...
class ServerCurrentLicenseUsage:
    """
    Attributes:
        server_uid (UUID | Unset): Server UID.
        server_type (ServerCurrentLicenseUsageServerType | Unset): Veeam product installed on the server.
        workloads (list[CurrentLicenseUsageWorkload] | Unset): License usage by each workload type.
    """

    server_uid: UUID | Unset = UNSET
    server_type: ServerCurrentLicenseUsageServerType | Unset = UNSET
    workloads: list[CurrentLicenseUsageWorkload] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        server_uid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_type: ServerCurrentLicenseUsageServerType | Unset
