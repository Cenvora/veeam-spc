...
class CreateBackupServerMultipartPatchInput:
    r"""
    Example:
        {'files': [{'name': 'Veeam.Backup.Core.dll', 'fileSize': 180605200, 'targetDirectory': '\\PatchFolder'}],
            'action': 'ReplaceFilesAndRestart', 'stopAllActivities': True, 'rebootAutomatically': True}
