...
T = TypeVar("T", bound="PatchLabelResponse200")


@_attrs_define
class PatchLabelResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_label_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_label_response_200.additional_properties = d
        return patch_label_response_200
