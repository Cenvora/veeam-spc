...
class BackupServerBackupJobGFSPolicySettings:
    ...
    Attributes:
        ...
        weekly (BackupServerBackupGFSPolicySettingsWeekly | Unset): Weekly long-term retention policy settings.
        monthly (BackupServerBackupJobGFSPolicySettingsMonthly | Unset): Monthly long-term retention policy.
        yearly (BackupServerBackupJobGFSPolicySettingsYearly | Unset): Yearly long-term retention policy.
    """

    is_enabled: bool
    weekly: BackupServerBackupGFSPolicySettingsWeekly | Unset = UNSET
    monthly: BackupServerBackupJobGFSPolicySettingsMonthly | Unset = UNSET
    yearly: BackupServerBackupJobGFSPolicySettingsYearly | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        weekly: BackupServerBackupGFSPolicySettingsWeekly | Unset
        ...
        monthly: BackupServerBackupJobGFSPolicySettingsMonthly | Unset
        ...
        yearly: BackupServerBackupJobGFSPolicySettingsYearly | Unset
