...
class BackupServerAgent:
    ...
    os_type: BackupServerAgentOsType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        license_status: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        license_: BackupServerAgentLicense | Unset
        ...
        license_status: BackupServerAgentLicenseStatus | Unset
        ...
        os_type: BackupServerAgentOsType | Unset
