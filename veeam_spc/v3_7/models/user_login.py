...
class UserLogin:
    ...
    Attributes:
        ...
        company_id (UUID | Unset): UID assigned to a user company.
        company_name (str | Unset): Name of a user company.
        scopes (list[UserLoginScopesItem] | Unset): Services that are available to the user identity.
        parameters (str | Unset): Parameters of a user identity.
        creation_date (datetime.datetime | Unset): Date and time of identity creation.
    """
    ...
    scopes: list[UserLoginScopesItem] | Unset = UNSET
