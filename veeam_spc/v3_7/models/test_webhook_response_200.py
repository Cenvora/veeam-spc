...
T = TypeVar("T", bound="TestWebhookResponse200")


@_attrs_define
class TestWebhookResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WebhookTestResult.from_dict(d.pop("data"))
        ...
        test_webhook_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        test_webhook_response_200.additional_properties = d
        return test_webhook_response_200
