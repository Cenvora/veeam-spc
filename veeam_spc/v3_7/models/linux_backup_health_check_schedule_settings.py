...
class LinuxBackupHealthCheckScheduleSettings:
    ...
    Attributes:
        ...
        weekly_on_days (list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysItem] | Unset): Scheduling settings for
    ...
    weekly_on_days: list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysItem] | Unset = UNSET
