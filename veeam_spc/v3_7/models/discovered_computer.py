...
class DiscoveredComputer:
    ...
    Attributes:
        ...
        backup_agent_version (str | Unset): Veeam backup agent version.
        backup_agent_management_status (DiscoveredComputerBackupAgentManagementStatus | Unset): Veeam backup agent
            management status.
        info (ComputerInfo | Unset): Information about a computer on which a management agent is deployed.
        label (str | Unset): Label assigned to the management agent hosting this computer.
    """
    ...
    backup_agent_management_status: DiscoveredComputerBackupAgentManagementStatus | Unset = UNSET
    info: ComputerInfo | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_agent_management_status: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: DiscoveredComputerStatus | Unset
        ...
        backup_agent_management_status: DiscoveredComputerBackupAgentManagementStatus | Unset
