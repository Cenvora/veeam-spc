...
class PulseLicenseProductWorkload:
    """
    Attributes:
        workload_id (str | Unset): ID addigned to a workload.
        name (str | Unset): Name of a workload.
        multiplier (float | Unset): License unit multiplier for the workload type.
    """

    workload_id: str | Unset = UNSET
    name: str | Unset = UNSET
    multiplier: float | Unset = UNSET
