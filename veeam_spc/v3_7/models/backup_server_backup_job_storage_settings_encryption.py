...
class BackupServerBackupJobStorageSettingsEncryption:
    ...
    Attributes:
        ...
        encryption_password_id (UUID | Unset): ID assigned to a password used for encryption.
            >For exported objects, the property value is `null`.
        encryption_password_tag (str | Unset): Tag used to identify the password.
        kms_server_id (UUID | Unset): ID assigned to a Key Management Server.
    """
    ...
    encryption_password_tag: str | Unset = UNSET
