...
class LinuxCustomDiscoveryRuleInput:
    """
    Example:
        {'name': 'Linux Custom Rule', 'masterAgentUid': 'da463bea-d186-4a14-b809-4aba366b03e8', 'hosts': ['r2val'],
            'credentials': [{'username': 'root', 'password': 'Password1', 'priority': 0, 'description': None, 'sshPort': 22,
            'elevateAccountPrivileges': False, 'addAccountToSudoersFile': False, 'useSuIfsudoFails': False, 'rootPassword':
            '1', 'sshPrivateKey': None, 'passphrase': None, 'type': 'LinuxBased'}], 'filter': None, 'notificationSettings':
            None, 'deploymentSettings': None, 'scheduleSettings': {'scheduleType': 'NotScheduled', 'timeZone': None,
            'dailyScheduleSettings': None, 'monthlyScheduleSettings': None, 'periodicalScheduleSettings': None}}
