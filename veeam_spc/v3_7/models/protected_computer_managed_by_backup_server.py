...
class ProtectedComputerManagedByBackupServer:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a protected computer.
        source_instance_uid (UUID | Unset): Protected computer UID assigned in Veeam Backup & Replication.
        ...
        name (str | Unset): Host name of a protected computer.
        ip_addresses (list[str] | Unset): Computer IP addresses.
        guest_os (str | Unset): Operating system installed on a protected computer.
    ...
    source_instance_uid: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_instance_uid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_instance_uid: UUID | Unset
        ...
        platform_type: ProtectedComputerManagedByBackupServerPlatformType | Unset
        ...
        operation_mode: ProtectedComputerManagedByBackupServerOperationMode | Unset
