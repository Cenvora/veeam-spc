...
class MacBackupHealthCheckScheduleSettings:
    ...
    Attributes:
        ...
        weekly_on_days (list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysItem] | Unset): Scheduling settings for
    ...
    weekly_on_days: list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysItem] | Unset = UNSET
