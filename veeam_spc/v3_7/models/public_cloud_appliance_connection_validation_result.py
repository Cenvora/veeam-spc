...
class PublicCloudApplianceConnectionValidationResult:
    ...
    Attributes:
        ...
        error_message (str | Unset): Error message for failed Veeam Backup for Public Clouds appliance connection.
        certificate (Certificate | Unset):
    """

    error_type: PublicCloudApplianceConnectionValidationErrorType
    certificate_thumbprint: str
    error_message: str | Unset = UNSET
    certificate: Certificate | Unset = UNSET
