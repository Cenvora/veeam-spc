...
class BackupServerEncryptionPasswordInput:
    """
    Example:
        {'password': 'Password1', 'uniqueId': '85690e8b-df4a-446e-8f66-d00ad6e6d2d4', 'hint': 'Standard password',
            'mappedOrganizationUid': '988c4583-5336-4e20-892d-eabcca0b34ac', 'mappedOrganizationName': 'Alpha'}
