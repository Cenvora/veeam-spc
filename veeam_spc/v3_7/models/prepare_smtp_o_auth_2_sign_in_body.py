...
class PrepareSmtpOAuth2SignInBody:
    """
    Example:
        {'clientSettings': {'kind': 'Google', 'clientId': 'REDACTED_CLIENT_ID', 'clientSecret':
            'REDACTED_CLIENT_SECRET', 'scope': None, 'tenantId': None}, 'redirectUrl': 'https://local.vspc.com:1280',
            'state': None}
