...
class OrganizationLicenseUsage:
    """
    Attributes:
        organization_type (OrganizationLicenseUsageOrganizationType | Unset): Organization type.
    ...
    organization_type: OrganizationLicenseUsageOrganizationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_type: OrganizationLicenseUsageOrganizationType | Unset
