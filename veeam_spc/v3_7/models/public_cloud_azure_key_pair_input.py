...
class PublicCloudAzureKeyPairInput:
    """
    Example:
        {'connectionUid': 'da21b612-7f14-46cd-b32f-ec9407212147', 'subscriptionId':
            '8126721b-6b4a-4647-bbd2-259ebf802ff7', 'dataCenterId': '997c5444-8786-48ec-be2a-c3f80a535dfd',
            'resourceGroupName': 'rg-ct-management', 'keyPairName': 'dma-vspc-azure-pc-plugin'}
