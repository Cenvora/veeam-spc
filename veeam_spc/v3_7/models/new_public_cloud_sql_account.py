...
class NewPublicCloudSqlAccount:
    """
    Example:
        {'accountName': 'Admin', 'databaseType': 'AzureSql', 'userName': 'admin', 'password': 'Password1',
            'description': 'Admin credentials', 'applianceUid': '6d18e5fe-20e5-4248-a87f-29a109a44b80'}
