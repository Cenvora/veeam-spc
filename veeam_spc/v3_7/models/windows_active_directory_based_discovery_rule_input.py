...
class WindowsActiveDirectoryBasedDiscoveryRuleInput:
    r"""
    Example:
        {'name': 'Complex AD Rule By Query', 'masterAgentUid': '4ae8db95-8a4e-4a6a-b1fb-89a0d4b8aca5',
            'skipOfflineComputersDays': 45, 'customQuery': 'OU=auto, DC=n, DC=local', 'adMethod': 'Query',
            'useMasterManagementAgentCredentials': True, 'accessAccount': {'userName': 'tech\\administrator', 'password':
            'Password1'}, 'filter': {'exclusionMask': ['string'], 'ignoreInaccessibleMachine': True, 'osTypes':
            ['WindowsServer'], 'applications': ['MicrosoftExchangeServer', 'MicrosoftActiveDirectory'], 'customApplication':
            None, 'platforms': ['MicrosoftHyperVandVmWareVSphere']}, 'notificationSettings': {'isEnabled': True,
            'scheduleType': 'Days', 'scheduleTime': '08:00', 'weekSettings': None, 'to': 'administrator@vspc1.com',
            'subject': 'VSPC Discovery Results', 'notifyOnTheFirstRun': False}, 'deploymentSettings': {'isEnabled': True,
            'backupPolicyUid': '7a8f9468-4c46-4b52-b011-cce3507f6b04', 'setReadOnlyAccess': True, 'backupAgentSettings':
            {'disableScheduledBackups': True, 'disableControlPanelNotification': True, 'disableBackupOverMeteredConnection':
            True, 'disableScheduleWakeup': True, 'throttleBackupActivity': True, 'restrictVpnConnections': True,
            'limitBandwidthConsumption': False, 'bandwidthSpeedLimit': 2, 'bandwidthSpeedLimitUnit': 'MbitPerSec',
            'flrWithoutAdminPrivilegesAllowed': True}}, 'scheduleSettings': {'scheduleType': 'NotScheduled', 'timeZone':
            None, 'dailyScheduleSettings': None, 'monthlyScheduleSettings': None, 'periodicalScheduleSettings': None}}
