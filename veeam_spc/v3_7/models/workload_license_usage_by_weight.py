...
class WorkloadLicenseUsageByWeight:
    """
    Attributes:
        weight (float | Unset): Number of license units consumed by a single workload.
        initial_count (int | Unset): Number of managed Veeam backup agents.
        reported_count (int | Unset): Number of managed Veeam backup agents in a finalized report.
        new_count (int | Unset): Number of managed Veeam backup agents that were activated within the current calendar
            month.
        used_points (float | Unset): Number of license units consumed by all workloads.
    """
