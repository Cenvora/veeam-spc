...
class WindowsBackupJobConfiguration:
    ...
    Attributes:
        ...
        server_mode_settings (WindowsServerModeJobSettings | Unset):
        workstation_mode_settings (WindowsWorkstationModeJobSettings | Unset):
        advanced_settings (WindowsAdvancedJobSettings | Unset):
        gfs_retention_settings (WindowsGfsRetentionSettings | Unset):
    """

    backup_source: WindowsBackupSource
    backup_target: WindowsBackupTarget
    server_mode_settings: WindowsServerModeJobSettings | Unset = UNSET
    workstation_mode_settings: WindowsWorkstationModeJobSettings | Unset = UNSET
    advanced_settings: WindowsAdvancedJobSettings | Unset = UNSET
    gfs_retention_settings: WindowsGfsRetentionSettings | Unset = UNSET
