...
class VbrScheduledPatchConfiguration:
    """
    Example:
        {'configuration': {'allowAutoReboot': True, 'stopAllActivities': True}, 'schedule': {'dateTime':
            '2023-11-18T21:00:08.2424862-06:00'}}

    Attributes:
        configuration (VbrPatchConfiguration):  Example: {'allowAutoReboot': True, 'stopAllActivities': True}.
