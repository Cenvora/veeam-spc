...
class PublicCloudAzureAddExistingApplianceInput:
    """
    Example:
        {'account': {'accountUid': '07e5070f-f170-4a89-8e44-206b56692624', 'subscriptionId': '3a485c0d-3911-48a9-94ff-
            fe325503e892', 'dataCenterId': 'westeurope', 'connectionUid': 'eefa8303-cf95-4912-9ba6-3ba635d2ba86',
            'environment': 'Global'}, 'virtualMachine': {'virtualMachineId':
            '/subscriptions/13e8e398-9860-4de9-9a0c-290d9724c6bf/resourcegroups/dma-vspc-
            pc/providers/microsoft.compute/virtualmachines/dmavspcazurepluginpermanent', 'description': 'Existing appliance
            added.'}, 'network': None, 'guestOsCredentials': {'guestOsCredentialsUid':
            'e2cfa41f-bc14-41e1-b6a0-2fdb04178e37'}}
    ...
    Attributes:
        ...
        network (PublicCloudAzureAddExistingApplianceInputNetwork | Unset):
    """

    account: PublicCloudAzureAddExistingApplianceInputAccount
    virtual_machine: PublicCloudAzureAddExistingApplianceInputVirtualMachine
    guest_os_credentials: PublicCloudAzureAddExistingApplianceInputGuestOsCredentials
    network: PublicCloudAzureAddExistingApplianceInputNetwork | Unset = UNSET
