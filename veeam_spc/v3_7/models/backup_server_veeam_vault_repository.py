...
class BackupServerVeeamVaultRepository:
    ...
    Example:
        {'description': 'Created by Veeam Service Provider Console VSPC1\\Administrator at 3/17/2026 2:03:57 PM.',
            'name': 'ALpha Vault Repository', 'uniqueId': 'F4B1ABA32F964CC5A5DF156E3DF5146E', 'taskLimitEnabled': False,
            'maxTaskCount': 2, 'mountServer': {'type': 'Windows', 'windows': {'mountServerId':
            '6745a759-2205-4cd2-b172-8ec8f7e60ef8', 'vPowerNFSEnabled': True, 'writeCacheFolder':
            'C:\\ProgramData\\Veeam\\Backup\\IRCache\\', 'vPowerNFSPortSettings': None}, 'linux': None}, 'account':
            {'vault': {'vaultId': 'b29dbf9c-93ec-4533-9b51-1df3a4e219f8', 'vaultName': 'vault1', 'storageContainerName':
            'immutable-vbr', 'isInitialized': True, 'folders': []}, 'connectionSettings': {'connectionType': 'Direct',
            'gatewayServerIds': ['6745a759-2205-4cd2-b172-8ec8f7e60ef8']}}, 'container': {'folder': 'backup',
            'storageConsumptionLimit': {'consumptionLimitCount': 10, 'isEnabled': False, 'consumptionLimitKind': 'TB'},
            'immutability': {'isEnabled': True, 'daysCount': 10, 'immutabilityMode': 'RepositorySettings'}}}
