...
class WindowsBackupAgentJob:
    ...
    Attributes:
        ...
        name (str | Unset): Name of a Veeam Agent for Microsoft Windows job.
        description (str | Unset): Description of a Veeam Agent for Microsoft Windows job.
        ...
        last_end_time (datetime.datetime | Unset): Date and time when the latest job session finished.
        ...
        schedule_events (list[WindowsBackupAgentJobScheduleEventsItem] | Unset): Events that trigger the backup job
            launch.
        last_modified_date (datetime.datetime | Unset): Date and time when settings of the backup job were last
            modified.
