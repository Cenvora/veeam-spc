...
class SubscriptionPlanCloudBackup:
    """
    Attributes:
        round_up_used_space (bool | Unset): Indicates whether storage usage cost must be rounded up to a full data block
            cost when the consumed storage space does not match data block size. Default: False.
        vm_cloud_backups_price (float | Unset): Charge rate for storing one VM in backup on a cloud repository, per
            month. Default: 0.0.
        server_cloud_backups_price (float | Unset): Charge rate for storing backup data of one server computer on a
            cloud repository, per month. Default: 0.0.
        workstation_cloud_backups_price (float | Unset): Charge rate for storing backup data for one workstation
            computer on a cloud repository, per month. Default: 0.0.
        cloud_repository_space_usage_algorithm (SubscriptionPlanCloudBackupCloudRepositorySpaceUsageAlgorithm | Unset):
            Type of charge rate for storage space on a cloud repository. Default:
            SubscriptionPlanCloudBackupCloudRepositorySpaceUsageAlgorithm.CONSUMED.
        cloud_repository_allocated_space_price (float | Unset): Charge rate for one GB or TB of allocated storage space
            on a cloud repository. Default: 0.0.
        cloud_repository_allocated_space_units (SubscriptionPlanCloudBackupCloudRepositoryAllocatedSpaceUnits | Unset):
            Measurement units of allocated storage space on a cloud repository. Default:
            SubscriptionPlanCloudBackupCloudRepositoryAllocatedSpaceUnits.GB.
        cloud_repository_consumed_space_price (float | Unset): Charge rate for a block of consumed storage space on a
            cloud repository. Default: 0.0.
        cloud_repository_consumed_space_chunk_size (int | Unset): Size of a block of consumed storage space on a cloud
        ...
        backup_data_transfer_out_price (float | Unset): Charge rate for one GB or TB of data downloaded from a cloud
            repository Default: 0.0.
        backup_data_transfer_out_units (SubscriptionPlanCloudBackupBackupDataTransferOutUnits | Unset): Measurement
            units of data downloaded from a cloud repository. Default:
            SubscriptionPlanCloudBackupBackupDataTransferOutUnits.GB.
        insider_protection_used_space_price (float | Unset): Charge rate for cloud repository space that is consumed by
            deleted backup files. Default: 0.0.
        insider_protection_used_space_units (SubscriptionPlanCloudBackupInsiderProtectionUsedSpaceUnits | Unset):
        ...
        performance_tier_used_space_price (float | Unset): Charge rate for a block of consumed performance tier space.
            Default: 0.0.
        performance_tier_used_space_chunk_size (int | Unset): Size of a consumed performance tier space block. Default:
            1.
        performance_tier_used_space_units (SubscriptionPlanCloudBackupPerformanceTierUsedSpaceUnits | Unset):
        ...
        capacity_tier_used_space_price (float | Unset): Charge rate for a block of consumed capacity tier space.
            Default: 0.0.
        capacity_tier_used_space_chunk_size (int | Unset): Size of a consumed capacity tier space block. Default: 1.
        capacity_tier_used_space_units (SubscriptionPlanCloudBackupCapacityTierUsedSpaceUnits | Unset): Measurement
            units of consumed capacity tier space. Default: SubscriptionPlanCloudBackupCapacityTierUsedSpaceUnits.GB.
        archive_tier_used_space_price (float | Unset): Charge rate for a block of consumed archive tier space. Default:
            0.0.
        archive_tier_used_space_chunk_size (int | Unset): Size of a consumed archive tier space block. Default: 1.
        archive_tier_used_space_units (SubscriptionPlanCloudBackupArchiveTierUsedSpaceUnits | Unset): Measurement units
            of consumed archive tier space. Default: SubscriptionPlanCloudBackupArchiveTierUsedSpaceUnits.GB.
    """

    round_up_used_space: bool | Unset = False
    vm_cloud_backups_price: float | Unset = 0.0
    server_cloud_backups_price: float | Unset = 0.0
    workstation_cloud_backups_price: float | Unset = 0.0
    cloud_repository_space_usage_algorithm: SubscriptionPlanCloudBackupCloudRepositorySpaceUsageAlgorithm | Unset = (
        SubscriptionPlanCloudBackupCloudRepositorySpaceUsageAlgorithm.CONSUMED
    )
    cloud_repository_allocated_space_price: float | Unset = 0.0
    cloud_repository_allocated_space_units: SubscriptionPlanCloudBackupCloudRepositoryAllocatedSpaceUnits | Unset = (
        SubscriptionPlanCloudBackupCloudRepositoryAllocatedSpaceUnits.GB
    )
    cloud_repository_consumed_space_price: float | Unset = 0.0
    cloud_repository_consumed_space_chunk_size: int | Unset = 1
    cloud_repository_consumed_space_units: SubscriptionPlanCloudBackupCloudRepositoryConsumedSpaceUnits | Unset = (
        SubscriptionPlanCloudBackupCloudRepositoryConsumedSpaceUnits.TB
    )
    ...
    backup_data_transfer_out_price: float | Unset = 0.0
    backup_data_transfer_out_units: SubscriptionPlanCloudBackupBackupDataTransferOutUnits | Unset = (
        SubscriptionPlanCloudBackupBackupDataTransferOutUnits.GB
    )
    insider_protection_used_space_price: float | Unset = 0.0
    insider_protection_used_space_units: SubscriptionPlanCloudBackupInsiderProtectionUsedSpaceUnits | Unset = (
        SubscriptionPlanCloudBackupInsiderProtectionUsedSpaceUnits.GB
    )
    performance_tier_used_space_price: float | Unset = 0.0
    performance_tier_used_space_chunk_size: int | Unset = 1
    performance_tier_used_space_units: SubscriptionPlanCloudBackupPerformanceTierUsedSpaceUnits | Unset = (
        SubscriptionPlanCloudBackupPerformanceTierUsedSpaceUnits.GB
    )
    capacity_tier_used_space_price: float | Unset = 0.0
    capacity_tier_used_space_chunk_size: int | Unset = 1
    capacity_tier_used_space_units: SubscriptionPlanCloudBackupCapacityTierUsedSpaceUnits | Unset = (
        SubscriptionPlanCloudBackupCapacityTierUsedSpaceUnits.GB
    )
    archive_tier_used_space_price: float | Unset = 0.0
    archive_tier_used_space_chunk_size: int | Unset = 1
    archive_tier_used_space_units: SubscriptionPlanCloudBackupArchiveTierUsedSpaceUnits | Unset = (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cloud_repository_space_usage_algorithm: str | Unset = UNSET
        ...
        cloud_repository_allocated_space_units: str | Unset = UNSET
        ...
        cloud_repository_consumed_space_units: str | Unset = UNSET
        ...
        backup_data_transfer_out_units: str | Unset = UNSET
        ...
        insider_protection_used_space_units: str | Unset = UNSET
        ...
        performance_tier_used_space_units: str | Unset = UNSET
        ...
        capacity_tier_used_space_units: str | Unset = UNSET
        ...
        archive_tier_used_space_units: str | Unset = UNSET
