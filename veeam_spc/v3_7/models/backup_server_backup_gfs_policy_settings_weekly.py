...
class BackupServerBackupGFSPolicySettingsWeekly:
    ...
    Attributes:
        ...
        keep_for_number_of_weeks (int | Unset): Number of weeks during which restore points must be stored.
        desired_time (BackupServerBackupGFSPolicySettingsWeeklyDesiredTime | Unset): Day of the week when the weekly
            retore point must be created.
    """

    is_enabled: bool
    keep_for_number_of_weeks: int | Unset = UNSET
    desired_time: BackupServerBackupGFSPolicySettingsWeeklyDesiredTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        desired_time: BackupServerBackupGFSPolicySettingsWeeklyDesiredTime | Unset
