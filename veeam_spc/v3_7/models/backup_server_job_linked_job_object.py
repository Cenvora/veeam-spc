...
class BackupServerJobLinkedJobObject:
    ...
    Attributes:
        ...
        linked_job_uid (UUID | Unset): UID assigned to the linked backup job in Veeam Service Provider Console.
    """

    job_uid: UUID | Unset = UNSET
    unique_job_uid: UUID | Unset = UNSET
    linked_job_uid: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        linked_job_uid: str | Unset = UNSET
