...
class ResellerVb365ResourceInput:
    """
    Example:
        {'vb365ServerUid': 'cac1f37d-a177-4cd6-a08b-852cb40dcad7', 'friendlyName': 'VBM365 Resource',
            'vb365RepositoriesUids': ['215c8f93-b1a6-4ab9-9849-c45e94976000']}
    ...
    Attributes:
        ...
        vb_365_repositories_uids (list[UUID] | Unset): Array of UIDs assigned to Veeam Backup for Microsoft 365 backup
            repositories.
    """

    vb_365_server_uid: UUID
    friendly_name: str
    vb_365_repositories_uids: list[UUID] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        vb_365_repositories_uids: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vb_365_repositories_uids: list[UUID] | Unset = UNSET
        if _vb_365_repositories_uids is not UNSET:
            vb_365_repositories_uids = []
            for vb_365_repositories_uids_item_data in _vb_365_repositories_uids:
