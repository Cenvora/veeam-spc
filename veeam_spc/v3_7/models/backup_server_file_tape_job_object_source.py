...
class BackupServerFileTapeJobObjectSource:
    """
    Attributes:
        path (str | Unset): Path to a location where protected files and folders reside.
        type_ (BackupServerFileTapeJobObjectSourceType | Unset): Type of a protected unit.
    """

    path: str | Unset = UNSET
    type_: BackupServerFileTapeJobObjectSourceType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: BackupServerFileTapeJobObjectSourceType | Unset
