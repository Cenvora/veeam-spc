...
class BackupAgentSettings:
    """
    Example:
        {'backupAgentUid': '07773b42-89fb-7227-9c6a-95e6908f25de', 'disableScheduledBackups': True,
            'disableControlPanelNotification': True, 'disableBackupOverMeteredConnection': True, 'disableScheduleWakeup':
            False, 'throttleBackupActivity': True, 'restrictVpnConnections': False, 'limitBandwidthConsumption': True,
            'bandwidthSpeedLimit': 10, 'bandwidthSpeedLimitUnit': 'MbytePerSec', 'flrWithoutAdminPrivilegesAllowed': True}
