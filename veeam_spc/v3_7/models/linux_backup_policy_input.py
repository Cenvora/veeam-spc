...
class LinuxBackupPolicyInput:
    """
    Example:
        {'name': 'LinuxSrvtEntireCloud', 'description': '', 'operationMode': 'Server', 'accessMode': 'Public',
            'createSubtenants': True, 'unlimitedSubtenantQuota': False, 'repositoryQuotaGB': 100, 'jobConfiguration':
            ...
            'passwordHint': None, 'isSnapshotRequired': True}, 'indexingSettings': None, 'scriptSettings': None,
            'retentionSettings': {'restorePointsCount': 7, 'retentionDays': 7}, 'scheduleSettings': {'scheduleType':
            'NotScheduled', 'dailyScheduleSettings': {'time': '00:30', 'dailyMode': 'Everyday', 'specificDays': None},
            'monthlyScheduleSettings': None, 'periodicallyScheduleSettings': None, 'activeFullSettings': None,
            'retrySettings': {'enabled': False, 'retryTimes': 3, 'waitTimeoutMinutes': 10},
            'backupHealthCheckScheduleSettings': None, 'syntheticFullSettings': None}, 'applicationAwareProcessingSettings':
    ...
    Attributes:
        ...
        description (str | Unset): Backup policy description. Default: ''.
        create_subtenants (bool | Unset): Defines whether a subtenant must be created for each Veeam Agent for Linux.
