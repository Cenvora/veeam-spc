...
class LinuxBackupSource:
    ...
    Attributes:
        ...
        volume_level_options (LinuxVolumeLevelBackupSource | Unset):
        file_level_options (LinuxFileLevelBackupSource | Unset):
    """

    backup_mode: LinuxBackupSourceBackupMode
    volume_level_options: LinuxVolumeLevelBackupSource | Unset = UNSET
    file_level_options: LinuxFileLevelBackupSource | Unset = UNSET
