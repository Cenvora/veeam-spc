...
class ProtectedVirtualMachineBackupRestorePoint:
    ...
    Attributes:
        ...
        virtual_machine_uid (UUID | Unset): UID assigned to a protected virtual machine.
        ...
        tier (SobrRepositoryTier | Unset): Tier of a target repository in case it is an extent of a scale-out backup
            repository.
    ...
    tier: SobrRepositoryTier | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        virtual_machine_uid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_machine_uid: UUID | Unset
        ...
        gfs_type: list[ProtectedVirtualMachineBackupRestorePointGfsTypeItem] | Unset = UNSET
        if _gfs_type is not UNSET:
            gfs_type = []
            for gfs_type_item_data in _gfs_type:
        ...
        tier: SobrRepositoryTier | Unset
        if isinstance(_tier, Unset):
            tier = UNSET
        else:
            tier = SobrRepositoryTier(_tier)
