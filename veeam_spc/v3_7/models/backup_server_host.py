...
class BackupServerHost:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a server.
        name (str | Unset): Host name of a server.
        backup_server_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        type_ (BackupServerHostType | Unset): Type of a server.
    """

    instance_uid: UUID | Unset = UNSET
    name: str | Unset = UNSET
    backup_server_uid: UUID | Unset = UNSET
    type_: BackupServerHostType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: BackupServerHostType | Unset
