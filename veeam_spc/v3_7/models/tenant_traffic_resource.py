...
class TenantTrafficResource:
    ...
    Attributes:
        ...
        is_data_transfer_out_quota_unlimited (bool | Unset): Indicates whether the amount of data transfer out traffic
            available to a company is unlimited. Default: True.
    """
