...
class EnterpriseManagerBackupServer:
    ...
    Attributes:
        ...
        address (str | Unset): DNS name or IP address of a Veeam Backup & Replication server.
        port (int | Unset): Port used by Veeam Backup Service.
        backup_server (BackupServer | Unset):  Example: {'instanceUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'name':
    ...
    backup_server: BackupServer | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_server: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server: BackupServer | Unset
