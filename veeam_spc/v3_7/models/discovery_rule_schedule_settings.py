...
class DiscoveryRuleScheduleSettings:
    ...
    Attributes:
        ...
        time_zone (TimeZone | Unset):
        daily_schedule_settings (DiscoveryRuleDailyScheduleSettings | Unset):
        monthly_schedule_settings (DiscoveryRuleMonthlyScheduleSettings | Unset):
        periodical_schedule_settings (DiscoveryRulePeriodicalScheduleSettings | Unset):
    """

    schedule_type: DiscoveryRuleScheduleSettingsScheduleType = DiscoveryRuleScheduleSettingsScheduleType.NOTSCHEDULED
    time_zone: TimeZone | Unset = UNSET
    daily_schedule_settings: DiscoveryRuleDailyScheduleSettings | Unset = UNSET
    monthly_schedule_settings: DiscoveryRuleMonthlyScheduleSettings | Unset = UNSET
    periodical_schedule_settings: DiscoveryRulePeriodicalScheduleSettings | Unset = UNSET
