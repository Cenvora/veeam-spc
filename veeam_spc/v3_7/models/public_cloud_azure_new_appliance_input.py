...
class PublicCloudAzureNewApplianceInput:
    """
    Example:
        {'account': {'connectionUid': 'de26c441-b776-4aff-bcc3-9f8336d06b1a', 'environment': 'Global',
            'resourceGroupName': 'dma-vspc-pc', 'subscriptionId': '0381fa98-9d97-4b9a-923a-4746bdd9fbcb', 'dataCenterId':
            'westeurope', 'accountUid': '91bd2d80-e9ba-4a62-9b3a-2f6ee26a40ba'}, 'virtualMachine': {'virtualMachineName':
            'dmaVspcAzurePluginTemporary', 'description': 'Created at [1:47:35 PM] by [PortalAdministrator]'}, 'network':
            {'networkId': '/subscriptions/0381fa98-9d97-4b9a-923a-4746bdd9fbcb/resourcegroups/dma-vspc-
            pc/providers/microsoft.network/virtualnetworks/dma-vspc-pc-net', 'subnetName': 'default', 'securityGroupId':
            '/subscriptions/0381fa98-9d97-4b9a-923a-4746bdd9fbcb/resourcegroups/dma-vspc-
            pc/providers/microsoft.network/networksecuritygroups/dma-vspc-pc-sg'}, 'ipAddress': {'backupServerIpAddresses':
            '89.296.226.25', 'applianceIp': {'applianceIpAddressId': None, 'newIpAddressType': 'dynamic'}},
            'guestOsCredentials': {'guestOsCredentialsUid': 'f7d20bb9-4c56-46d6-aedc-738e77d104a2', 'keyPairName': 'dma-
            vspc-azure-plugin', 'timeZoneId': 'Etc/GMT+2'}}
    ...
    Attributes:
        ...
        network (PublicCloudAzureNewApplianceInputNetwork | Unset): Veeam Backup for Public Clouds appliance network
            resources.
    ...
    ip_address: PublicCloudAzureNewApplianceInputIpAddress
    guest_os_credentials: PublicCloudAzureNewApplianceInputGuestOsCredentials
    network: PublicCloudAzureNewApplianceInputNetwork | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network: PublicCloudAzureNewApplianceInputNetwork | Unset
