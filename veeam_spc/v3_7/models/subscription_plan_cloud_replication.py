...
class SubscriptionPlanCloudReplication:
    """
    Attributes:
        replicated_vm_price (float | Unset): Charge rate for one VM replica registered on a cloud host, per month.
            Default: 0.0.
        cloud_storage_consumed_space_price (float | Unset): Charge rate for one GB or TB of cloud storage space consumed
            by VM replica files. Default: 0.0.
        ...
        free_cloud_storage_consumed_space_units (SubscriptionPlanCloudReplicationFreeCloudStorageConsumedSpaceUnits |
            Unset): Measurement units of cloud storage space that can be consumed by VM replicas for free. Default:
            SubscriptionPlanCloudReplicationFreeCloudStorageConsumedSpaceUnits.GB.
        compute_resources_price (float | Unset): Charge rate for a CPU and memory resources usage by a VM on a cloud
            host. Default: 0.0.
        compute_resources_units (SubscriptionPlanCloudReplicationComputeResourcesUnits | Unset): Measurement units of
            time period of CPU and memory resources usage by a VM on a cloud host Default:
            SubscriptionPlanCloudReplicationComputeResourcesUnits.HOURS.
        free_compute_resources (int | Unset): Amount of time during which VM replicas can consume compute resources on a
            cloud host for free. Default: 0.
        free_compute_resources_units (SubscriptionPlanCloudReplicationFreeComputeResourcesUnits | Unset): Measurement
            units of time during which VM replicas can consume compute resources on a cloud host for free. Default:
            SubscriptionPlanCloudReplicationFreeComputeResourcesUnits.MINUTES.
        replication_data_transfer_out_price (float | Unset): Charge rate for one GB or TB of VM replica data downloaded
            from cloud storage. Default: 0.0.
        replication_data_transfer_out_units (SubscriptionPlanCloudReplicationReplicationDataTransferOutUnits | Unset):
            Measurement units of VM replica data downloaded from cloud storage. Default:
            SubscriptionPlanCloudReplicationReplicationDataTransferOutUnits.GB.
    """

    replicated_vm_price: float | Unset = 0.0
    cloud_storage_consumed_space_price: float | Unset = 0.0
    cloud_storage_consumed_space_units: SubscriptionPlanCloudReplicationCloudStorageConsumedSpaceUnits | Unset = (
        SubscriptionPlanCloudReplicationCloudStorageConsumedSpaceUnits.TB
    )
    ...
    compute_resources_price: float | Unset = 0.0
    compute_resources_units: SubscriptionPlanCloudReplicationComputeResourcesUnits | Unset = (
        SubscriptionPlanCloudReplicationComputeResourcesUnits.HOURS
    )
    free_compute_resources: int | Unset = 0
    free_compute_resources_units: SubscriptionPlanCloudReplicationFreeComputeResourcesUnits | Unset = (
        SubscriptionPlanCloudReplicationFreeComputeResourcesUnits.MINUTES
    )
    replication_data_transfer_out_price: float | Unset = 0.0
    replication_data_transfer_out_units: SubscriptionPlanCloudReplicationReplicationDataTransferOutUnits | Unset = (
        SubscriptionPlanCloudReplicationReplicationDataTransferOutUnits.GB
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cloud_storage_consumed_space_units: str | Unset = UNSET
        ...
        compute_resources_units: str | Unset = UNSET
        ...
        free_compute_resources_units: str | Unset = UNSET
        ...
        replication_data_transfer_out_units: str | Unset = UNSET
