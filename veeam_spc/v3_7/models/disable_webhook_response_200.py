...
T = TypeVar("T", bound="DisableWebhookResponse200")


@_attrs_define
class DisableWebhookResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WebhookConfiguration.from_dict(d.pop("data"))
        ...
        disable_webhook_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        disable_webhook_response_200.additional_properties = d
        return disable_webhook_response_200
