...
class WindowsBackupSource:
    ...
    Attributes:
        ...
        computer_level_options (WindowsComputerLevelBackupSource | Unset):
        volume_level_options (WindowsVolumeLevelBackupSource | Unset):
        file_level_options (WindowsFileLevelBackupSource | Unset):
    """

    backup_mode: WindowsBackupSourceBackupMode
    computer_level_options: WindowsComputerLevelBackupSource | Unset = UNSET
    volume_level_options: WindowsVolumeLevelBackupSource | Unset = UNSET
    file_level_options: WindowsFileLevelBackupSource | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        backup_mode = self.backup_mode.value

        computer_level_options: dict[str, Any] | Unset = UNSET
        if not isinstance(self.computer_level_options, Unset):
            computer_level_options = self.computer_level_options.to_dict()

        volume_level_options: dict[str, Any] | Unset = UNSET
        if not isinstance(self.volume_level_options, Unset):
            volume_level_options = self.volume_level_options.to_dict()

        file_level_options: dict[str, Any] | Unset = UNSET
