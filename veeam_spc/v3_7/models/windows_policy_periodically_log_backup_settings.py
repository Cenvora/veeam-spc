...
class WindowsPolicyPeriodicallyLogBackupSettings:
    """
    Attributes:
        backup_logs_every_min (int | Unset): Frequency for archived logs backup, in minutes. Default: 15.
        backup_retention_mode (WindowsPolicyPeriodicallyLogBackupSettingsBackupRetentionMode | Unset): Type of a
        ...
        keep_backups_only_last_days (int | Unset): Number of days for which archived logs are kept. Default: 15.
    """

    backup_logs_every_min: int | Unset = 15
    backup_retention_mode: WindowsPolicyPeriodicallyLogBackupSettingsBackupRetentionMode | Unset = (
        WindowsPolicyPeriodicallyLogBackupSettingsBackupRetentionMode.UNTILBACKUPISDELETED
    )
    keep_backups_only_last_days: int | Unset = 15
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        backup_logs_every_min = self.backup_logs_every_min

        backup_retention_mode: str | Unset = UNSET
