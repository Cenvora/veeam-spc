...
class CloudTenant:
    """
    Example:
        {'type': 'General', 'vCloudOrganizationUid': None, 'isLeaseExpirationEnabled': False, 'leaseExpirationDate':
            None, 'credentials': {'userName': 'admin', 'password': 'Password1'}, 'description': 'Tenant for Alpha company',
            'isThrottlingEnabled': False, 'throttlingValue': None, 'throttlingUnit': None, 'maxConcurrentTask': 1,
            'isBackupProtectionEnabled': False, 'backupProtectionPeriod': None, 'gatewaySelectionType':
            'StandaloneGateways', 'gatewayPoolsUids': [], 'isGatewayFailoverEnabled': False,
