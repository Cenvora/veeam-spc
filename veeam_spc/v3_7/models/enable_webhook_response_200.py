...
T = TypeVar("T", bound="EnableWebhookResponse200")


@_attrs_define
class EnableWebhookResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_webhook_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        enable_webhook_response_200.additional_properties = d
        return enable_webhook_response_200
