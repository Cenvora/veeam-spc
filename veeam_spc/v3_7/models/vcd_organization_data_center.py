...
class VcdOrganizationDataCenter:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to an organization VDC.
        urn (str | Unset): URN of an organization VDC. That identifier must be used on working with Vcd job
            configuration.
        vcd_organization_uid (UUID | Unset): UID assigned to a VMware Cloud Director organization.
        vcd_organization_name (str | Unset): Name of a VMware Cloud Director organization.
        ...
        name (str | Unset): Name of an organization VDC.
    """
