...
class PublicCloudGoogleVirtualMachine:
    """
    Attributes:
        virtual_machine_name (str | Unset): Name of a Google Cloud VM.
        virtual_machine_id (str | Unset): ID assigned to a Google Cloud VM.
        availability_zone_id (str | Unset): ID assigned to an availability zone.
    """
