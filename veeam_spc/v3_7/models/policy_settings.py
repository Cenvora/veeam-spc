...
class PolicySettings:
    ...
    Attributes:
        ...
        redirecting_to_vbr_web_ui_enabled (bool): Indicates whether Veeam Backup & Replication Web UI proxying is
            enabled.
        webhooks_enabled (bool): Indicates whether webhooks are enabled for this organization.
        ...
        redirecting_to_vbr_web_ui_enabled_by_manager (bool | Unset): Indicates whether Veeam Backup & Replication Web UI
            proxying is enabled by parent organizations.
        webhooks_enabled_by_manager (bool | Unset): Indicates whether webhooks are enabled by parent organizations.
    """
    ...
    webhooks_enabled_by_manager: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        webhooks_enabled_by_manager = self.webhooks_enabled_by_manager
        ...
        if webhooks_enabled_by_manager is not UNSET:
            field_dict["webhooksEnabledByManager"] = webhooks_enabled_by_manager
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhooks_enabled = d.pop("webhooksEnabled")
        ...
        webhooks_enabled_by_manager = d.pop("webhooksEnabledByManager", UNSET)
        ...
        policy_settings = cls(
            ...
            webhooks_enabled_by_manager=webhooks_enabled_by_manager,
        )
