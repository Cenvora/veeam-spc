...
T = TypeVar("T", bound="InstallLinuxVbrManagementAgentResponse200")


@_attrs_define
class InstallLinuxVbrManagementAgentResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_linux_vbr_management_agent_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_linux_vbr_management_agent_response_200.additional_properties = d
        return install_linux_vbr_management_agent_response_200
