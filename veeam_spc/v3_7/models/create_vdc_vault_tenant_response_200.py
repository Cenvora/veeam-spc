...
T = TypeVar("T", bound="CreateVdcVaultTenantResponse200")


@_attrs_define
class CreateVdcVaultTenantResponse200:
    """
    Attributes:
        data (VdcVaultTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VdcVaultTenant.from_dict(d.pop("data"))
        ...
        create_vdc_vault_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_vdc_vault_tenant_response_200.additional_properties = d
        return create_vdc_vault_tenant_response_200
