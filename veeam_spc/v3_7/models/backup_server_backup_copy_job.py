...
class BackupServerBackupCopyJob:
    ...
    Attributes:
        ...
        target_repository_uid (UUID | Unset): UID assigned to a target repository.
        ...
        yearly_restore_points_to_keep (int | Unset): Number of years during which the yearly backup must be stored on
            the target repository.
        retention_policy_type (BackupServerBackupCopyJobRetentionPolicyType | Unset): Type of a retention policy of a
            backup copy job.
        ...
        rpo_options_unit (BackupServerBackupCopyJobRpoOptionsUnit | Unset): Measurement units of a desired RPO interval
            value.
    ...
    retention_policy_type: BackupServerBackupCopyJobRetentionPolicyType | Unset = UNSET
    is_rpo_options_enabled: bool | Unset = UNSET
    rpo_options_value: int | Unset = UNSET
    rpo_options_unit: BackupServerBackupCopyJobRpoOptionsUnit | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_type: BackupServerBackupCopyJobRetentionPolicyType | Unset
        ...
        rpo_options_unit: BackupServerBackupCopyJobRpoOptionsUnit | Unset
