...
class CompanyHostedVbrResourceInput:
    """
    Example:
        {'serverUid': '6f213654-b538-4695-ac69-aa677e41862e', 'friendlyName': 'Alpha VBR 2', 'isJobSchedulingEnabled':
            False, 'isWholeServerAssigned': False}
    ...
    Attributes:
        ...
        is_job_scheduling_enabled (bool | Unset): Defines whether job schedule can be enabled. Default: False.
        company_uid (UUID | Unset): UID assigned to a company.
        is_whole_server_assigned (bool | Unset):  Default: False.
    """

    server_uid: UUID
    friendly_name: str
    instance_uid: UUID | Unset = UNSET
    is_job_scheduling_enabled: bool | Unset = False
    company_uid: UUID | Unset = UNSET
    is_whole_server_assigned: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_whole_server_assigned = self.is_whole_server_assigned
        ...
        if is_whole_server_assigned is not UNSET:
            field_dict["isWholeServerAssigned"] = is_whole_server_assigned
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_whole_server_assigned = d.pop("isWholeServerAssigned", UNSET)
        ...
        company_hosted_vbr_resource_input = cls(
            ...
            is_whole_server_assigned=is_whole_server_assigned,
        )
