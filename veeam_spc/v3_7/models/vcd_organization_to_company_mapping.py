...
class VcdOrganizationToCompanyMapping:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a mapping of a VMware Cloud Director organization to a company.
        ...
        backup_server_uid (UUID | Unset): UID assigned to a hosted Veeam Backup & Replication server.
