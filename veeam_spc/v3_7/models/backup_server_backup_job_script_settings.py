...
class BackupServerBackupJobScriptSettings:
    ...
    Attributes:
        ...
        windows_scripts (BackupServerBackupJobWindowsScript | Unset): Paths to pre-freeze and post-thaw scripts for
            Microsoft Windows VMs.
        linux_scripts (BackupServerBackupJobLinuxScript | Unset): Paths to pre-freeze and post-thaw scripts for Linux
            VMs.
    """

    script_processing_mode: BackupServerBackupJobScriptProcessingMode
    windows_scripts: BackupServerBackupJobWindowsScript | Unset = UNSET
    linux_scripts: BackupServerBackupJobLinuxScript | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_scripts: BackupServerBackupJobWindowsScript | Unset
        ...
        linux_scripts: BackupServerBackupJobLinuxScript | Unset
