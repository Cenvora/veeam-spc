...
class ProtectedComputerManagedByConsole:
    """
    Attributes:
        backup_agent_uid (UUID | Unset): UID assigned to a backup agent installed on a computer.
        organization_uid (UUID | Unset): UID assigned to an organization.
        name (str | Unset): Host name of a protected computer.
        number_of_jobs (int | Unset): Number of jobs.
        operation_mode (ProtectedComputerManagedByConsoleOperationMode | Unset): Operation mode.
    ...
    number_of_jobs: int | Unset = UNSET
    operation_mode: ProtectedComputerManagedByConsoleOperationMode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operation_mode: ProtectedComputerManagedByConsoleOperationMode | Unset
