...
class TestSmtpSettingsResponse:
    ...
    Attributes:
        ...
        smtp_settings (SmtpSettings | Unset):  Example: {'serverAddress': 'smtp://smtp1.tech.local:25', 'tlsMode':
            'auto', 'timeout': '00:05:00', 'passwordCredential': None, 'oAuth2Credential': None,
            'exclusivelyAcceptedCertificateHash': None}.
        server_certificate (SmtpServerCertificateInfo | Unset): Server X509 certificate information.
        error (ResponseError | Unset):
    """

    result: TestSmtpSettingsResponseResult
    smtp_settings: SmtpSettings | Unset = UNSET
    server_certificate: SmtpServerCertificateInfo | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        server_certificate: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_certificate: SmtpServerCertificateInfo | Unset
