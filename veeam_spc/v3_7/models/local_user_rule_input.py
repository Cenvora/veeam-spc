...
class LocalUserRuleInput:
    """
    Example:
        {'sid': 'S-1-5-21-3655030342-2499544343-4802907742-1002', 'name': 'PortalAdmin', 'description': 'Created by
            admin', 'enabled': True, 'roleType': 'portalAdministrator', 'contextType': 'machine', 'scope': [{'type': 'all',
            'objectUid': None}], 'mfaPolicyStatus': 'disabled', 'hasAccessToProvider': None}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_type: LocalUserRuleRoleType | Unset
