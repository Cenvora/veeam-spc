...
class WindowsOracleTransactionLogHandlingSettings:
    """
    Attributes:
        credentials (WindowsOracleAccountSettings | Unset):
        archived_logs_retention_mode (WindowsOracleTransactionLogHandlingSettingsArchivedLogsRetentionMode | Unset):
            Archived log processing mode. Default:
            WindowsOracleTransactionLogHandlingSettingsArchivedLogsRetentionMode.DONOTDELETEARCHIVEDLOGS.
        backup_life_time_hours (int | Unset): Amount of time after which archived logs must be deleted, in hours.
            > Required for the `DeleteLogsOlderThanHours` archived log processing mode.
             Default: 24.
        backup_size_threshold_gb (int | Unset): Maximum threshold for archived log file size, in GB.
            ...
            > Required for the `DeleteLogsOverGb` archived log processing mode.
             Default: 10.
        backup_logs_periodically (bool | Unset): Indicates whether Veeam Agent for Microsoft Windows must back up
            archive logs. Default: False.
        periodically_backup_setting (WindowsPolicyPeriodicallyLogBackupSettings | Unset):
    """

    credentials: WindowsOracleAccountSettings | Unset = UNSET
    archived_logs_retention_mode: WindowsOracleTransactionLogHandlingSettingsArchivedLogsRetentionMode | Unset = (
        WindowsOracleTransactionLogHandlingSettingsArchivedLogsRetentionMode.DONOTDELETEARCHIVEDLOGS
    )
    backup_life_time_hours: int | Unset = 24
    backup_size_threshold_gb: int | Unset = 10
    backup_logs_periodically: bool | Unset = False
    periodically_backup_setting: WindowsPolicyPeriodicallyLogBackupSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        archived_logs_retention_mode: str | Unset = UNSET
        ...
        periodically_backup_setting: dict[str, Any] | Unset = UNSET
