...
class SingleLicenseReport:
    """
    Attributes:
        report_status (SingleLicenseReportReportStatus | Unset): License usage report status.
        report_parameters (LicenseReportParameters | Unset):
        report_summary (LicenseReportSummary | Unset):
        organizations_usage (list[OrganizationLicenseUsage] | Unset): Number of license points used by managed
            organizations.
        not_collected_cloud_servers (list[str] | Unset): Array of Veeam Cloud Connect servers from which Veeam Service
            Provider Console could not collect the license usage data.
        cloned_cloud_servers (list[str] | Unset): Array of cloned Veeam Cloud Connect servers.
        unsupported_cloud_servers (list[str] | Unset): Array of unsupported Veeam Cloud Connect servers.
        usage_details (list[OrganizationUsageOfLicensesWithSameSupportId] | Unset): Usage of licenses with the same
            support ID.
        appendices (list[LicenseReportAppendix] | Unset): Usage of licenses issued to organizations other than report
            owner.
    """

    report_status: SingleLicenseReportReportStatus | Unset = UNSET
    report_parameters: LicenseReportParameters | Unset = UNSET
    report_summary: LicenseReportSummary | Unset = UNSET
    organizations_usage: list[OrganizationLicenseUsage] | Unset = UNSET
    not_collected_cloud_servers: list[str] | Unset = UNSET
    cloned_cloud_servers: list[str] | Unset = UNSET
    unsupported_cloud_servers: list[str] | Unset = UNSET
    usage_details: list[OrganizationUsageOfLicensesWithSameSupportId] | Unset = UNSET
    appendices: list[LicenseReportAppendix] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        organizations_usage: list[dict[str, Any]] | Unset = UNSET
        ...
        usage_details: list[dict[str, Any]] | Unset = UNSET
        ...
        appendices: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        report_status: SingleLicenseReportReportStatus | Unset
        ...
        organizations_usage: list[OrganizationLicenseUsage] | Unset = UNSET
        if _organizations_usage is not UNSET:
            organizations_usage = []
            for organizations_usage_item_data in _organizations_usage:
        ...
        usage_details: list[OrganizationUsageOfLicensesWithSameSupportId] | Unset = UNSET
        if _usage_details is not UNSET:
            usage_details = []
            for usage_details_item_data in _usage_details:
        ...
        appendices: list[LicenseReportAppendix] | Unset = UNSET
        if _appendices is not UNSET:
            appendices = []
            for appendices_item_data in _appendices:
