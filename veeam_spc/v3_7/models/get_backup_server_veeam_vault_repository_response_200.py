...
T = TypeVar("T", bound="GetBackupServerVeeamVaultRepositoryResponse200")


@_attrs_define
class GetBackupServerVeeamVaultRepositoryResponse200:
    r"""
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_backup_server_veeam_vault_repository_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_backup_server_veeam_vault_repository_response_200.additional_properties = d
        return get_backup_server_veeam_vault_repository_response_200
