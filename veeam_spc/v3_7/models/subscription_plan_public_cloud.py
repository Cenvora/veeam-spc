...
class SubscriptionPlanPublicCloud:
    """
    Attributes:
        remote_cloud_vm_price (float | Unset): Charge rate for a managed remote public cloud VM. Default: 0.0.
        remote_free_cloud_vms (int | Unset): Number of remote public cloud VMs that are managed for free. Default: 0.
        remote_cloud_file_share_price (float | Unset): Charge rate for a managed remote public cloud file share.
            Default: 0.0.
        remote_free_cloud_file_shares (int | Unset): Number of remote public cloud file shares that are managed for
            free. Default: 0.
        remote_cloud_database_price (float | Unset): Charge rate for a managed remote public cloud database. Default:
            0.0.
        remote_free_cloud_databases (int | Unset): Number of remote public cloud databases that are managed for free.
            Default: 0.
        remote_cloud_network_price (float | Unset): Charge rate for a managed remote public cloud network. Default: 0.0.
        remote_backup_used_space_price (float | Unset): Charge rate for one GB or TB of consumed space on remote public
        ...
        remote_archive_used_space_price (float | Unset): Charge rate for one GB or TB of consumed space on remote
        ...
        hosted_cloud_vm_price (float | Unset): Charge rate for a managed hosted public cloud VM. Default: 0.0.
        hosted_free_cloud_vms (int | Unset): Number of hosted public cloud VMs that are managed for free. Default: 0.
        hosted_cloud_file_share_price (float | Unset): Charge rate for a managed hosted public cloud file share.
            Default: 0.0.
        hosted_free_cloud_file_shares (int | Unset): Number of hosted public cloud file shares that are managed for
            free. Default: 0.
        hosted_cloud_database_price (float | Unset): Charge rate for a managed hosted public cloud database. Default:
            0.0.
        hosted_free_cloud_databases (int | Unset): Number of hosted public cloud databases that are managed for free.
            Default: 0.
        hosted_cloud_network_price (float | Unset): Charge rate for a managed hosted public cloud network. Default: 0.0.
        hosted_backup_used_space_price (float | Unset): Charge rate for one GB or TB of consumed space on a hosted
        ...
        hosted_archive_used_space_price (float | Unset): Charge rate for one GB or TB of consumed space on a hosted
            public cloud archive repository. Default: 0.0.
    ...
    remote_cloud_vm_price: float | Unset = 0.0
    remote_free_cloud_vms: int | Unset = 0
    remote_cloud_file_share_price: float | Unset = 0.0
    remote_free_cloud_file_shares: int | Unset = 0
    remote_cloud_database_price: float | Unset = 0.0
    remote_free_cloud_databases: int | Unset = 0
    remote_cloud_network_price: float | Unset = 0.0
    ...
    remote_archive_used_space_price: float | Unset = 0.0
    ...
    hosted_cloud_vm_price: float | Unset = 0.0
    hosted_free_cloud_vms: int | Unset = 0
    hosted_cloud_file_share_price: float | Unset = 0.0
    hosted_free_cloud_file_shares: int | Unset = 0
    hosted_cloud_database_price: float | Unset = 0.0
    hosted_free_cloud_databases: int | Unset = 0
    hosted_cloud_network_price: float | Unset = 0.0
    ...
    hosted_archive_used_space_price: float | Unset = 0.0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        remote_archive_used_space_units: str | Unset = UNSET
        ...
        hosted_archive_used_space_units: str | Unset = UNSET
