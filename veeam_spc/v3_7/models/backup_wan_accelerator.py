...
class BackupWanAccelerator:
    ...
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a WAN accelerator.
        name (str | Unset): Name of a WAN accelerator.
        backup_server_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        version (str | Unset): Version of a WAN accelerator service.
        host_uid (UUID | Unset): UID assigned to a computer that performs a role of a WAN accelerator.
        host_name (str | Unset): Name of a computer that performs a role of a WAN accelerator.
        is_out_of_date (bool | Unset): Indicates whether a WAN accelerator service is outdated.
        status (BackupWanAcceleratorStatus | Unset): WAN accelerator status.
        is_cloud (bool | Unset): Indicates whether a WAN accelerator is used in the Veeam Cloud Connect infrastructure.
    """
    ...
    status: BackupWanAcceleratorStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: BackupWanAcceleratorStatus | Unset
