...
class WindowsSqlServerTransactionLogHandlingSettings:
    """
    Attributes:
        credentials (WindowsMsSqlAccountSettings | Unset):
        logs_processing_mode (WindowsSqlServerTransactionLogHandlingSettingsLogsProcessingMode | Unset): Transaction log
            processing mode. Default: WindowsSqlServerTransactionLogHandlingSettingsLogsProcessingMode.TRUNCATELOGS.
        periodically_backup_setting (WindowsPolicyPeriodicallyLogBackupSettings | Unset):
    """

    credentials: WindowsMsSqlAccountSettings | Unset = UNSET
    logs_processing_mode: WindowsSqlServerTransactionLogHandlingSettingsLogsProcessingMode | Unset = (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        logs_processing_mode: str | Unset = UNSET
