...
T = TypeVar("T", bound="GetVdcVaultSubscriptionResponse200")


@_attrs_define
class GetVdcVaultSubscriptionResponse200:
    """
    Attributes:
        data (VdcVaultSubscription):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VdcVaultSubscription.from_dict(d.pop("data"))
        ...
        get_vdc_vault_subscription_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_subscription_response_200.additional_properties = d
        return get_vdc_vault_subscription_response_200
