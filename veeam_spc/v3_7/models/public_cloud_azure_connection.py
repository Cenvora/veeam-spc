...
class PublicCloudAzureConnection:
    """
    Attributes:
        connection_uid (UUID | Unset): UID assigned to a Microsoft Azure connection.
    """

    connection_uid: UUID | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        connection_uid: str | Unset = UNSET
