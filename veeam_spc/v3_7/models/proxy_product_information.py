...
class ProxyProductInformation:
    """
    Attributes:
        proxy_product (ProxyProduct | Unset): Veeam product that accepts proxied requests.
        proxy_product_url_representation (str | Unset): Part of URL path that must be used to proxy requests to a Veeam
            product.
    """

    proxy_product: ProxyProduct | Unset = UNSET
    proxy_product_url_representation: str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        proxy_product: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        proxy_product: ProxyProduct | Unset
