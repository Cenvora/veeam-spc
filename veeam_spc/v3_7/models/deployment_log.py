...
class DeploymentLog:
    """
    Attributes:
        complete_percentage (int | Unset): Percentage of deployment progress.
        status (DeploymentLogStatus | Unset): Deployment status.
        log_entries (list[DeploymentLogEntry] | Unset): Log entry containing details about deployment process.
    """

    complete_percentage: int | Unset = UNSET
    status: DeploymentLogStatus | Unset = UNSET
    log_entries: list[DeploymentLogEntry] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: DeploymentLogStatus | Unset
