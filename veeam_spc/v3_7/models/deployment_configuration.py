...
class DeploymentConfiguration:
    """
    Example:
        {'backupPolicyUid': '70069387-2799-489b-9592-4b11c55012d7', 'allowAutoRebootIfNeeded': True,
            'setReadOnlyAccess': True, 'installCbtDriver': False, 'credentials': None, 'backupAgentSettings': None}
    ...
    Attributes:
        ...
        set_read_only_access (bool | Unset): Indicates whether the read-only access mode is enabled for Veeam backup
            agents. Default: True.
        install_cbt_driver (bool | Unset): Indicates whether CBT driver is installed during agent deployment. Default:
            False.
        credentials (DomainCredentials | Unset):
    ...
    credentials: DomainCredentials | Unset = UNSET
