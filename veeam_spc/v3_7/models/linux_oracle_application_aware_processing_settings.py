...
class LinuxOracleApplicationAwareProcessingSettings:
    """
    Attributes:
        processing_type (LinuxOracleApplicationAwareProcessingSettingsProcessingType | Unset): Processing type. Default:
            LinuxOracleApplicationAwareProcessingSettingsProcessingType.DISABLEPROCESS.
        credentials (LinuxBaseCredentials | Unset):
        truncation_config (LinuxOracleArchivedLogsTruncationConfig | Unset):
        use_oracle_credentials (bool | Unset): Indicates whether the Oracle account credentials must be used. Default:
            False.
    """

    processing_type: LinuxOracleApplicationAwareProcessingSettingsProcessingType | Unset = (
        LinuxOracleApplicationAwareProcessingSettingsProcessingType.DISABLEPROCESS
    )
    credentials: LinuxBaseCredentials | Unset = UNSET
    truncation_config: LinuxOracleArchivedLogsTruncationConfig | Unset = UNSET
    use_oracle_credentials: bool | Unset = False
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        processing_type: str | Unset = UNSET
        ...
        truncation_config: dict[str, Any] | Unset = UNSET
