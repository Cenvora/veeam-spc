...
class EnterpriseManager:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a Veeam Backup Enterprise Manager server.
        name (str | Unset): Host name of a Veeam Backup Enterprise Manager server.
        management_agent_uid (UUID | Unset): UID assigned to a management agent installed on a Veeam Backup Enterprise
            Manager server.
        installation_uid (UUID | Unset): UID assigned to a Veeam Backup Enterprise Manager installation.
        version (str | Unset): Version of a Veeam Backup Enterprise Manager.
        status (EnterpriseManagerStatus | Unset): Status of a Veeam Backup Enterprise Manager server.
    """
    ...
    status: EnterpriseManagerStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: EnterpriseManagerStatus | Unset
