...
class PublicCloudGuestOsCredentialsInput:
    ...
    Example:
        {'role': 'serviceProviderAdministrator', 'username': 'admin', 'description': 'Service Provider Admin
            Credentials', 'password': 'Password1', 'siteUid': 'e5d94dfc-0861-42ef-b929-7265eead92cc'}
