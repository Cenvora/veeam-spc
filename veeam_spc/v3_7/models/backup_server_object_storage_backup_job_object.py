...
class BackupServerObjectStorageBackupJobObject:
    ...
    Attributes:
        ...
        name (str | Unset): Name of an object storage.
        sources (list[BackupServerFileJobObjectSource] | Unset): Processed files and folders.
        last_session (BackupServerObjectStorageBackupJobObjectLastSession | Unset):
    """
    ...
    last_session: BackupServerObjectStorageBackupJobObjectLastSession | Unset = UNSET
