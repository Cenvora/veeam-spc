...
class BackupFailoverPlanObject:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a VM included in a failover plan.
        plan_uid (UUID | Unset): UID assigned to a failover plan.
        name (str | Unset): Name of a VM included in a failover plan.
        host_name (str | Unset): Name of a host running the VM.
        folder_name (str | Unset): Name of a folder that contains replicas.
        path (str | Unset): Path to a folder that contains replicas.
        backup_server_uid (UUID | Unset): Veeam Backup & Replication server on which a failover plan is configured.
        restore_session (BackupFailoverPlanRestoreSession | Unset):
    """

    instance_uid: UUID | Unset = UNSET
    plan_uid: UUID | Unset = UNSET
    name: str | Unset = UNSET
    host_name: str | Unset = UNSET
    folder_name: str | Unset = UNSET
    path: str | Unset = UNSET
    backup_server_uid: UUID | Unset = UNSET
    restore_session: BackupFailoverPlanRestoreSession | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        restore_session: dict[str, Any] | Unset = UNSET
