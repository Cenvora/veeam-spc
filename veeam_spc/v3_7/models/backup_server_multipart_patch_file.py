...
class BackupServerMultipartPatchFile:
    """
    Attributes:
        name (str | Unset): Name of a file included in a Veeam Backup & Replication server patch upload.
        file_stream_uid (UUID | Unset): UID assigned a file included in a Veeam Backup & Replication server patch
            upload.
    """

    name: str | Unset = UNSET
    file_stream_uid: UUID | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        name = self.name

        file_stream_uid: str | Unset = UNSET
