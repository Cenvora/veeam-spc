...
class ProxySession:
    """
    Attributes:
        user_uid (UUID | Unset): UID of a user that created a proxy session.
        management_agent_uid (UUID | Unset): UID assigned to a management agent.
        product (ProxyProduct | Unset): Veeam product that accepts proxied requests.
        creation_time (datetime.datetime | Unset): Date and time when a proxy session was created.
        last_action_time (datetime.datetime | Unset): Date and time of the latest action performed inside a proxy
            session.
    """

    user_uid: UUID | Unset = UNSET
    management_agent_uid: UUID | Unset = UNSET
    product: ProxyProduct | Unset = UNSET
    creation_time: datetime.datetime | Unset = UNSET
    last_action_time: datetime.datetime | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_action_time: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        last_action_time: datetime.datetime | Unset
