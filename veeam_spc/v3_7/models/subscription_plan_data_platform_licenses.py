...
class SubscriptionPlanDataPlatformLicenses:
    """
    Attributes:
        vm_price (float | Unset): Monthly charge rate for a licensed VM protected by Veeam Backup & Replication.
            Default: 0.0.
        workstation_price (float | Unset): Monthly charge rate for a licensed workstation protected by Veeam Backup &
            Replication. Default: 0.0.
        server_price (float | Unset): Monthly charge rate for a licensed server protected by Veeam Backup & Replication.
            Default: 0.0.
        application_price (float | Unset): Monthly charge rate for a licensed application protected by Veeam Backup &
            Replication. Default: 0.0.
        microsoft_entra_id_price (float | Unset): Monthly charge rate for a licensed Microsoft Entra ID protected by
            Veeam Backup & Replication. Default: 0.0.
        file_share_price (float | Unset): Monthly charge rate for a licensed file share protected by Veeam Backup &
            Replication. Default: 0.0.
        object_storage_price (float | Unset): Monthly charge rate for a licensed object storage protected by Veeam
            Backup & Replication. Default: 0.0.
        cloud_vm_price (float | Unset): Monthly charge rate for a licensed cloud VM protected by Veeam Backup &
            Replication. Default: 0.0.
        cloud_file_share_price (float | Unset): Monthly charge rate for a licensed cloud file share protected by Veeam
            Backup & Replication. Default: 0.0.
        cloud_database_price (float | Unset): Monthly charge rate for a licensed cloud database protected by Veeam
            Backup & Replication. Default: 0.0.
    """

    vm_price: float | Unset = 0.0
    workstation_price: float | Unset = 0.0
    server_price: float | Unset = 0.0
    application_price: float | Unset = 0.0
    microsoft_entra_id_price: float | Unset = 0.0
    file_share_price: float | Unset = 0.0
    object_storage_price: float | Unset = 0.0
    cloud_vm_price: float | Unset = 0.0
    cloud_file_share_price: float | Unset = 0.0
    cloud_database_price: float | Unset = 0.0
