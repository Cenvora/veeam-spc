...
class ActiveAlarm:
    ...
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a triggered alarm.
        alarm_template_uid (UUID | Unset): UID assigned to an alarm template.
        repeat_count (int | Unset): Number of times that an alarm changed its status.
        object_ (AlarmObject | Unset):
        last_activation (AlarmActivation | Unset):
        area (ActiveAlarmArea | Unset): Alarm area.
    """

    instance_uid: UUID | Unset = UNSET
    alarm_template_uid: UUID | Unset = UNSET
    repeat_count: int | Unset = UNSET
    object_: AlarmObject | Unset = UNSET
    last_activation: AlarmActivation | Unset = UNSET
    area: ActiveAlarmArea | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        alarm_template_uid: str | Unset = UNSET
        ...
        last_activation: dict[str, Any] | Unset = UNSET
