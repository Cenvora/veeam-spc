...
class BackupServerWinLocalRepository:
    r"""
    Example:
        {'description': 'Created by MyCompany admin', 'name': 'LocalRepo2', 'hostId':
            '6d18e5fe-20e5-4248-a87f-29a109a44b80', 'importBackup': False, 'importIndex': False, 'repository':
            {'maxTaskCount': 10, 'path': '\\Backups', 'readWriteLimitEnabled': False, 'readWriteRate': 0,
