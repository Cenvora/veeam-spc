...
class WindowsBackupPolicyInput:
    r"""
    Example:
        {'name': 'WWrkstEntireCloud', 'description': 'temp description', 'operationMode': 'Workstation', 'accessMode':
            'Public', 'createSubtenants': True, 'createSubFolders': False, 'unlimitedSubtenantQuota': False,
            'repositoryQuotaGb': 1, 'jobConfiguration': {'backupSource': {'backupMode': 'EntireComputer',
            'computerLevelOptions': {'includeUsbDrives': True}, 'volumeLevelOptions': None, 'fileLevelOptions': None},
            'backupTarget': {'targetType': 'CloudRepository', 'localPath': None, 'sharedFolder': None, 'backupRepository':
            None, 'cloudRepository': {'backupCacheSettings': {'location': 'C:\\string', 'maximumSizeGb': 1}}},
            'serverModeSettings': {'retentionSettings': {'retentionMode': 'RestorePoints', 'retentionCount': 7},
            'scheduleSetting': {'scheduleType': 'Daily', 'dailyScheduleSettings': {'time': '00:30', 'dailyMode': 'Everyday',
            'specificDays': None}, 'monthlyScheduleSettings': None, 'periodicalScheduleSettings': None,
            'continuousScheduleSettings': {'backupWindowSettings': {'scheduleWindow': None, 'shiftForMinutes': 0}},
            'retrySettings': {'enabled': True, 'retryTimes': 3, 'waitTimeoutMinutes': 10}, 'backupWindow': None},
            'indexingSettings': None, 'applicationAwareProcessingSettings': {'enabled': False,
            'transactionLogProcessingMode': 'ProcessTransactionLogsWithJob', 'sqlServerTransactionLogHandlingSettings':
            None, 'oracleTransactionLogHandlingSettings': None, 'sharePointAccountSettings': None, 'scriptSettings': None}},
            'workstationModeSettings': {'scheduleSetting': {'periodicalScheduleEnabled': True, 'periodicalScheduleSettings':
            {'dailyScheduleSettings': {'time': '00:30', 'dailyMode': 'Everyday', 'specificDays': None}, 'shutdownAction':
            'SkipBackup', 'finalizingAction': 'KeepRunning'}, 'eventTriggerSettings': {'backupOnLock': False,
            'backupOnLogOff': False, 'backupOnTargetConnection': False, 'ejectTargetOnBackupComplete': False,
            'backupNotOften': 3, 'notOftenTimeUnit': 'Hours'}}, 'retentionSettings': {'retentionDays': 7}},
            'advancedSettings': {'backupStorage': {'compressionLevel': 'Optimal', 'storageOptimization': 'Local1MB',
            'encryptionEnabled': False, 'password': None, 'passwordHint': None}, 'scheduleSettings': None,
            'maintenanceSettings': None}, 'gfsRetentionSettings': None}}
    ...
    Attributes:
        ...
        create_subtenants (bool | Unset): Defines whether a subtenant must be created for each Veeam Agent for Microsoft
            ...
            > Available if a cloud repository is selected as backup destination.
             Default: True.
        create_sub_folders (bool | Unset): Defines whether a subfolder must be created for each Veeam Agent for
            Microsoft Windows on the shared folder.
            > Available if a shared folder is selected as backup destination.
             Default: False.
        unlimited_subtenant_quota (bool | Unset): Defines whether a subtenant can consume unlimited amount of space on a
            repository.
            > Available if a cloud repository is selected as backup destination.
             Default: False.
