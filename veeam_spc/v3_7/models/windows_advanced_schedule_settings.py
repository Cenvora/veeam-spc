...
class WindowsAdvancedScheduleSettings:
    """
    Attributes:
        synthetic_full_settings (MonthlyOrWeeklyScheduleWithDaySettings | Unset):
        active_full_settings (MonthlyOrWeeklyScheduleWithDaySettings | Unset):
    """

    synthetic_full_settings: MonthlyOrWeeklyScheduleWithDaySettings | Unset = UNSET
    active_full_settings: MonthlyOrWeeklyScheduleWithDaySettings | Unset = UNSET
