...
class TenantReplicationResourceInput:
    """
    Example:
        {'hardwarePlans': [{'hardwarePlanUid': 'ae61e533-82c7-4cb6-a030-78ae589cf49d', 'isWanAccelerationEnabled':
            False, 'wanAcceleratorUid': None}], 'isFailoverCapabilitiesEnabled': False, 'isPublicAllocationEnabled': False,
            'numberOfPublicIps': 0}
