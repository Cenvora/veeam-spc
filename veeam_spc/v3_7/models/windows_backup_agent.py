...
class WindowsBackupAgent:
    ...
    Attributes:
        ...
        management_agent_uid (UUID | Unset): UID assigned to a management agent that is deployed along with Veeam backup
            agent.
        cbt_driver_status (WindowsBackupAgentCbtDriverStatus | Unset): CBT driver status.
    """

    instance_uid: UUID | Unset = UNSET
    management_agent_uid: UUID | Unset = UNSET
    cbt_driver_status: WindowsBackupAgentCbtDriverStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cbt_driver_status: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cbt_driver_status: WindowsBackupAgentCbtDriverStatus | Unset
