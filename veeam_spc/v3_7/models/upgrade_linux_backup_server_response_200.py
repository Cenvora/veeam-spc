...
T = TypeVar("T", bound="UpgradeLinuxBackupServerResponse200")


@_attrs_define
class UpgradeLinuxBackupServerResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upgrade_linux_backup_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        upgrade_linux_backup_server_response_200.additional_properties = d
        return upgrade_linux_backup_server_response_200
