...
class MacCustomJobConfiguration:
    """
    Example:
        {'name': 'ServerEntireCloud_Custom', 'description': 'Mac Policy', 'operationMode': 'Server',
            'cloudRepositoryConnectionSettings': {'backupResourceUid': '28428289-2557-41b5-a51d-95730a24f23a', 'username':
            'admin', 'password': None}, 'jobConfiguration': {'backupSource': {'backupDirectlyFromLiveFileSystem': True,
            ...
            None, 'retentionDays': 7}, 'scheduleSettings': {'scheduleType': 'Daily', 'dailyScheduleSettings': {'time':
            '00:30', 'dailyMode': 'Everyday', 'specificDays': None}, 'monthlyScheduleSettings': None,
            'periodicallyScheduleSettings': None, 'activeFullSettings': None, 'retrySettings': {'enabled': False,
            'retryTimes': 3, 'waitTimeoutMinutes': 10}, 'backupHealthCheckScheduleSettings': None, 'syntheticFullSettings':
            None}, 'gfsRetentionSettings': None}}
