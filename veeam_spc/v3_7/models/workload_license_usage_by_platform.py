...
class WorkloadLicenseUsageByPlatform:
    """
    Attributes:
        type_id (str | Unset): ID of a workload type and platform.
        description (str | Unset): Description of a workload type and platform.
        objects_by_weight (list[WorkloadLicenseUsageByWeight] | Unset): License usage by workloads for each number of
            consumed units.
    """

    type_id: str | Unset = UNSET
    description: str | Unset = UNSET
    objects_by_weight: list[WorkloadLicenseUsageByWeight] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        objects_by_weight: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        objects_by_weight: list[WorkloadLicenseUsageByWeight] | Unset = UNSET
        if _objects_by_weight is not UNSET:
            objects_by_weight = []
            for objects_by_weight_item_data in _objects_by_weight:
