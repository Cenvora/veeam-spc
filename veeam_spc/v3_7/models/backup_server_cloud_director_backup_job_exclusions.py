...
class BackupServerCloudDirectorBackupJobExclusions:
    ...
    Attributes:
        vms (list[BackupServerCloudDirectorObject] | Unset): Array of VMs excluded from a backup job.'
        disks (list[BackupServerCloudDirectorBackupJobDisk] | Unset): Array of VM disks excluded from a backup job.
        templates (BackupServerBackupJobExclusionsTemplates | Unset): Excluded VM templates.
    """

    vms: list[BackupServerCloudDirectorObject] | Unset = UNSET
    disks: list[BackupServerCloudDirectorBackupJobDisk] | Unset = UNSET
