...
class WindowsServerModeJobSettings:
    """
    Attributes:
        retention_settings (WindowsServerJobRetentionSettings | Unset):
        schedule_setting (WindowsServerJobScheduleSettings | Unset):
        indexing_settings (WindowsIndexingSettings | Unset):
        application_aware_processing_settings (WindowsApplicationAwareProcessingSettings | Unset):
    """

    retention_settings: WindowsServerJobRetentionSettings | Unset = UNSET
    schedule_setting: WindowsServerJobScheduleSettings | Unset = UNSET
    indexing_settings: WindowsIndexingSettings | Unset = UNSET
    application_aware_processing_settings: WindowsApplicationAwareProcessingSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        schedule_setting: dict[str, Any] | Unset = UNSET
