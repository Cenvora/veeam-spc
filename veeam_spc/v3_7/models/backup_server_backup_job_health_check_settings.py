...
class BackupServerBackupJobHealthCheckSettings:
    ...
    Attributes:
        ...
        weekly (BackupServerBackupJobAdvancedStorageScheduleWeekly | Unset): Weekly schedule settings.
        monthly (BackupServerBackupJobAdvancedStorageScheduleMonthly | Unset): Monthly schedule settings.
    """

    is_enabled: bool
    weekly: BackupServerBackupJobAdvancedStorageScheduleWeekly | Unset = UNSET
    monthly: BackupServerBackupJobAdvancedStorageScheduleMonthly | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        weekly: BackupServerBackupJobAdvancedStorageScheduleWeekly | Unset
        ...
        monthly: BackupServerBackupJobAdvancedStorageScheduleMonthly | Unset
