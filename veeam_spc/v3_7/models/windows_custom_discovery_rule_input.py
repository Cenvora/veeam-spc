...
class WindowsCustomDiscoveryRuleInput:
    r"""
    Example:
        {'name': 'Complex Custom Rule', 'masterAgentUid': '4ae8db95-8a4e-4a6a-b1fb-89a0d4b8aca5', 'hosts':
            ['vaw2rule.tech.local', '173.27.21.161'], 'useMasterManagementAgentCredentials': True, 'accessAccount':
            {'userName': '.\\administrator', 'password': 'Password1'}, 'filter': {'exclusionMask': ['string'],
            'ignoreInaccessibleMachine': True, 'osTypes': ['WindowsServer', 'WindowsWorkstation'], 'applications':
            ['MicrosoftExchangeServer'], 'customApplication': None, 'platforms': ['MicrosoftHyperVandVmWareVSphere']},
            'notificationSettings': {'isEnabled': True, 'scheduleType': 'Days', 'scheduleTime': '08:00', 'weekSettings':
            None, 'to': 'administrator@vspc1.com', 'subject': 'VSPC Discovery Results', 'notifyOnTheFirstRun': False},
            'deploymentSettings': {'isEnabled': True, 'backupPolicyUid': '7a8f9468-4c46-4b52-b011-cce3507f6b04',
            'setReadOnlyAccess': True, 'backupAgentSettings': {'disableScheduledBackups': True,
            'disableControlPanelNotification': True, 'disableBackupOverMeteredConnection': True, 'disableScheduleWakeup':
            True, 'throttleBackupActivity': True, 'restrictVpnConnections': True, 'limitBandwidthConsumption': True,
            'bandwidthSpeedLimit': 2, 'bandwidthSpeedLimitUnit': 'MbitPerSec', 'flrWithoutAdminPrivilegesAllowed': True}},
            'scheduleSettings': {'scheduleType': 'NotScheduled', 'timeZone': None, 'dailyScheduleSettings': None,
