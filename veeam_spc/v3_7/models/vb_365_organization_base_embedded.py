...
class Vb365OrganizationBaseEmbedded:
    """
    Attributes:
        organization_details (Vb365OrganizationDetails | Unset):
        vb_365_server (Vb365Server | Unset):
    """

    organization_details: Vb365OrganizationDetails | Unset = UNSET
    vb_365_server: Vb365Server | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        organization_details: dict[str, Any] | Unset = UNSET
        if not isinstance(self.organization_details, Unset):
            organization_details = self.organization_details.to_dict()

        vb_365_server: dict[str, Any] | Unset = UNSET
