...
class AutoDeploymentSettings:
    ...
    Attributes:
        ...
        retry_interval (int | Unset): Time interval in minutes after which the next deployment attempt starts. Default:
            7.
        accept_new_connections (bool | Unset): Indicates whether Veeam Service Provider Console accepts connections from
            new management agents. Default: True.
        install_driver (bool | Unset): Indicates whether CBT driver is installed during auto deployment. Default: False.
        set_read_only_access (bool | Unset): Indicates whether the read-only access mode is enabled for Veeam backup
            agent. Default: True.
        backup_agent_settings (BackupAgentSettings | Unset):  Example: {'backupAgentUid':
            '07773b42-89fb-7227-9c6a-95e6908f25de', 'disableScheduledBackups': True, 'disableControlPanelNotification':
            True, 'disableBackupOverMeteredConnection': True, 'disableScheduleWakeup': False, 'throttleBackupActivity':
            True, 'restrictVpnConnections': False, 'limitBandwidthConsumption': True, 'bandwidthSpeedLimit': 10,
            'bandwidthSpeedLimitUnit': 'MbytePerSec', 'flrWithoutAdminPrivilegesAllowed': True}.
    """
    ...
    accept_new_connections: bool | Unset = True
    install_driver: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_agent_settings: dict[str, Any] | Unset = UNSET
