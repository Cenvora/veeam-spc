...
class PublicCloudAzureDeviceCode:
    """
    Attributes:
        user_code (str | Unset): Verification code used to authenticate to the Azure CLI.
        verification_url (str | Unset): Redirect URI used to authenticate to the Azure CLI.
        device_code_token (str | Unset): Verification code used to start an authentication session.
    """

    user_code: str | Unset = UNSET
    verification_url: str | Unset = UNSET
    device_code_token: str | Unset = UNSET
