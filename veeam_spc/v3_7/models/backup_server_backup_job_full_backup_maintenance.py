...
class BackupServerBackupJobFullBackupMaintenance:
    ...
    Attributes:
        remove_data (BackupServerBackupJobFullBackupMaintenanceRemoveData | Unset): Backup data settings for deleted
            VMs.
        defragment_and_compact (BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompact | Unset): Compact
            operation settings.
    """

    remove_data: BackupServerBackupJobFullBackupMaintenanceRemoveData | Unset = UNSET
    defragment_and_compact: BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompact | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_data: BackupServerBackupJobFullBackupMaintenanceRemoveData | Unset
        ...
        defragment_and_compact: BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompact | Unset
