...
class SubscriptionPlanFileShareBackup:
    """
    Attributes:
        file_share_remote_backup_used_space_price (float | Unset): Charge rate for one GB or TB of backup repository
        ...
        file_share_remote_archive_used_space_price (float | Unset): Charge rate for one GB or TB of archive repository
            space consumed by file share backups. Default: 0.0.
        ...
        file_share_hosted_backup_used_space_price (float | Unset): Charge rate for one GB or TB of backup repository
            space consumed by file share backups. Default: 0.0.
        ...
        file_share_hosted_archive_used_space_price (float | Unset): Charge rate for one GB or TB of archive repository
            space consumed by file share backups. Default: 0.0.
    ...
    file_share_remote_backup_used_space_price: float | Unset = 0.0
    ...
    file_share_remote_archive_used_space_price: float | Unset = 0.0
    ...
    source_remote_amount_of_data_price: float | Unset = 0.0
    source_remote_amount_of_data_units: SubscriptionPlanFileShareBackupSourceRemoteAmountOfDataUnits | Unset = (
    ...
    file_share_hosted_backup_used_space_price: float | Unset = 0.0
    ...
    file_share_hosted_archive_used_space_price: float | Unset = 0.0
    ...
    source_hosted_amount_of_data_price: float | Unset = 0.0
    source_hosted_amount_of_data_units: SubscriptionPlanFileShareBackupSourceHostedAmountOfDataUnits | Unset = (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        file_share_remote_backup_used_space_units: str | Unset = UNSET
        ...
        file_share_remote_archive_used_space_units: str | Unset = UNSET
        ...
        source_remote_amount_of_data_units: str | Unset = UNSET
        ...
        file_share_hosted_backup_used_space_units: str | Unset = UNSET
        ...
        file_share_hosted_archive_used_space_units: str | Unset = UNSET
        ...
        source_hosted_amount_of_data_units: str | Unset = UNSET
