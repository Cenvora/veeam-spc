...
class LinuxJobScheduleSettings:
    """
    Attributes:
        schedule_type (LinuxJobScheduleSettingsScheduleType | Unset): Type of periodicity. Default:
            LinuxJobScheduleSettingsScheduleType.NOTSCHEDULED.
        daily_schedule_settings (LinuxDailyScheduleSettings | Unset):
        monthly_schedule_settings (LinuxMonthlyScheduleSettingsWithTime | Unset):
        periodically_schedule_settings (LinuxPeriodicallyScheduleSettings | Unset):
        active_full_settings (LinuxActiveFullSettings | Unset):
        retry_settings (LinuxScheduleRetrySettings | Unset):
        backup_health_check_schedule_settings (LinuxBackupHealthCheckScheduleSettings | Unset):
        synthetic_full_settings (LinuxSyntheticFullSettings | Unset):
    """

    schedule_type: LinuxJobScheduleSettingsScheduleType | Unset = LinuxJobScheduleSettingsScheduleType.NOTSCHEDULED
    daily_schedule_settings: LinuxDailyScheduleSettings | Unset = UNSET
    monthly_schedule_settings: LinuxMonthlyScheduleSettingsWithTime | Unset = UNSET
    periodically_schedule_settings: LinuxPeriodicallyScheduleSettings | Unset = UNSET
    active_full_settings: LinuxActiveFullSettings | Unset = UNSET
    retry_settings: LinuxScheduleRetrySettings | Unset = UNSET
    backup_health_check_schedule_settings: LinuxBackupHealthCheckScheduleSettings | Unset = UNSET
    synthetic_full_settings: LinuxSyntheticFullSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        periodically_schedule_settings: dict[str, Any] | Unset = UNSET
        ...
        active_full_settings: dict[str, Any] | Unset = UNSET
        ...
        backup_health_check_schedule_settings: dict[str, Any] | Unset = UNSET
        ...
        synthetic_full_settings: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_type: LinuxJobScheduleSettingsScheduleType | Unset
