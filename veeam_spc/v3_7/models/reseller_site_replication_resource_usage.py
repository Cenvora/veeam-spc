...
class ResellerSiteReplicationResourceUsage:
    """
    Attributes:
        replication_resource_uid (UUID | Unset): UID assigned to a cloud replication resource.
        reseller_uid (UUID | Unset): UID assigned to a reseller.
        hardware_plan_uid (UUID | Unset): UID assigned to a hardware plan.
        tenants_per_plan_usage (int | Unset): Number of companies that are subscribe to a hardware plan.
    """

    replication_resource_uid: UUID | Unset = UNSET
    reseller_uid: UUID | Unset = UNSET
    hardware_plan_uid: UUID | Unset = UNSET
    tenants_per_plan_usage: int | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        replication_resource_uid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replication_resource_uid: UUID | Unset
