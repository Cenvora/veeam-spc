...
class SmtpSettings:
    """
    Example:
        {'serverAddress': 'smtp://smtp1.tech.local:25', 'tlsMode': 'auto', 'timeout': '00:05:00', 'passwordCredential':
            None, 'oAuth2Credential': None, 'exclusivelyAcceptedCertificateHash': None}
