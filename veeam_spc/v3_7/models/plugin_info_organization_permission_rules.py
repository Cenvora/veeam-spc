...
class PluginInfoOrganizationPermissionRules:
    ...
    Attributes:
        rules (list[PluginPermissionRule] | Unset): Array of plugin access rules configured for organizations.
        organizations_are_allowed_by_default (bool | Unset): Indicates whether all other organizations are permitted to
            access plugin by default.
    """

    rules: list[PluginPermissionRule] | Unset = UNSET
    organizations_are_allowed_by_default: bool | Unset = UNSET
