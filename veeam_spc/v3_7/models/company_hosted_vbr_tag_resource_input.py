...
class CompanyHostedVbrTagResourceInput:
    """
    Example:
        {'virtualCenterUid': '23c54529-5c14-4ebf-aa2c-64f3503a1070', 'virtualServerTag': {'urn':
            'urn:vmomi:InventoryServiceTag:88788f9e-d8f5-4eb4-bc4f-9b3f5403bcec', 'name': 'VSPC', 'hostUid':
            '23c54529-5c14-4ebf-aa2c-64f3503a1070', 'hostName': 'vcenter01.tech.local'}}
