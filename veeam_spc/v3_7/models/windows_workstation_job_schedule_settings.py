...
class WindowsWorkstationJobScheduleSettings:
    """
    Attributes:
        periodical_schedule_enabled (bool | Unset): Indicates whether backup must be performed periodically. Default:
            True.
        periodical_schedule_settings (WindowsWorkstationJobPeriodicalScheduleSettings | Unset):
        event_trigger_settings (WindowsWorkstationJobEventTriggerSettings | Unset):
    """

    periodical_schedule_enabled: bool | Unset = True
    periodical_schedule_settings: WindowsWorkstationJobPeriodicalScheduleSettings | Unset = UNSET
    event_trigger_settings: WindowsWorkstationJobEventTriggerSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        event_trigger_settings: dict[str, Any] | Unset = UNSET
