...
T = TypeVar("T", bound="UpdateWebhookResponse200")


@_attrs_define
class UpdateWebhookResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_webhook_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        update_webhook_response_200.additional_properties = d
        return update_webhook_response_200
