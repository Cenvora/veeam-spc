...
class PluginInfo:
    """
    Attributes:
        plugin_id (UUID | Unset): ID assigned to a plugin.
        name (str | Unset): Name of a plugin.
        icon (str | Unset): Path to a plugin icon file.
        description (str | Unset): Description of a plugin.
        version (str | Unset): Version of a plugin.
        available_versions (list[str] | Unset): Array of available plugin versions.
        enabled (bool | Unset): Indicates whether a plugin is enabled.
        has_api_key (bool | Unset): Indicates whether API key is assigned to a plugin.
        supported_features (list[PluginFeature] | Unset): Array of supported plugin features.
        agent_permission_rules (PluginInfoAgentPermissionRules | Unset): Plugin access rules configured for management
            agents.
        organization_permission_rules (PluginInfoOrganizationPermissionRules | Unset): Plugin access rules configured
            for organizations.
    """

    plugin_id: UUID | Unset = UNSET
    ...
    has_api_key: bool | Unset = UNSET
    supported_features: list[PluginFeature] | Unset = UNSET
    agent_permission_rules: PluginInfoAgentPermissionRules | Unset = UNSET
    organization_permission_rules: PluginInfoOrganizationPermissionRules | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_permission_rules: PluginInfoAgentPermissionRules | Unset
        ...
        organization_permission_rules: PluginInfoOrganizationPermissionRules | Unset
