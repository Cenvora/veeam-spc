...
from ..models.backup_server_immediate_backup_copy_job_retention_policy_type import (
    BackupServerImmediateBackupCopyJobRetentionPolicyType,
)
from ..models.backup_server_immediate_backup_copy_job_rpo_options_unit import (
    BackupServerImmediateBackupCopyJobRpoOptionsUnit,
)
...
T = TypeVar("T", bound="BackupServerImmediateBackupCopyJob")


@_attrs_define
class BackupServerImmediateBackupCopyJob:
    """
    Attributes:
        ...
        monthly_restore_points_to_keep (int | Unset): Number of months during which the monthly backup must be stored on
            the target repository.
        yearly_restore_points_to_keep (int | Unset): Number of years during which the yearly backup must be stored on
            the target repository.
        retention_policy_type (BackupServerImmediateBackupCopyJobRetentionPolicyType | Unset): Type of a retention
            policy of a backup copy job.
        is_rpo_options_enabled (bool | Unset): Indicates whether a warning is enabled in case backup copy job fails to
            complete within the specified RPO interval.
        rpo_options_value (int | Unset): Desired RPO interval value.
        rpo_options_unit (BackupServerImmediateBackupCopyJobRpoOptionsUnit | Unset): Measurement units of a desired RPO
            interval value.
    ...
    retention_policy_type: BackupServerImmediateBackupCopyJobRetentionPolicyType | Unset = UNSET
    is_rpo_options_enabled: bool | Unset = UNSET
    rpo_options_value: int | Unset = UNSET
    rpo_options_unit: BackupServerImmediateBackupCopyJobRpoOptionsUnit | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        retention_policy_type: str | Unset = UNSET
        ...
        rpo_options_unit: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_type: BackupServerImmediateBackupCopyJobRetentionPolicyType | Unset
        if isinstance(_retention_policy_type, Unset):
            retention_policy_type = UNSET
        else:
            retention_policy_type = BackupServerImmediateBackupCopyJobRetentionPolicyType(_retention_policy_type)
        ...
        rpo_options_unit: BackupServerImmediateBackupCopyJobRpoOptionsUnit | Unset
        if isinstance(_rpo_options_unit, Unset):
            rpo_options_unit = UNSET
        else:
            rpo_options_unit = BackupServerImmediateBackupCopyJobRpoOptionsUnit(_rpo_options_unit)
        ...
        backup_server_immediate_backup_copy_job = cls(
        ...
        backup_server_immediate_backup_copy_job.additional_properties = d
        return backup_server_immediate_backup_copy_job
