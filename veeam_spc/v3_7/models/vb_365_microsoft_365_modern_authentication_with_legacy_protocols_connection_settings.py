...
class Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsConnectionSettings:
    """
    Attributes:
        share_point_settings (Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsCommonConnectionSettings | Unset):
        exchange_settings (Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsCommonConnectionSettings | Unset):
    """

    share_point_settings: Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsCommonConnectionSettings | Unset = (
        UNSET
    )
    exchange_settings: Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsCommonConnectionSettings | Unset = UNSET
