...
class PublicCloudGoogleNetworks:
    """
    Attributes:
        network_id (str | Unset): ID assigned to a network.
        network_name (str | Unset): Name of a network.
        project_id (str | Unset): ID assigned to a project to which a network is added.
        network_type (PublicCloudGoogleNetworkType | Unset): Type of a network.
    """

    network_id: str | Unset = UNSET
    network_name: str | Unset = UNSET
    project_id: str | Unset = UNSET
    network_type: PublicCloudGoogleNetworkType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_type: PublicCloudGoogleNetworkType | Unset
