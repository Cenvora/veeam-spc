...
class EmbeddedForWindowsDiscoveryRuleChildren:
    ...
    Attributes:
        ...
        windows_discovery_rule (WindowsDiscoveryRule | Unset):
    """

    discovery_rule: DiscoveryRule | Unset = UNSET
    windows_discovery_rule: WindowsDiscoveryRule | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        windows_discovery_rule: dict[str, Any] | Unset = UNSET
