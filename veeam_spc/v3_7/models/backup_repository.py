...
class BackupRepository:
    ...
    Attributes:
        ...
        labels (list[str] | Unset): Array of assigned labels.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        label_target_uid: str | Unset = UNSET
        ...
        if label_target_uid is not UNSET:
            field_dict["labelTargetUid"] = label_target_uid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _label_target_uid = d.pop("labelTargetUid", UNSET)
        label_target_uid: UUID | Unset
        if isinstance(_label_target_uid, Unset):
            label_target_uid = UNSET
        else:
        ...
        backup_repository = cls(
            ...
            labels=labels,
            label_target_uid=label_target_uid,
