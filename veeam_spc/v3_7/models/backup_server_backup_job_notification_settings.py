...
class BackupServerBackupJobNotificationSettings:
    ...
    Attributes:
        send_snmp_notifications (bool | Unset): Indicates whether SNMP notifications are enabled for a job. Default:
            False.
        email_notifications (BackupServerEmailNotificationSettings | Unset): Email notification settings.
        vm_attribute (BackupServerNotificationVmAttributeSettings | Unset): VM attribute settings.
    """

    send_snmp_notifications: bool | Unset = False
    email_notifications: BackupServerEmailNotificationSettings | Unset = UNSET
    vm_attribute: BackupServerNotificationVmAttributeSettings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        email_notifications: BackupServerEmailNotificationSettings | Unset
        ...
        vm_attribute: BackupServerNotificationVmAttributeSettings | Unset
