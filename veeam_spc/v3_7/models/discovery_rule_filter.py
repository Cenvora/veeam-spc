...
class DiscoveryRuleFilter:
    """
    Attributes:
        exclusion_mask (list[str] | Unset): Array of applied exclusion masks. For custom discovery rules this property
            is ignored.
        ignore_inaccessible_machine (bool | Unset): Indicates whether discovery is performed among accessible computers
            only. Default: False.
        os_types (list[DiscoveryRuleFilterOsTypesItem] | Unset): Type of operating system.
        applications (list[DiscoveryRuleFilterApplicationsItem] | Unset): Applications that must run on discovered
            computers.
        custom_application (str | Unset): Name of an application required for the `OtherApp` application type.
            > Available only for Linux computers.
        platforms (list[DiscoveryRuleFilterPlatformsItem] | Unset): Platforms on which discovered computers must run.
    """

    exclusion_mask: list[str] | Unset = UNSET
    ignore_inaccessible_machine: bool | Unset = False
    os_types: list[DiscoveryRuleFilterOsTypesItem] | Unset = UNSET
    applications: list[DiscoveryRuleFilterApplicationsItem] | Unset = UNSET
    custom_application: str | Unset = UNSET
    platforms: list[DiscoveryRuleFilterPlatformsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        os_types: list[DiscoveryRuleFilterOsTypesItem] | Unset = UNSET
        if _os_types is not UNSET:
            os_types = []
            for os_types_item_data in _os_types:
