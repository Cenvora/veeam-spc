...
class CloudAgent:
    ...
    Attributes:
        ...
        port (int | Unset): Reverse proxy port of a Veeam Cloud Connect site.
        ...
        tenant_management_in_cloud_connect_is_enabled (bool | Unset): Indicates whether tenant and cloud resource
    ...
    tenant_management_in_cloud_connect_is_enabled: bool | Unset = UNSET
