...
class BackupServerBackupJobOracleSettings:
    ...
    Attributes:
        ...
        credentials_id (UUID | Unset): UID assigned to a credentials record that is used to access Oracle database in
            case the `useGuestCredentials` property has the `false` value.
        ...
        log_shipping_servers (BackupServerBackupJobLogShippingServers | Unset): Log shipping servers used to transport
            transaction logs.
    """
    ...
    log_shipping_servers: BackupServerBackupJobLogShippingServers | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_shipping_servers: BackupServerBackupJobLogShippingServers | Unset
