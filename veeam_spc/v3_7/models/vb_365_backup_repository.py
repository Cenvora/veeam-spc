...
class Vb365BackupRepository:
    ...
    Attributes:
        ...
        retention_period_type (Vb365BackupRepositoryRetentionPeriodType | Unset): Retention period type.
        yearly_retention_period (Vb365BackupRepositoryYearlyRetentionPeriod | Unset): Retention period in years.
        retention_frequency_type (Vb365BackupRepositoryRetentionFrequencyType | Unset): Clean-up schedule type.
        daily_type (Vb365BackupRepositoryDailyType | Unset): Days when the daily clean-up must be performed.
        monthly_day_number (Vb365BackupRepositoryMonthlyDayNumber | Unset): Ordinal number of the week when the monthly
            clean-up must be performed.
        monthly_day_of_week (Vb365BackupRepositoryMonthlyDayOfWeek | Unset): Day of the week when the monthly clean-up
            must be performed.
    """
    ...
    yearly_retention_period: Vb365BackupRepositoryYearlyRetentionPeriod | Unset = UNSET
    retention_frequency_type: Vb365BackupRepositoryRetentionFrequencyType | Unset = UNSET
    daily_type: Vb365BackupRepositoryDailyType | Unset = UNSET
    monthly_day_number: Vb365BackupRepositoryMonthlyDayNumber | Unset = UNSET
    monthly_day_of_week: Vb365BackupRepositoryMonthlyDayOfWeek | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        monthly_day_number: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        yearly_retention_period: Vb365BackupRepositoryYearlyRetentionPeriod | Unset
        ...
        daily_type: Vb365BackupRepositoryDailyType | Unset
        ...
        monthly_day_number: Vb365BackupRepositoryMonthlyDayNumber | Unset
        ...
        monthly_day_of_week: Vb365BackupRepositoryMonthlyDayOfWeek | Unset
