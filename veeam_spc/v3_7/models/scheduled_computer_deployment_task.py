...
class ScheduledComputerDeploymentTask:
    ...
    Attributes:
        ...
        task_uid (UUID | Unset): UID assigned to a scheduled deployment task.
        task_type (ScheduledDeploymentTaskType | Unset): Type of a scheduled deployment task.
    """

    date_time: datetime.datetime
    task_uid: UUID | Unset = UNSET
    task_type: ScheduledDeploymentTaskType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_type: ScheduledDeploymentTaskType | Unset
