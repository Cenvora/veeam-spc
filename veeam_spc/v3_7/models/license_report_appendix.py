...
class LicenseReportAppendix:
    """
    Attributes:
        license_company_name (str | Unset): Licensee company name.
        appendix_summary (LicenseReportSummary | Unset):
        ...
        usage_details (list[OrganizationUsageOfLicensesWithSameSupportId] | Unset): Detailed information about license
            usage.
    """

    license_company_name: str | Unset = UNSET
    appendix_summary: LicenseReportSummary | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        appendix_summary: dict[str, Any] | Unset = UNSET
