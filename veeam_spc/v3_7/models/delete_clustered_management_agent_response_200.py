...
T = TypeVar("T", bound="DeleteClusteredManagementAgentResponse200")


@_attrs_define
class DeleteClusteredManagementAgentResponse200:
    """
    Attributes:
        data (list[Warning_]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_clustered_management_agent_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        delete_clustered_management_agent_response_200.additional_properties = d
        return delete_clustered_management_agent_response_200
