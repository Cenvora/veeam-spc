...
class VOneScheduledDeploymentConfigurationWithCredentials:
    ...
    Example:
        {'configuration': {'configuration': {'distribution': {'filePath':
            ...
            'licenseSource': 'LicenseFileContent'}}, 'schedule': {'dateTime': '2025-07-23T19:55:26.3617936-05:00'}}

    Attributes:
        configuration (VOneDeploymentConfigurationWithCredentials):  Example: {'configuration': {'distribution':
            {'filePath': '\\\\tech.local\\tech\\VSPC\\VBR\\13\\Butler\\VeeamONE_13.0.0.5457_20250723.iso', 'userName':
            'vspc\\admin', 'password': 'Password1'}, 'usePredownloadedIso': None, 'answerXml': '<?xml version="1.0"
            encoding="utf-8"?>\r\n<unattendedInstallationConfiguration bundle="Vo" mode="install" version="1.0">\r\n
            <properties>\r\n\r\n    <!--License agreements-->\r\n    <property name="ACCEPT_EULA" value="1" />\r\n
            <property name="ACCEPT_LICENSING_POLICY" value="1" />\r\n    <property name="ACCEPT_THIRDPARTY_LICENSES"
            value="1" />\r\n    <property name="ACCEPT_REQUIRED_SOFTWARE" value="1" />\r\n\r\n    <!--License file-->\r\n
