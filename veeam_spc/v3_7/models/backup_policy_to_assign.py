...
class BackupPolicyToAssign:
    """
    Attributes:
        company_uid (UUID | Unset): UID assigned to an organization to whose agents a backup policy is assigned.
        backup_policies (list[BackupPolicy] | Unset): Array of backup policies available to assign.
    """

    company_uid: UUID | Unset = UNSET
    backup_policies: list[BackupPolicy] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_policies: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_policies: list[BackupPolicy] | Unset = UNSET
        if _backup_policies is not UNSET:
            backup_policies = []
            for backup_policies_item_data in _backup_policies:
