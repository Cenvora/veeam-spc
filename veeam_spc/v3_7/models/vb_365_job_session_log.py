...
class Vb365JobSessionLog:
    """
    Attributes:
        message (str | Unset): The job session log details
        log_type (Vb365JobSessionLogLogType | Unset): The job session log type
    """

    message: str | Unset = UNSET
    log_type: Vb365JobSessionLogLogType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_type: Vb365JobSessionLogLogType | Unset
