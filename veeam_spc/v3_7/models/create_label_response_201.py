...
T = TypeVar("T", bound="CreateLabelResponse201")


@_attrs_define
class CreateLabelResponse201:
    """
    Attributes:
        data (Label): Assigned label.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = Label.from_dict(d.pop("data"))
        ...
        create_label_response_201 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_label_response_201.additional_properties = d
        return create_label_response_201
