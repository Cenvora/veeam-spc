...
class BackupServerBackupJobStorageSetting:
    ...
    Attributes:
        ...
        encryption (BackupServerBackupJobStorageSettingsEncryption | Unset): Backup file encryption settings.
    """
    ...
    encryption: BackupServerBackupJobStorageSettingsEncryption | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encryption: BackupServerBackupJobStorageSettingsEncryption | Unset
