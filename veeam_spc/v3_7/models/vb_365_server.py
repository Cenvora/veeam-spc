...
class Vb365Server:
    ...
    Attributes:
        ...
        server_api_version (Vb365ServerServerApiVersion | Unset): Version of Veeam Backup for Microsoft 365 server API.
        status (Vb365ServerStatus | Unset): Veeam Backup for Microsoft 365 server status.
    ...
    server_api_version: Vb365ServerServerApiVersion | Unset = UNSET
    status: Vb365ServerStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        server_api_version: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_api_version: Vb365ServerServerApiVersion | Unset
        ...
        status: Vb365ServerStatus | Unset
