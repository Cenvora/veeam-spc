...
class PublicCloudAwsAddExistingApplianceInput:
    """
    Example:
        {'account': {'connectionUid': 'ae61e533-82c7-4cb6-a030-78ae589cf49d', 'dataCenterId': 'eu-central-1',
            'regionId': 'Global', 'accountUid': 'd60543b8-9a53-473a-8e4c-cfdc374286cf'}, 'virtualMachine':
            {'virtualMachineId': 'i-3583285fb7c5b174d', 'description': 'Existing appliance.'}, 'network': None,
            'guestOsCredentials': {'guestOsCredentialsUid': '6f213654-b538-4695-ac69-aa677e41862e', 'certificateThumbprint':
            'sample-certificateThumbprint'}}
    ...
    Attributes:
        ...
        network (PublicCloudAwsAddExistingApplianceInputNetwork | Unset):
    """

    account: PublicCloudAwsAddExistingApplianceInputAccount
    virtual_machine: PublicCloudAwsAddExistingApplianceInputVirtualMachine
    guest_os_credentials: PublicCloudAwsAddExistingApplianceInputGuestOsCredentials
    network: PublicCloudAwsAddExistingApplianceInputNetwork | Unset = UNSET
