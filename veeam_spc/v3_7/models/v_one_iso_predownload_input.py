...
class VOneIsoPredownloadInput:
    r"""Setup file predownload configuration.
    ...
    Attributes:
        ...
        predownload_type (VOneIsoPredownloadInputPredownloadType | Unset): Veeam ONE distribution type.
    """

    path: str
    predownload_type: VOneIsoPredownloadInputPredownloadType | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        path = self.path

        predownload_type: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        predownload_type: VOneIsoPredownloadInputPredownloadType | Unset
