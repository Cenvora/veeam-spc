...
class BackupServerJobScriptsSettings:
    ...
    Attributes:
        ...
        run_script_every (int | Unset): Number of backup job sessions after which the scripts must be executed.
        day_of_week (list[DaysOfWeek] | Unset): Days of the week when the scripts must be executed.
    """
    ...
    day_of_week: list[DaysOfWeek] | Unset = UNSET
