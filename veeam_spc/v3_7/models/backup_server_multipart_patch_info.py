...
class BackupServerMultipartPatchInfo:
    """
    Attributes:
        upload_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server patch upload.
        files (list[BackupServerMultipartPatchFile] | Unset): Array of files included in a Veeam Backup & Replication
            server patch upload.
    """

    upload_uid: UUID | Unset = UNSET
    files: list[BackupServerMultipartPatchFile] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        upload_uid: str | Unset = UNSET
