...
class WindowsJobScriptSettings:
    """
    Attributes:
        mode (WindowsJobScriptSettingsMode | Unset): Script processing mode. Default:
            WindowsJobScriptSettingsMode.DISABLED.
        pre_freeze_script (WindowsJobScript | Unset):
        post_thaw_script (WindowsJobScript | Unset):
        credentials (WindowsJobScriptExecutionAccount | Unset):
    """

    mode: WindowsJobScriptSettingsMode | Unset = WindowsJobScriptSettingsMode.DISABLED
    pre_freeze_script: WindowsJobScript | Unset = UNSET
    post_thaw_script: WindowsJobScript | Unset = UNSET
    credentials: WindowsJobScriptExecutionAccount | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode: WindowsJobScriptSettingsMode | Unset
