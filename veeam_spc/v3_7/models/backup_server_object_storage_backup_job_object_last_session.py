...
class BackupServerObjectStorageBackupJobObjectLastSession:
    ...
    Attributes:
        ...
        source_files_count (int | Unset): Number of source files.
        changed_files_count (int | Unset): Number of changed files.
        skipped_files_count (int | Unset): Number of skipped files.
        backed_up_files_count (int | Unset): Number of backed up files.
        transferred_size (int | Unset): Total size of processed object storage backup data, in bytes.
        source_size (int | Unset): Total size of all source files, in bytes.
        duration (int | Unset): Duration of the latest job session, in seconds.
