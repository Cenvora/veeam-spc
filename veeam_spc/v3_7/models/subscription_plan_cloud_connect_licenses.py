...
class SubscriptionPlanCloudConnectLicenses:
    """
    Attributes:
        vm_backup_price (float | Unset): Monthly charge rate for a licensed VM backup managed in Veeam Cloud Connect.
            Default: 0.0.
        vm_replica_price (float | Unset): Monthly charge rate for a licensed VM replica managed in Veeam Cloud Connect.
            Default: 0.0.
        workstation_backup_price (float | Unset): Monthly charge rate for a licensed workstation backup managed in Veeam
            Cloud Connect. Default: 0.0.
        server_backup_price (float | Unset): Monthly charge rate for a licensed server backup managed in Veeam Cloud
            Connect. Default: 0.0.
    """

    vm_backup_price: float | Unset = 0.0
    vm_replica_price: float | Unset = 0.0
    workstation_backup_price: float | Unset = 0.0
    server_backup_price: float | Unset = 0.0
