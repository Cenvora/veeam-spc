...
class TenantVcdReplicationResourceInput:
    """
    Example:
        {'dataCenters': [{'dataCenterUid': 'ae61e533-82c7-4cb6-a030-78ae589cf49d', 'isWanAccelerationEnabled': False,
            'wanAcceleratorUid': None}], 'isFailoverCapabilitiesEnabled': False}

    Attributes:
        data_centers (list[TenantVcdReplicationResourceDataCenter] | Unset): Array of organization VDCs.
