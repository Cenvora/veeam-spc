...
class GetBackupServerCredentialsByServerResponse200:
    ...
    Attributes:
        ...
        data (Union[Unset, list[Union['BackupServerCredentialsRecordType0', None]]]):
        errors (Union[None, Unset, list['ResponseError']]):
    """

    meta: Union["ResponseMetadataType0", None, Unset] = UNSET
    data: Union[Unset, list[Union["BackupServerCredentialsRecordType0", None]]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        data: Union[Unset, list[Union[None, dict[str, Any]]]] = UNSET
