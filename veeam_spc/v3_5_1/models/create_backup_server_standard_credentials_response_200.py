...
class CreateBackupServerStandardCredentialsResponse200:
    ...
    Attributes:
        ...
        data (Union['BackupServerCredentialsStandardType0', None, Unset]):
        errors (Union[None, Unset, list['ResponseError']]):
    """

    meta: Union["ResponseMetadataType0", None, Unset] = UNSET
    data: Union["BackupServerCredentialsStandardType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, BackupServerCredentialsStandardType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union["BackupServerCredentialsStandardType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["BackupServerCredentialsStandardType0", None, Unset], data)
