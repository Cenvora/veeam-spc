...
class SubscriptionPlanPublicCloud:
    ...
    Attributes:
        ...
        free_backup_used_space (Union[None, Unset, int]): Amount of consumed space on backup repository that is
            processed for free.
        ...
        free_archive_used_space (Union[None, Unset, int]): Amount of consumed space on archive repository that is
            processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
    ...
    free_backup_used_space: Union[None, Unset, int] = UNSET
    ...
    free_archive_used_space: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        free_backup_used_space: Union[None, Unset, int]
        if isinstance(self.free_backup_used_space, Unset):
            free_backup_used_space = UNSET
        else:
        ...
        free_archive_used_space: Union[None, Unset, int]
        if isinstance(self.free_archive_used_space, Unset):
            free_archive_used_space = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_free_backup_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        free_backup_used_space = _parse_free_backup_used_space(d.pop("freeBackupUsedSpace", UNSET))
        ...
        def _parse_free_archive_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        free_archive_used_space = _parse_free_archive_used_space(d.pop("freeArchiveUsedSpace", UNSET))
