...
class SubscriptionPlanVb365:
    ...
    Attributes:
        ...
        free_standard_storage_used_space (Union[None, Unset, int]): Amount of disk space consumed by Microsoft 365
        ...
        free_archive_storage_used_space (Union[None, Unset, int]): Amount of archive repository disk space consumed by
    ...
    free_standard_storage_used_space: Union[None, Unset, int] = UNSET
    free_standard_storage_used_space_units: Union[Unset, SubscriptionPlanVb365FreeStandardStorageUsedSpaceUnits] = (
        SubscriptionPlanVb365FreeStandardStorageUsedSpaceUnits.GB
    )
    ...
    free_archive_storage_used_space: Union[None, Unset, int] = UNSET
    free_archive_storage_used_space_units: Union[Unset, SubscriptionPlanVb365FreeArchiveStorageUsedSpaceUnits] = (
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        free_standard_storage_used_space: Union[None, Unset, int]
        if isinstance(self.free_standard_storage_used_space, Unset):
            free_standard_storage_used_space = UNSET
        else:
        ...
        free_archive_storage_used_space: Union[None, Unset, int]
        if isinstance(self.free_archive_storage_used_space, Unset):
            free_archive_storage_used_space = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_free_standard_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        free_standard_storage_used_space = _parse_free_standard_storage_used_space(
            d.pop("freeStandardStorageUsedSpace", UNSET)
        )
        ...
        def _parse_free_archive_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        free_archive_storage_used_space = _parse_free_archive_storage_used_space(
            d.pop("freeArchiveStorageUsedSpace", UNSET)
        )
