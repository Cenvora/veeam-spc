...
class WindowsFileLevelBackupSource:
    """
    Attributes:
        directories (Union[None, Unset, list[str]]): Array of paths to folders containing the files that must be
            protected.
    ...
    directories: Union[None, Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        directories: Union[None, Unset, list[str]]
        if isinstance(self.directories, Unset):
            directories = UNSET
        elif isinstance(self.directories, list):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_directories(data: object) -> Union[None, Unset, list[str]]:
            if data is None:
                return data
        ...
        directories = _parse_directories(d.pop("directories", UNSET))
