...
class SubscriptionPlanFileShareBackup:
    ...
    Attributes:
        ...
        free_file_share_backup_used_space (Union[None, Unset, int]): Amount of backup repository space that can be
        ...
        free_file_share_archive_used_space (Union[None, Unset, int]): Amount of archive repository space that can be
            consumed by file share backups for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        free_source_amount_of_data (Union[None, Unset, int]): Amount of source data that is processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
    ...
    free_file_share_backup_used_space: Union[None, Unset, int] = UNSET
    ...
    free_file_share_archive_used_space: Union[None, Unset, int] = UNSET
    ...
    free_source_amount_of_data: Union[None, Unset, int] = UNSET
    free_source_amount_of_data_units: Union[Unset, SubscriptionPlanFileShareBackupFreeSourceAmountOfDataUnits] = (
        SubscriptionPlanFileShareBackupFreeSourceAmountOfDataUnits.GB
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        free_file_share_backup_used_space: Union[None, Unset, int]
        if isinstance(self.free_file_share_backup_used_space, Unset):
            free_file_share_backup_used_space = UNSET
        else:
        ...
        free_file_share_archive_used_space: Union[None, Unset, int]
        if isinstance(self.free_file_share_archive_used_space, Unset):
            free_file_share_archive_used_space = UNSET
        else:
        ...
        free_source_amount_of_data: Union[None, Unset, int]
        if isinstance(self.free_source_amount_of_data, Unset):
            free_source_amount_of_data = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_free_file_share_backup_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        free_file_share_backup_used_space = _parse_free_file_share_backup_used_space(
            d.pop("freeFileShareBackupUsedSpace", UNSET)
        )
        ...
        def _parse_free_file_share_archive_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        free_file_share_archive_used_space = _parse_free_file_share_archive_used_space(
            d.pop("freeFileShareArchiveUsedSpace", UNSET)
        )
        ...
        def _parse_free_source_amount_of_data(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        free_source_amount_of_data = _parse_free_source_amount_of_data(d.pop("freeSourceAmountOfData", UNSET))
