...
class UserBackupResourceInput:
    ...
    Attributes:
        ...
        site_uid (Union[None, UUID, Unset]): UID assigned to a Veeam Cloud Connect site. If the property has the `null`
            value, the default Veeam Cloud Connect site will be selected.
