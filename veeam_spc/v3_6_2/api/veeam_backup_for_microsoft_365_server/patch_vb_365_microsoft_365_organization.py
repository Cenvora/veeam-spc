...
) -> Any | ErrorResponse | PatchVb365Microsoft365OrganizationResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchVb365Microsoft365OrganizationResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchVb365Microsoft365OrganizationResponse200 | None:
    """Modify Microsoft 365 Organization
