...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/jobs/copy/{vb_365_copy_job_uid}".format(
            vb_365_server_uid=quote(str(vb_365_server_uid), safe=""),
            vb_365_copy_job_uid=quote(str(vb_365_copy_job_uid), safe=""),
        ),
    }
...
) -> Any | ErrorResponse | PatchVb365CopyJobResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchVb365CopyJobResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchVb365CopyJobResponse200 | None:
    """Modify Veeam Backup for Microsoft 365 Backup Copy Job
