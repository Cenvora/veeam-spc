...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/{vb_365_organization_uid}".format(
...
) -> Any | ErrorResponse | GetVb365OrganizationResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetVb365OrganizationResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetVb365OrganizationResponse200 | None:
    """Get Microsoft Organization
