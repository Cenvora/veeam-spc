...
) -> Any | ErrorResponse | PatchTenantVcdReplicationResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchTenantVcdReplicationResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchTenantVcdReplicationResourceResponse200 | None:
    """Modify Tenant VMware Cloud Director Replication Resource
