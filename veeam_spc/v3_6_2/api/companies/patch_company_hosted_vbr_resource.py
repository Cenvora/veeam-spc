...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organizations/companies/{company_uid}/hostedResources/vbr/{vbr_hosted_resource_uid}".format(
...
) -> Any | ErrorResponse | PatchCompanyHostedVbrResourceResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchCompanyHostedVbrResourceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchCompanyHostedVbrResourceResponse200 | None:
    """Modify Company Hosted Server Resource
