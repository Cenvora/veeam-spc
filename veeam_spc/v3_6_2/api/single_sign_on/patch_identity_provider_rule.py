...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organizations/{organization_uid}/identityProviders/{identity_provider_name}/rules/{rule_uid}".format(
...
) -> Any | ErrorResponse | PatchIdentityProviderRuleResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchIdentityProviderRuleResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchIdentityProviderRuleResponse200 | None:
    """Modify Organization Identity Provider Mapping Rule
