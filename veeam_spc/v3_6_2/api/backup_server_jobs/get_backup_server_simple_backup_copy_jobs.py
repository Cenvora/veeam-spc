...
) -> Any | ErrorResponse | GetBackupServerSimpleBackupCopyJobsResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetBackupServerSimpleBackupCopyJobsResponse200]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetBackupServerSimpleBackupCopyJobsResponse200 | None:
    """Get All Immediate Backup Copy Jobs
