...
from ...models.patch_backup_server_veeam_vault_repository_response_200 import (
    PatchBackupServerVeeamVaultRepositoryResponse200,
)
...
) -> Any | ErrorResponse | PatchBackupServerVeeamVaultRepositoryResponse200:
    if response.status_code == 200:
        response_200 = PatchBackupServerVeeamVaultRepositoryResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchBackupServerVeeamVaultRepositoryResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchBackupServerVeeamVaultRepositoryResponse200 | None:
    """Modify Veeam Data Cloud Vault Backup Repository
