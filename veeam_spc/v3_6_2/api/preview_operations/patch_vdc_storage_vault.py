...
from ...models.patch_vdc_storage_vault_response_200 import PatchVdcStorageVaultResponse200
...
) -> Any | ErrorResponse | PatchVdcStorageVaultResponse200:
    if response.status_code == 200:
        response_200 = PatchVdcStorageVaultResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | PatchVdcStorageVaultResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | PatchVdcStorageVaultResponse200 | None:
    """Modify Storage Vault
