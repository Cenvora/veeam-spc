...
from ...models.get_vdc_storage_vaults_response_200 import GetVdcStorageVaultsResponse200
...
) -> Any | ErrorResponse | GetVdcStorageVaultsResponse200:
    if response.status_code == 200:
        response_200 = GetVdcStorageVaultsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetVdcStorageVaultsResponse200]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetVdcStorageVaultsResponse200 | None:
    """Get All Storage Vaults
