...
def _get_kwargs(
    ...
    *,
    ...
    json_gateway_pool_uid: str | Unset = UNSET
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/pulse/tenants/{tenant_uid}/createCompany".format(
...
) -> Any | CreateCompanyByPulseTenantResponse200 | ErrorResponse:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CreateCompanyByPulseTenantResponse200 | ErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | CreateCompanyByPulseTenantResponse200 | ErrorResponse | None:
    """Create Company from VCSP Tenant
