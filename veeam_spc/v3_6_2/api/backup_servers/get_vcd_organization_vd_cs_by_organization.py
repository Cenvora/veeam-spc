...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/backupServers/{backup_server_uid}/vcdServers/vcdOrganizations/{vcd_organization_uid}/vDCs".format(
...
) -> Any | ErrorResponse | GetVcdOrganizationVDCsByOrganizationResponse200:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ErrorResponse | GetVcdOrganizationVDCsByOrganizationResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: UUID | Unset = UNSET,
    x_client_version: str | Unset = UNSET,
) -> Any | ErrorResponse | GetVcdOrganizationVDCsByOrganizationResponse200 | None:
    """Get All VDCs Providing Resources to VMware Cloud Director Organization
