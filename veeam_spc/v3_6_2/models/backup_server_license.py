...
class BackupServerLicense:
    ...
    Attributes:
        ...
        type_ (BackupServerLicenseType | Unset): Type of the license.
    """
    ...
    type_: BackupServerLicenseType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: BackupServerLicenseStatus | Unset
        ...
        cloud_connect: BackupServerLicenseCloudConnect | Unset
        ...
        unit_type: BackupServerLicenseUnitType | Unset
        ...
        type_: BackupServerLicenseType | Unset
