...
T = TypeVar("T", bound="CompleteLinuxBackupServerMultipartPatchResponse200")


@_attrs_define
class CompleteLinuxBackupServerMultipartPatchResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        complete_linux_backup_server_multipart_patch_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        complete_linux_backup_server_multipart_patch_response_200.additional_properties = d
        return complete_linux_backup_server_multipart_patch_response_200
