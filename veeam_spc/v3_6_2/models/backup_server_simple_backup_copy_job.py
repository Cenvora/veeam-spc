...
class BackupServerSimpleBackupCopyJob:
    ...
    Attributes:
        ...
        yearly_restore_points_to_keep (int | Unset): Number of years during which the yearly backup must be stored on
            the target repository.
        retention_policy_type (BackupServerSimpleBackupCopyJobRetentionPolicyType | Unset): Type of a retention policy
    ...
    retention_policy_type: BackupServerSimpleBackupCopyJobRetentionPolicyType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_type: BackupServerSimpleBackupCopyJobRetentionPolicyType | Unset
        ...
        rpo_options_unit: BackupServerSimpleBackupCopyJobRpoOptionsUnit | Unset
