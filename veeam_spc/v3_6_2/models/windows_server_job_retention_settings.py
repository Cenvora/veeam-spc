...
class WindowsServerJobRetentionSettings:
    """
    Attributes:
        retention_mode (WindowsServerJobRetentionSettingsRetentionMode | Unset): Retention policy type.
        ...
        retention_count (int | Unset): Retention policy counter value. Default: 7.
    """

    retention_mode: WindowsServerJobRetentionSettingsRetentionMode | Unset = (
        WindowsServerJobRetentionSettingsRetentionMode.RESTOREPOINTS
    )
    retention_count: int | Unset = 7
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        retention_mode: str | Unset = UNSET
