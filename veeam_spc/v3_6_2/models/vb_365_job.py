...
class Vb365Job:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a Veeam Backup for Microsoft 365 job.
        name (str | Unset): Name of a Veeam Backup for Microsoft 365 job.
        job_type (Vb365JobJobType | Unset): Type of a Veeam Backup for Microsoft 365 job.
    ...
    job_type: Vb365JobJobType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_type: Vb365JobJobType | Unset
        ...
        last_status: Vb365JobLastStatus | Unset
