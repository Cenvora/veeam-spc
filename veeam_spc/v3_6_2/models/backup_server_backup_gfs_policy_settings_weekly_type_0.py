...
class BackupServerBackupGFSPolicySettingsWeeklyType0:
    ...
    Attributes:
        ...
        keep_for_number_of_weeks (int | None | Unset): Number of weeks during which restore points must be stored.
        desired_time (BackupServerBackupGFSPolicySettingsWeeklyType0DesiredTime | Unset): Day of the week when the
            weekly retore point must be created.
    """

    is_enabled: bool
    keep_for_number_of_weeks: int | None | Unset = UNSET
    desired_time: BackupServerBackupGFSPolicySettingsWeeklyType0DesiredTime | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        is_enabled = self.is_enabled

        keep_for_number_of_weeks: int | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_keep_for_number_of_weeks(data: object) -> int | None | Unset:
            if data is None:
                return data
        ...
        desired_time: BackupServerBackupGFSPolicySettingsWeeklyType0DesiredTime | Unset
