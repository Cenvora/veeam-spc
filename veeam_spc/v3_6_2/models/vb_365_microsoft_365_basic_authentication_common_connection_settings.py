    ...
    Attributes:
        ...
        grant_admin_access (bool | Unset): Indicates whether the `ApplicationImpersonation` role is assigned to an
            ...
            Management group and has been granted the Role Management role in advance.
             Default: False.
        use_custom_veeam_aad_application (bool | Unset): Indicates whether Veeam Backup for Microsoft 365 must use Veeam
            Azure AD Application to connect to a Microsoft organization. Default: False.
    """
