...
class BackupServerEmailCustomNotificationTypeType0:
    ...
    Attributes:
        ...
        notify_on_success (bool | Unset): Indicates whether email notifications are sent when a job completes
            successfully. Default: True.
        notify_on_warning (bool | Unset): Indicates whether email notifications are sent when a job completes with
            warnings. Default: True.
        notify_on_error (bool | Unset): Indicates whether email notifications are sent when a job fails. Default: True.
        suppress_notification_until_last_retry (bool | Unset): Indicates whether email notifications are sent about the
            final job status only. Default: True.
    """

    subject: str | Unset = "[%JobResult%] %JobName% (%ObjectCount% objects) %Issues%"
    notify_on_success: bool | Unset = True
    notify_on_warning: bool | Unset = True
    notify_on_error: bool | Unset = True
    suppress_notification_until_last_retry: bool | Unset = True
