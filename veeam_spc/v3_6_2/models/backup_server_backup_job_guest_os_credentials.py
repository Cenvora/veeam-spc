...
class BackupServerBackupJobGuestOsCredentials:
    ...
    Attributes:
        ...
        credentials_per_machine (list[BackupServerBackupJobGuestOsCredentialsPerMachine] | Unset): Array of individual
            credentials for VMs.
    """

    credentials_id: UUID
    credentials_type: BackupServerCredentialsType
    credentials_per_machine: list[BackupServerBackupJobGuestOsCredentialsPerMachine] | Unset = UNSET
