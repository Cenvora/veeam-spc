...
class BrandingSettings:
    """
    Attributes:
        portal_color_theme (BrandingSettingsPortalColorTheme | Unset): Interface color scheme. Default:
            BrandingSettingsPortalColorTheme.BLUE.
        managed_organizations_branding_policy (BrandingSettingsManagedOrganizationsBrandingPolicy | Unset): Type of
            portal branding policy applied to managed organizations. Default:
            BrandingSettingsManagedOrganizationsBrandingPolicy.ALLOWCUSTOMIZATION.
    """

    portal_color_theme: BrandingSettingsPortalColorTheme | Unset = BrandingSettingsPortalColorTheme.BLUE
    managed_organizations_branding_policy: BrandingSettingsManagedOrganizationsBrandingPolicy | Unset = (
        BrandingSettingsManagedOrganizationsBrandingPolicy.ALLOWCUSTOMIZATION
    )
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        portal_color_theme: str | Unset = UNSET
        if not isinstance(self.portal_color_theme, Unset):
            portal_color_theme = self.portal_color_theme.value

        managed_organizations_branding_policy: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        portal_color_theme: BrandingSettingsPortalColorTheme | Unset
