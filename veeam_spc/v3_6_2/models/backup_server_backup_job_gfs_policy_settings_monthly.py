...
class BackupServerBackupJobGFSPolicySettingsMonthly:
    ...
    Attributes:
        ...
        keep_for_number_of_months (int | Unset): Number of months during which restore points must be stored.
        desired_time (BackupServerBackupJobGFSPolicySettingsMonthlyDesiredTime | Unset): Week of the month when the
            monthly restore point must be created.
    """

    is_enabled: bool
    keep_for_number_of_months: int | Unset = UNSET
    desired_time: BackupServerBackupJobGFSPolicySettingsMonthlyDesiredTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        desired_time: BackupServerBackupJobGFSPolicySettingsMonthlyDesiredTime | Unset
