...
class PublicCloudDatabasePolicyObject:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a cloud database.
        instance_name (str | Unset): Name of a cloud database.
        policy_uid (UUID | Unset): UID assigned to a cloud database policy.
        policy_name (str | Unset): Name of a cloud database policy.
        ...
        last_archive (PublicCloudPolicySession | Unset):
    """
    ...
    last_archive: PublicCloudPolicySession | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_archive: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        engine_type: ProtectedCloudDatabaseEngineType | Unset
