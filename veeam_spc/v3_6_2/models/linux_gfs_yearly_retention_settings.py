...
class LinuxGfsYearlyRetentionSettings:
    ...
    Attributes:
        ...
        use_monthly_full_backup_for_the_following_month
            (LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset): Month when Veeam Backup &
    ...
    use_monthly_full_backup_for_the_following_month: (
        LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset
    ) = LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth.JAN
