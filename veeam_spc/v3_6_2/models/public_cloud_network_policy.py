...
class PublicCloudNetworkPolicy:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a cloud network policy.
        name (str | Unset): Name of a cloud network policy.
        ...
        vnet_type (PublicCloudNetworkTypeReadonly | Unset): Type of a cloud network included in a policy.
        platform_type (BackupServerPublicCloudAppliancePlatform | Unset): Platform of a Veeam Backup for Public Clouds
            appliance.
        subscriptions_count (int | Unset): Number of Microsoft Azure subscriptions.
        regions_count (int | Unset): Number of regions.
    ...
    vnet_type: PublicCloudNetworkTypeReadonly | Unset = UNSET
    platform_type: BackupServerPublicCloudAppliancePlatform | Unset = UNSET
    subscriptions_count: int | Unset = UNSET
    regions_count: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vnet_type: PublicCloudNetworkTypeReadonly | Unset
