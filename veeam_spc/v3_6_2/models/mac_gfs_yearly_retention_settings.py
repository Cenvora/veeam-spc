...
class MacGfsYearlyRetentionSettings:
    ...
    Attributes:
        ...
        use_monthly_full_backup_for_the_following_month
            (MacGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset): Month when Veeam Backup &
    ...
    use_monthly_full_backup_for_the_following_month: (
        MacGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset
    ) = MacGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth.JAN
