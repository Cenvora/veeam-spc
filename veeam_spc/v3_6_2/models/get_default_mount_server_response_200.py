...
if TYPE_CHECKING:
    from ..models.mount_server import MountServer
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetDefaultMountServerResponse200")


@_attrs_define
class GetDefaultMountServerResponse200:
    """
    Attributes:
        data (list[MountServer]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MountServer.from_dict(data_item_data)
        ...
        get_default_mount_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_default_mount_server_response_200.additional_properties = d
        return get_default_mount_server_response_200
