...
class PublicCloudVirtualMachinePolicyObject:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a cloud VM.
        instance_name (str | Unset): Name of a cloud VM.
        policy_uid (UUID | Unset): UID assigned to cloud VM policy.
        policy_name (str | Unset): Name of a cloud VM policy.
        backup_server_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        resource_id (str | Unset): Resource ID assigned to a cloud VM.
