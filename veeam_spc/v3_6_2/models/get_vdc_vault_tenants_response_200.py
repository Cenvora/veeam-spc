...
T = TypeVar("T", bound="GetVdcVaultTenantsResponse200")


@_attrs_define
class GetVdcVaultTenantsResponse200:
    """
    Attributes:
        data (list[VdcVaultTenant]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = VdcVaultTenant.from_dict(data_item_data)
        ...
        get_vdc_vault_tenants_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_tenants_response_200.additional_properties = d
        return get_vdc_vault_tenants_response_200
