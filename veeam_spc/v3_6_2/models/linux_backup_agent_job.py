...
class LinuxBackupAgentJob:
    ...
    Attributes:
        ...
        instance_uid (UUID | Unset): UID assigned to a Veeam Agent for Linux job.
        ...
        name (None | str | Unset): Name of a Veeam Agent for Linux job.
        description (None | str | Unset): Description of a Veeam Agent for Linux job.
