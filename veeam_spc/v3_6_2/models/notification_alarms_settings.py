...
class NotificationAlarmsSettings:
    ...
    Attributes:
        ...
        daily_status_filter (list[NotificationAlarmsSettingsDailyStatusFilterItem] | Unset): Array of statuses that
            alarms must have to be included into daily notifications.
    ...
    daily_status_filter: list[NotificationAlarmsSettingsDailyStatusFilterItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        daily_status_filter: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        daily_status_filter: list[NotificationAlarmsSettingsDailyStatusFilterItem] | Unset = UNSET
        if _daily_status_filter is not UNSET:
            daily_status_filter = []
            for daily_status_filter_item_data in _daily_status_filter:
                daily_status_filter_item = NotificationAlarmsSettingsDailyStatusFilterItem(
                    daily_status_filter_item_data
                )
