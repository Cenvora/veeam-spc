...
class BackupServerBackupJobSQLSettingsType0:
    ...
    Attributes:
        ...
        backup_minutes_count (int | Unset): Frequency of transaction log backup, in minutes. Default: 15.
        retain_log_backups (BackupServerBackupJobRetainLogBackupsType | Unset): Type of log retention policy.
        keep_days_count (int | Unset): Number of days to keep transaction logs. Default: 15.
