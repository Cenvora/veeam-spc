...
class OrganizationLocation:
    ...
    Attributes:
        ...
        instance_uid (UUID | Unset): UID assigned to a location in Veeam Service Provider Console.
        organization_uid (UUID | Unset): UID assigned to an organization.
        type_ (OrganizationLocationType | Unset): Type of an organization location. Default:
    ...
    type_: OrganizationLocationType | Unset = OrganizationLocationType.CUSTOM
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: OrganizationLocationType | Unset
