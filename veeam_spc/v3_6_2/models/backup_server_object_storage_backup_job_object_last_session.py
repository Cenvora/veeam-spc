...
class BackupServerObjectStorageBackupJobObjectLastSession:
    """
    Attributes:
        backup_status (BackupServerObjectStorageBackupJobObjectLastSessionBackupStatus | Unset): Status of a job.
        source_files_count (int | None | Unset): Number of source files.
        changed_files_count (int | None | Unset): Number of changed files.
        skipped_files_count (int | None | Unset): Number of skipped files.
        backed_up_files_count (int | None | Unset): Number of backed up files.
        transferred_size (int | None | Unset): Total size of processed object storage backup data, in bytes.
        source_size (int | None | Unset): Total size of all source files, in bytes.
        duration (int | None | Unset): Duration of the latest job session, in seconds.
        messages (list[str] | Unset): Message that is displayed after a job session finishes.
    """

    backup_status: BackupServerObjectStorageBackupJobObjectLastSessionBackupStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_status: BackupServerObjectStorageBackupJobObjectLastSessionBackupStatus | Unset
