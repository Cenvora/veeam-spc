...
class BackupHardwarePlan:
    ...
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a hardware plan.
        ...
        network_with_internet_quota (int | Unset): Number of IP networks with internet access that are available to
            tenant VM replicas.
        network_without_internet_quota (int | Unset): Number of IP networks without internet access that are available
