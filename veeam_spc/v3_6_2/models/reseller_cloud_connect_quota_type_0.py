...
class ResellerCloudConnectQuotaType0:
    ...
    it to `null`.
        ...
        Attributes:
            data_transfer_out_quota (int | None | Unset): Maximum amount of data transfer out traffic available to a
                reseller, in bytes.
                > If quota is unlimited, the property value is `null`.
            insider_protection_quota (int | None | Unset): Number of days during which deleted backup files of reseller
                clients must be kept in the recycle bin by the service provider.
                > If quota is unlimited, the property value is `null`.
                 Default: 1.
            throttling_value (int | None | Unset): Maximum amount of incoming network traffic accepted from reseller
                clients.
                > If throttling is disabled, the property value is `null`.
                 Default: 1.
            throttling_unit (ResellerCloudConnectQuotaType0ThrottlingUnit | Unset): Measurement units of the amount of
                incoming network traffic accepted from reseller clients. Default:
                ResellerCloudConnectQuotaType0ThrottlingUnit.MBYTEPERSEC.
            max_concurrent_task (int | None | Unset): Maximum number of concurrent tasks that reseller clients can perform.
                > If concurrent tasks count is unlimited, the property value is `null`.
                 Default: 1.
            is_wan_acceleration_enabled (bool | Unset): Indicates whether WAN acceleration is enabled for replication jobs
                of reseller clients. Default: False.
    """

    data_transfer_out_quota: int | None | Unset = UNSET
    insider_protection_quota: int | None | Unset = 1
    throttling_value: int | None | Unset = 1
    throttling_unit: ResellerCloudConnectQuotaType0ThrottlingUnit | Unset = (
        ResellerCloudConnectQuotaType0ThrottlingUnit.MBYTEPERSEC
    )
    max_concurrent_task: int | None | Unset = 1
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        insider_protection_quota: int | None | Unset
        ...
        max_concurrent_task: int | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_insider_protection_quota(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_max_concurrent_task(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
