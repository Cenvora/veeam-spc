...
class ResellerCloudConnectQuota:
    ...
    it to `null`.
        ...
        Attributes:
            data_transfer_out_quota (int | Unset): Maximum amount of data transfer out traffic available to a reseller, in
                bytes.
                > If quota is unlimited, the property value is `null`.
            insider_protection_quota (int | Unset): Number of days during which deleted backup files of reseller clients
                must be kept in the recycle bin by the service provider.
                > If quota is unlimited, the property value is `null`.
                 Default: 1.
            throttling_value (int | Unset): Maximum amount of incoming network traffic accepted from reseller clients.
                > If throttling is disabled, the property value is `null`.
                 Default: 1.
            throttling_unit (ResellerCloudConnectQuotaThrottlingUnit | Unset): Measurement units of the amount of incoming
                network traffic accepted from reseller clients. Default: ResellerCloudConnectQuotaThrottlingUnit.MBYTEPERSEC.
            max_concurrent_task (int | Unset): Maximum number of concurrent tasks that reseller clients can perform.
    ...
    insider_protection_quota: int | Unset = 1
    throttling_value: int | Unset = 1
    throttling_unit: ResellerCloudConnectQuotaThrottlingUnit | Unset = (
