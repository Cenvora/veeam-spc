...
class BackupServerBackupJobRetentionPolicySettings:
    ...
    Attributes:
        type_ (BackupServerBackupJobRetentionPolicyType | Unset): Type of a retention policy.
        quantity (int | Unset): Number of restore points or days that must must be stored. Default: 7.
    """

    type_: BackupServerBackupJobRetentionPolicyType | Unset = UNSET
    quantity: int | Unset = 7
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: BackupServerBackupJobRetentionPolicyType | Unset
