...
class BackupServerAgentJob:
    ...
    Attributes:
        ...
        total_jobs_count (int | Unset): Number of job sessions.
        success_jobs_count (int | Unset): Number of successful job sessions.
        destination (str | Unset): Location of backup files.
        source (BackupServerAgentJobSource | Unset):
    ...
    source: BackupServerAgentJobSource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_mode: BackupServerAgentJobJobMode | Unset
        ...
        os_type: BackupServerAgentJobOsType | Unset
        ...
        license_type: BackupServerAgentJobLicenseType | Unset
