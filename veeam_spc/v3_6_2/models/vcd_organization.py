...
class VcdOrganization:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a VMware Cloud Director organization.
        urn (str | Unset): URN of a VMware Cloud Director organization. That identifier must be used on working with Vcd
            job configuration.
        name (str | Unset): Name of a VMware Cloud Director organization.
        vcd_server_uid (UUID | Unset): UID assigned to a VMware Cloud Director server.
        backup_server_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        hosted_backup_server (bool | Unset): Indicates whether an organization VMware Cloud Director server is connected
            to a hosted Veeam Backup & Replication server.
        can_be_mapped_as_hosted_resource (bool | Unset): Indicates whether a VMware Cloud Director organization can be
            mapped to a company as a hosted resource.
    ...
    vcd_server_uid: UUID | Unset = UNSET
    backup_server_uid: UUID | Unset = UNSET
    hosted_backup_server: bool | Unset = UNSET
    can_be_mapped_as_hosted_resource: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        vcd_server_uid: str | Unset = UNSET
