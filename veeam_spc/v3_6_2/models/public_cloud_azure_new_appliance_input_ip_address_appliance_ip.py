...
class PublicCloudAzureNewApplianceInputIpAddressApplianceIp:
    ...
    > Send only one of the following properties.
        ...
        Attributes:
            appliance_ip_address_id (None | str | Unset): Veeam Backup for Public Clouds appliance elastic IP address.
            new_ip_address_type (PublicCloudAzureNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset): Type of a
                new IP address that must be generated automatically.
    """

    appliance_ip_address_id: None | str | Unset = UNSET
    new_ip_address_type: PublicCloudAzureNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        appliance_ip_address_id: None | str | Unset
        ...
        new_ip_address_type: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_appliance_ip_address_id(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        new_ip_address_type: PublicCloudAzureNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset
