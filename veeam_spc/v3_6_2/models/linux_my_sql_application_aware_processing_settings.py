...
class LinuxMySqlApplicationAwareProcessingSettings:
    """
    Attributes:
        processing_type (LinuxMySqlApplicationAwareProcessingSettingsProcessingType | Unset): Transaction log processing
            mode. Default: LinuxMySqlApplicationAwareProcessingSettingsProcessingType.DISABLEPROCESS.
