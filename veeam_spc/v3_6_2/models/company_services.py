...
class CompanyServices:
    """
    Attributes:
        hosted_services (CompanyHostedServices | Unset):
        remote_services (CompanyRemoteServices | Unset):
    """

    hosted_services: CompanyHostedServices | Unset = UNSET
    remote_services: CompanyRemoteServices | Unset = UNSET
