...
class BackupServerBackupJobStorageSettingsEncryptionType0:
    ...
    Attributes:
        is_enabled (bool | Unset): Indicates whether backup file content encryption is enabled. Default: False.
        encryption_type (BackupServerEncryptionTypeNullable | Unset): Type of backup file content encryption.
        encryption_password_id (None | Unset | UUID): ID assigned to a password used for encryption.
            >For exported objects, the property value is `null`.
        encryption_password_tag (None | str | Unset): Tag used to identify the password.
        kms_server_id (None | Unset | UUID): ID assigned to a Key Management Server.
    """

    is_enabled: bool | Unset = False
    encryption_type: BackupServerEncryptionTypeNullable | Unset = UNSET
    encryption_password_id: None | Unset | UUID = UNSET
    encryption_password_tag: None | str | Unset = UNSET
    kms_server_id: None | Unset | UUID = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        encryption_password_id: None | str | Unset
        ...
        encryption_password_tag: None | str | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encryption_type: BackupServerEncryptionTypeNullable | Unset
        ...
        def _parse_encryption_password_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
        ...
        def _parse_encryption_password_tag(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_kms_server_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
