...
T = TypeVar("T", bound="EmbeddedForBackupServerRepositoryChildrenType0")


@_attrs_define
class EmbeddedForBackupServerRepositoryChildrenType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_for_backup_server_repository_children_type_0 = cls(
            backup_repository=backup_repository,
        )

        embedded_for_backup_server_repository_children_type_0.additional_properties = d
        return embedded_for_backup_server_repository_children_type_0
