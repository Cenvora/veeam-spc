...
class SiteLicense:
    ...
    Attributes:
        ...
        status (SiteLicenseStatus | Unset): Current status of a license.
        cloud_connect (SiteLicenseCloudConnect | Unset): Indicates whether a license includes Veeam Cloud Connect.
        units (float | Unset): Number of available license units.
        used_units (float | Unset): Number of used license units.
        unit_type (SiteLicenseUnitType | Unset): Type of license units.
        type_ (SiteLicenseType | Unset): Type of a license.
    """
    ...
    status: SiteLicenseStatus | Unset = UNSET
    cloud_connect: SiteLicenseCloudConnect | Unset = UNSET
    units: float | Unset = UNSET
    used_units: float | Unset = UNSET
    unit_type: SiteLicenseUnitType | Unset = UNSET
    type_: SiteLicenseType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        section_types: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        license_ids: list[UUID] | Unset = UNSET
        if _license_ids is not UNSET:
            license_ids = []
            for license_ids_item_data in _license_ids:
        ...
        section_types: list[SiteLicenseSectionTypesItem] | Unset = UNSET
        if _section_types is not UNSET:
            section_types = []
            for section_types_item_data in _section_types:
                section_types_item = SiteLicenseSectionTypesItem(section_types_item_data)

                section_types.append(section_types_item)

        _status = d.pop("status", UNSET)
        status: SiteLicenseStatus | Unset
        ...
        cloud_connect: SiteLicenseCloudConnect | Unset
        ...
        unit_type: SiteLicenseUnitType | Unset
