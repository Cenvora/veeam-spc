...
T = TypeVar("T", bound="GetVdcVaultTenantResponse200")


@_attrs_define
class GetVdcVaultTenantResponse200:
    """
    Attributes:
        data (VdcVaultTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vdc_vault_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_tenant_response_200.additional_properties = d
        return get_vdc_vault_tenant_response_200
