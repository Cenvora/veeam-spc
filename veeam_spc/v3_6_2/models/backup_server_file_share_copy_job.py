...
class BackupServerFileShareCopyJob:
    ...
    Attributes:
        ...
        source_file_share_job_uid (UUID | Unset): UID assigned to a source file share job in Veeam Backup & Replication
        source_file_share_job_unique_uid (UUID | Unset): UID assigned to a source file share job in Veeam Service
            Provider Console.
        target_repository_uid (UUID | Unset): UID assigned to a target backup repository.
        retention (int | Unset): Duration of backup file retention.
        retention_unit (BackupServerFileShareCopyJobRetentionUnit | Unset): Measurement units of backup file retention
            duration.
        source_size (int | Unset): Size of a job source, in bytes.
    ...
    source_file_share_job_uid: UUID | Unset = UNSET
    source_file_share_job_unique_uid: UUID | Unset = UNSET
    target_repository_uid: UUID | Unset = UNSET
    retention: int | Unset = UNSET
    retention_unit: BackupServerFileShareCopyJobRetentionUnit | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_file_share_job_uid: UUID | Unset
        ...
        source_file_share_job_unique_uid: UUID | Unset
        ...
        retention_unit: BackupServerFileShareCopyJobRetentionUnit | Unset
