...
class WindowsAdvancedJobSettings:
    """
    Attributes:
        backup_storage (WindowsBackupStorage | Unset):
        schedule_settings (WindowsAdvancedScheduleSettings | Unset):
        maintenance_settings (WindowsMaintenanceJobSettings | Unset):
    """

    backup_storage: WindowsBackupStorage | Unset = UNSET
    schedule_settings: WindowsAdvancedScheduleSettings | Unset = UNSET
    maintenance_settings: WindowsMaintenanceJobSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        maintenance_settings: dict[str, Any] | Unset = UNSET
