...
class BackupServerBackupJobFullBackupMaintenanceType0:
    ...
    Attributes:
        remove_data (BackupServerBackupJobFullBackupMaintenanceRemoveDataType0 | None | Unset): Backup data settings for
            deleted VMs.
        defragment_and_compact (BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompactType0 | None | Unset):
            Compact operation settings.
    """

    remove_data: BackupServerBackupJobFullBackupMaintenanceRemoveDataType0 | None | Unset = UNSET
    defragment_and_compact: BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompactType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        remove_data: dict[str, Any] | None | Unset
        ...
        defragment_and_compact: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_remove_data(
            data: object,
        ) -> BackupServerBackupJobFullBackupMaintenanceRemoveDataType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BackupServerBackupJobFullBackupMaintenanceRemoveDataType0 | None | Unset, data)
        ...
        def _parse_defragment_and_compact(
            ...
            try:
                ...
                pass
            return cast(BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompactType0 | None | Unset, data)
