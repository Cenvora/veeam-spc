...
class CompanyHostedVbrTagResource:
    """
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a company tag resource.
        company_uid (UUID | Unset): UID assigned to a company.
        hosted_resource_uid (UUID | Unset): UID assigned to a company hosted resource.
        tag_urn (str | Unset): URN assigned to a tag.
        tag_name (str | Unset): Name of a tag.
        virtual_center_uid (UUID | Unset): UID assigned to a vCenter Server.
    """

    instance_uid: UUID | Unset = UNSET
    company_uid: UUID | Unset = UNSET
    hosted_resource_uid: UUID | Unset = UNSET
    tag_urn: str | Unset = UNSET
    tag_name: str | Unset = UNSET
    virtual_center_uid: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        virtual_center_uid: str | Unset = UNSET
