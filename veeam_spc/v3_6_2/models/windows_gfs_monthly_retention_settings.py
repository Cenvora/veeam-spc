...
class WindowsGfsMonthlyRetentionSettings:
    ...
    Attributes:
        ...
        use_weekly_full_backup_for_the_following_week_of_month
            (WindowsGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset): Week when Veeam
            Backup & Replication must assign the monthly GFS flag to a full restore point. Default:
    ...
    use_weekly_full_backup_for_the_following_week_of_month: (
        WindowsGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset
    ) = WindowsGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST
