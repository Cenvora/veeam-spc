...
class Vb365JobItemSite:
    ...
    Attributes:
        ...
        url (str): Site URL.
        name (str | Unset): Name of a site.
        parent_url (str | Unset): Parent URL of a site.
        is_cloud (bool | Unset): Indicates whether a site is cloud-based.
        is_personal (bool | Unset): Indicates whether a site is personal.
        is_available (bool | Unset): Indicates whether a site can be included in a backup job.
        site_collection_error (str | Unset): Message for site collection processing error.
    """
