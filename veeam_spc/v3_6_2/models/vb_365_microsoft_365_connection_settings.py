...
class Vb365Microsoft365ConnectionSettings:
    """
    Attributes:
        modern_app_only_authentication_settings (Vb365Microsoft365ModernAppOnlyAuthenticationConnectionSettings |
            Unset):
        modern_authentication_with_legacy_protocols_settings
            (Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsConnectionSettings | Unset):
        basic_authentication_settings (Vb365Microsoft365BasicAuthenticationConnectionSettings | Unset):
    """

    modern_app_only_authentication_settings: Vb365Microsoft365ModernAppOnlyAuthenticationConnectionSettings | Unset = (
        UNSET
    )
    modern_authentication_with_legacy_protocols_settings: (
        Vb365Microsoft365ModernAuthenticationWithLegacyProtocolsConnectionSettings | Unset
    ) = UNSET
    basic_authentication_settings: Vb365Microsoft365BasicAuthenticationConnectionSettings | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        modern_app_only_authentication_settings: dict[str, Any] | Unset = UNSET
        ...
        modern_authentication_with_legacy_protocols_settings: dict[str, Any] | Unset = UNSET
        ...
        basic_authentication_settings: dict[str, Any] | Unset = UNSET
