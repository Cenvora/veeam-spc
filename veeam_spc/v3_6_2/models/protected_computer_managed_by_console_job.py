...
class ProtectedComputerManagedByConsoleJob:
    ...
    Attributes:
        ...
        job_uid (None | Unset | UUID): UID assigned to a job that protects the computer.
        job_name (str | Unset): Name of a job that protects the computer.
        source_size (int | None | Unset): Size of protected data, in bytes.
        ...
        latest_restore_point_date (datetime.datetime | None | Unset): Date and time of the latest restore point
            creation.
        target_type (ProtectedComputerManagedByConsoleJobTargetType | Unset): Type of a target repository.
    """
    ...
    target_type: ProtectedComputerManagedByConsoleJobTargetType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target_type: ProtectedComputerManagedByConsoleJobTargetType | Unset
