...
class ComputerInfo:
    ...
    Attributes:
        unique_uid (UUID | Unset): UID assigned to a computer.
        bios_uuid (UUID | Unset): UUID in Win32_ComputerSystem WMI class.
        host_name (str | Unset): Name of a computer.
        fqdn (str | Unset): FQDN of a computer.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        guest_os_type: ComputerInfoGuestOsType | Unset
