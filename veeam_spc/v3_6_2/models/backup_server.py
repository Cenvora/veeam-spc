...
class BackupServer:
    ...
    Attributes:
        instance_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        name (str | Unset): Name of a Veeam Backup & Replication server.
        ...
        management_agent_uid (UUID | Unset): UID assigned to a management agent installed on a Veeam Backup &
            Replication server.
        version (str | Unset): Version of Veeam Backup & Replication installed on a server.
        display_version (str | Unset): Version of Veeam Backup & Replication with additional information on installed
            patch version.
        installation_uid (str | Unset): UID assigned to Veeam Backup & Replication installation.
        backup_server_role_type (BackupServerBackupServerRoleType | Unset): Role of a Veeam Backup & Replication server.
    ...
    display_version: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_server_role_type: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_role_type: BackupServerBackupServerRoleType | Unset
        ...
        status: BackupServerStatus | Unset
