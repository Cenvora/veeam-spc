...
class PublicCloudAzureAddExistingApplianceInput:
    ...
    Attributes:
        ...
        network (None | PublicCloudAzureAddExistingApplianceInputNetworkType0 | Unset):
    """

    account: PublicCloudAzureAddExistingApplianceInputAccount
    virtual_machine: PublicCloudAzureAddExistingApplianceInputVirtualMachine
    guest_os_credentials: PublicCloudAzureAddExistingApplianceInputGuestOsCredentials
    network: None | PublicCloudAzureAddExistingApplianceInputNetworkType0 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_network(data: object) -> None | PublicCloudAzureAddExistingApplianceInputNetworkType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | PublicCloudAzureAddExistingApplianceInputNetworkType0 | Unset, data)
