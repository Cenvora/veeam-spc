...
class MacBackupSource:
    """
    Attributes:
        backup_directly_from_live_file_system (bool | Unset): Indicates whether backup is performed without creating
            snapshot. Required when backing up data stored in shared folders and file systems that are not supported by
            Veeam snapshot module. Default: False.
