...
class BackupServerBackupJobGuestOsCredentialsType0:
    ...
    Attributes:
        ...
        credentials_per_machine (list[BackupServerBackupJobGuestOsCredentialsPerMachine] | None | Unset): Array of
            individual credentials for VMs.
    """

    credentials_id: UUID
    credentials_type: BackupServerCredentialsType
    credentials_per_machine: list[BackupServerBackupJobGuestOsCredentialsPerMachine] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        credentials_per_machine: list[dict[str, Any]] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_credentials_per_machine(
            data: object,
        ) -> list[BackupServerBackupJobGuestOsCredentialsPerMachine] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[BackupServerBackupJobGuestOsCredentialsPerMachine] | None | Unset, data)
