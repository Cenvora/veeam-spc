...
class BackupFailoverPlanLastSessionType0:
    ...
    Attributes:
        ...
        end_time (datetime.datetime | None | Unset): Date and time when the latest failover plan session ended.
        status (BackupFailoverPlanSessionStatus | Unset): Status of a failover plan session.
        message (None | str | Unset): Message that is displayed in case of failover plan failure or warnings.
        detailed_messages (list[BackupFailoverPlanSessionMessage] | None | Unset): Array of detailed log messages.
            Available only in Veeam Backup & Replication v13 or later.
    """
    ...
    detailed_messages: list[BackupFailoverPlanSessionMessage] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        detailed_messages: list[dict[str, Any]] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_detailed_messages(data: object) -> list[BackupFailoverPlanSessionMessage] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[BackupFailoverPlanSessionMessage] | None | Unset, data)
