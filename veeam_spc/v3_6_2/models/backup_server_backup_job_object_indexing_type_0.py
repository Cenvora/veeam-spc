...
class BackupServerBackupJobObjectIndexingType0:
    ...
    Attributes:
        ...
        indexing_list (list[str] | None | Unset): Array of folders.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_indexing_list(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
