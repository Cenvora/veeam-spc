...
class WindowsFullBackupFileMaintenanceSettings:
    """
    Attributes:
        enable_deleted_files_retention (bool | Unset): [For Veeam backup repository and cloud repository targets]
            Defines whether the deleted backup files must be removed after a specific time period. Default: False.
        remove_deleted_items_data_after (int | Unset): [For Veeam backup repository and cloud repository targets] Number
            of days for which the deleted backup files are stored. Default: 30.
        defragment_and_compact_full_backup_file_settings (MonthlyOrWeeklyScheduleSettings | Unset):
    """

    enable_deleted_files_retention: bool | Unset = False
    remove_deleted_items_data_after: int | Unset = 30
    defragment_and_compact_full_backup_file_settings: MonthlyOrWeeklyScheduleSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        defragment_and_compact_full_backup_file_settings: dict[str, Any] | Unset = UNSET
