...
class LinuxGfsMonthlyRetentionSettings:
    ...
    Attributes:
        ...
        use_weekly_full_backup_for_the_following_week_of_month
            (LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset): Week when Veeam Backup
    ...
    use_weekly_full_backup_for_the_following_week_of_month: (
        LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset
    ) = LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST
