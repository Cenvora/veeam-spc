...
class MacGfsMonthlyRetentionSettings:
    ...
    Attributes:
        ...
        use_weekly_full_backup_for_the_following_week_of_month
            (MacGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset): Week of a month when
            Veeam Backup & Replication must assign the monthly GFS flag to a full restore point. Default:
            MacGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST.
    """

    keep_monthly_backups_for_months: int = 1
    use_weekly_full_backup_for_the_following_week_of_month: (
        MacGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth | Unset
    ) = MacGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        use_weekly_full_backup_for_the_following_week_of_month: str | Unset = UNSET
