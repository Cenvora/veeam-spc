...
class BackupServerBackupJobActiveFullSettingsType0:
    ...
    Attributes:
        ...
        weekly (BackupServerBackupJobAdvancedStorageScheduleWeeklyType0 | None | Unset): Weekly schedule settings.
        monthly (BackupServerBackupJobAdvancedStorageScheduleMonthlyType0 | None | Unset): Monthly schedule settings.
    """

    is_enabled: bool
    weekly: BackupServerBackupJobAdvancedStorageScheduleWeeklyType0 | None | Unset = UNSET
    monthly: BackupServerBackupJobAdvancedStorageScheduleMonthlyType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weekly(data: object) -> BackupServerBackupJobAdvancedStorageScheduleWeeklyType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BackupServerBackupJobAdvancedStorageScheduleWeeklyType0 | None | Unset, data)

        weekly = _parse_weekly(d.pop("weekly", UNSET))

        def _parse_monthly(data: object) -> BackupServerBackupJobAdvancedStorageScheduleMonthlyType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(BackupServerBackupJobAdvancedStorageScheduleMonthlyType0 | None | Unset, data)
