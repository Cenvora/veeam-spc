...
class BackupServerVSphereChangedBlockTrackingSettingsType0:
    ...
    Attributes:
        is_enabled (bool | Unset): Indicates whether CBT is enabled. Default: True.
        enable_cbt_automatically (bool | Unset): Indicates whether CBT is enabled for all processed VMs even if CBT is
            disabled in VM configuration.
            >CBT is used for VMs with virtual hardware version 7 or later.
            >VMs must not have existing snapshots.
             Default: True.
        reset_cbt_on_active_full (bool | Unset): Indicates whether CBT is reset before creating active full backups.
            Default: True.
    """

    is_enabled: bool | Unset = True
    enable_cbt_automatically: bool | Unset = True
    reset_cbt_on_active_full: bool | Unset = True
