...
T = TypeVar("T", bound="GetMountServersResponse200")


@_attrs_define
class GetMountServersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mount_servers_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_mount_servers_response_200.additional_properties = d
        return get_mount_servers_response_200
