...
class BackupServerBackupJobGFSPolicySettingsYearly:
    ...
    Attributes:
        ...
        keep_for_number_of_years (int | Unset): Number of years during which restore points must be stored.
        desired_time (BackupServerBackupJobGFSPolicySettingsYearlyDesiredTime | Unset): Month when the yearly restore
            point must be created.
    """

    is_enabled: bool
    keep_for_number_of_years: int | Unset = UNSET
    desired_time: BackupServerBackupJobGFSPolicySettingsYearlyDesiredTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        desired_time: BackupServerBackupJobGFSPolicySettingsYearlyDesiredTime | Unset
