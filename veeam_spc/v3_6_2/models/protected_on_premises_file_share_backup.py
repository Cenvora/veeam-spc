...
class ProtectedOnPremisesFileShareBackup:
    ...
    Attributes:
        ...
        job_uid (None | Unset | UUID): UID assigned to a backup job that protects a file share.
        ...
        sources (list[ProtectedOnPremisesFileShareSource] | Unset): File share backup scope.
    """
    ...
    sources: list[ProtectedOnPremisesFileShareSource] | Unset = UNSET
