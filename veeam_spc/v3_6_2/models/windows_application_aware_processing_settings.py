...
class WindowsApplicationAwareProcessingSettings:
    """
    Attributes:
        enabled (bool | Unset): Indicates whether the application-aware processing is enabled. Default: False.
        transaction_log_processing_mode (WindowsApplicationAwareProcessingSettingsTransactionLogProcessingMode | Unset):
            Application-aware processing type. Default:
            WindowsApplicationAwareProcessingSettingsTransactionLogProcessingMode.PROCESSTRANSACTIONLOGSWITHJOB.
        sql_server_transaction_log_handling_settings (WindowsSqlServerTransactionLogHandlingSettings | Unset):
        oracle_transaction_log_handling_settings (WindowsOracleTransactionLogHandlingSettings | Unset):
        share_point_account_settings (SharePointAccountSettings | Unset):
        script_settings (WindowsJobScriptSettings | Unset):
    """
    ...
    sql_server_transaction_log_handling_settings: WindowsSqlServerTransactionLogHandlingSettings | Unset = UNSET
    oracle_transaction_log_handling_settings: WindowsOracleTransactionLogHandlingSettings | Unset = UNSET
    share_point_account_settings: SharePointAccountSettings | Unset = UNSET
    script_settings: WindowsJobScriptSettings | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        enabled = self.enabled

        transaction_log_processing_mode: str | Unset = UNSET
        ...
        sql_server_transaction_log_handling_settings: dict[str, Any] | Unset = UNSET
        ...
        oracle_transaction_log_handling_settings: dict[str, Any] | Unset = UNSET
        ...
        share_point_account_settings: dict[str, Any] | Unset = UNSET
