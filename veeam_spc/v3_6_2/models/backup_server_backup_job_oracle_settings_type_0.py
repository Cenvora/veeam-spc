...
class BackupServerBackupJobOracleSettingsType0:
    ...
    Attributes:
        ...
        credentials_id (None | Unset | UUID): UID assigned to a credentials record that is used to access Oracle
            database in case the `useGuestCredentials` property has the `false` value.
        delete_hours_count (int | Unset): Time period during which archived logs must be kept, in hours.
            >Required if the `archiveLogs` property has the `deleteExpiredHours` value.
             Default: 24.
        delete_g_bs_count (int | Unset): Archive log size threshold, in GB.
            >Required if the `archiveLogs` praperty has the `deleteExpiredGBs` value.
             Default: 15.
        backup_logs (bool | Unset): Indicates whether archived logs must be backed up. Default: False.
        backup_minutes_count (int | Unset): Frequency of archived log backup, in minutes. Default: 15.
        retain_log_backups (BackupServerBackupJobRetainLogBackupsType | Unset): Type of log retention policy.
        keep_days_count (int | Unset): Number of days during which archived log backups must be stored. Default: 15.
        log_shipping_servers (BackupServerBackupJobLogShippingServersType0 | None | Unset): Log shipping servers used to
    ...
    delete_hours_count: int | Unset = 24
    delete_g_bs_count: int | Unset = 15
    backup_logs: bool | Unset = False
    backup_minutes_count: int | Unset = 15
    retain_log_backups: BackupServerBackupJobRetainLogBackupsType | Unset = UNSET
    keep_days_count: int | Unset = 15
    log_shipping_servers: BackupServerBackupJobLogShippingServersType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        log_shipping_servers: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retain_log_backups: BackupServerBackupJobRetainLogBackupsType | Unset
        ...
        def _parse_log_shipping_servers(data: object) -> BackupServerBackupJobLogShippingServersType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(BackupServerBackupJobLogShippingServersType0 | None | Unset, data)
