...
class BackupServerFileTapeJobObject:
    ...
    Attributes:
        ...
        host_name (str | Unset): Host name of a server, on which protected files and folders reside.
        sources (list[BackupServerFileTapeJobObjectSource] | Unset): Array of protected files and folders.
    ...
    sources: list[BackupServerFileTapeJobObjectSource] | Unset = UNSET
