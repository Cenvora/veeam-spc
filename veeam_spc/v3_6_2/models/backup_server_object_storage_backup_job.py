...
class BackupServerObjectStorageBackupJob:
    ...
    Attributes:
        ...
        retention_unit (BackupServerObjectStorageBackupJobRetentionUnit | Unset): Measurement units of file retention
            duration.
        ...
        archive_retention_unit (BackupServerObjectStorageBackupJobArchiveRetentionUnit | Unset): Measurement units of
            long-term file retention duration.
    ...
    retention_unit: BackupServerObjectStorageBackupJobRetentionUnit | Unset = UNSET
    is_archive_retention_enabled: bool | Unset = UNSET
    archive_retention: int | Unset = UNSET
    archive_retention_unit: BackupServerObjectStorageBackupJobArchiveRetentionUnit | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_unit: BackupServerObjectStorageBackupJobRetentionUnit | Unset
        ...
        archive_retention_unit: BackupServerObjectStorageBackupJobArchiveRetentionUnit | Unset
