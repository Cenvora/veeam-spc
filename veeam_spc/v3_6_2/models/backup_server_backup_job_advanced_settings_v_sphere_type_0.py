...
class BackupServerBackupJobAdvancedSettingsVSphereType0:
    ...
    Attributes:
        enable_vm_ware_tools_quiescence (bool | Unset): Indicates whether VMware Tools quiescence is enabled for
            freezing the VM file system and application data. Default: False.
        changed_block_tracking (BackupServerVSphereChangedBlockTrackingSettingsType0 | None | Unset): Changed block
            tracking settings.
    """

    enable_vm_ware_tools_quiescence: bool | Unset = False
    changed_block_tracking: BackupServerVSphereChangedBlockTrackingSettingsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        changed_block_tracking: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_changed_block_tracking(
            data: object,
        ) -> BackupServerVSphereChangedBlockTrackingSettingsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BackupServerVSphereChangedBlockTrackingSettingsType0 | None | Unset, data)
