...
class PolicySettings:
    ...
    Attributes:
        ...
        enforce_mfa_policy (bool | None | Unset): Indicates whether MFA policy is applied to child organizations.
    ...
    enforce_mfa_policy: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        enforce_mfa_policy: bool | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_enforce_mfa_policy(data: object) -> bool | None | Unset:
            if data is None:
                return data
