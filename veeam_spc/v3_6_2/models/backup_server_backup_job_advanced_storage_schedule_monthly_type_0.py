...
class BackupServerBackupJobAdvancedStorageScheduleMonthlyType0:
    ...
    Attributes:
        ...
        day_number_in_month (BackupServerBackupJobDayNumberInMonthNullable | Unset): Ordinal number of the week on which
            a job must start.
        day_of_months (int | None | Unset): Numerical value of the day when the operation is performed.
        months (list[Month] | None | Unset): Months when the operation is performed.
    """

    is_enabled: bool
    day_of_week: DaysOfWeekNullable | Unset = UNSET
    day_number_in_month: BackupServerBackupJobDayNumberInMonthNullable | Unset = UNSET
    day_of_months: int | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        day_number_in_month: BackupServerBackupJobDayNumberInMonthNullable | Unset
        ...
        def _parse_day_of_months(data: object) -> int | None | Unset:
            if data is None:
                return data
