...
class LinuxBackupStorage:
    """
    Attributes:
        compression_level (LinuxBackupStorageCompressionLevel | Unset): Compression level for the backup. Default:
            LinuxBackupStorageCompressionLevel.OPTIMAL.
        block_size (LinuxBackupStorageBlockSize | Unset): Type of data block size. Default:
        ...
        is_snapshot_required (bool | Unset): Indicates whether Veeam Agent for Linux must create a snapshot of a backed-
            up volume during backup. Default: True.
    """

    compression_level: LinuxBackupStorageCompressionLevel | Unset = LinuxBackupStorageCompressionLevel.OPTIMAL
    block_size: LinuxBackupStorageBlockSize | Unset = LinuxBackupStorageBlockSize.LOCAL1MB
    encryption_enabled: bool | Unset = False
    password: None | str | Unset = UNSET
    password_hint: None | str | Unset = UNSET
    is_snapshot_required: bool | Unset = True
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        compression_level: LinuxBackupStorageCompressionLevel | Unset
        ...
        block_size: LinuxBackupStorageBlockSize | Unset
