...
class LinuxJobApplicationAwareProcessingSettings:
    """
    Attributes:
        oracle_aap_settings (LinuxOracleApplicationAwareProcessingSettings | Unset):
        my_sql_aap_settings (LinuxMySqlApplicationAwareProcessingSettings | Unset):
        postgre_sql_aap_settings (LinuxPostgreSqlApplicationAwareProcessingSettings | Unset):
    """

    oracle_aap_settings: LinuxOracleApplicationAwareProcessingSettings | Unset = UNSET
    my_sql_aap_settings: LinuxMySqlApplicationAwareProcessingSettings | Unset = UNSET
    postgre_sql_aap_settings: LinuxPostgreSqlApplicationAwareProcessingSettings | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        oracle_aap_settings: dict[str, Any] | Unset = UNSET
        if not isinstance(self.oracle_aap_settings, Unset):
            oracle_aap_settings = self.oracle_aap_settings.to_dict()

        my_sql_aap_settings: dict[str, Any] | Unset = UNSET
        if not isinstance(self.my_sql_aap_settings, Unset):
            my_sql_aap_settings = self.my_sql_aap_settings.to_dict()

        postgre_sql_aap_settings: dict[str, Any] | Unset = UNSET
