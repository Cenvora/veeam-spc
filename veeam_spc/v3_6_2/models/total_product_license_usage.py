...
class TotalProductLicenseUsage:
    """
    Attributes:
        product_type (TotalProductLicenseUsageProductType | Unset): Product type.
        total_points (float | Unset): Number of used license points.
    ...
    product_type: TotalProductLicenseUsageProductType | Unset = UNSET
    total_points: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        workload_usage: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_type: TotalProductLicenseUsageProductType | Unset
        ...
        workload_usage: list[WorkloadLicenseUsage] | Unset = UNSET
        if _workload_usage is not UNSET:
            workload_usage = []
            for workload_usage_item_data in _workload_usage:
