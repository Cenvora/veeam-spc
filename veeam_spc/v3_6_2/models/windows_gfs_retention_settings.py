...
class WindowsGfsRetentionSettings:
    """
    Attributes:
        weekly (WindowsGfsWeeklyRetentionSettings | Unset):
        monthly (WindowsGfsMonthlyRetentionSettings | Unset):
        yearly (WindowsGfsYearlyRetentionSettings | Unset):
    """

    weekly: WindowsGfsWeeklyRetentionSettings | Unset = UNSET
    monthly: WindowsGfsMonthlyRetentionSettings | Unset = UNSET
    yearly: WindowsGfsYearlyRetentionSettings | Unset = UNSET
