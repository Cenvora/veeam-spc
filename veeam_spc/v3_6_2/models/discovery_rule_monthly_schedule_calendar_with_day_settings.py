...
class DiscoveryRuleMonthlyScheduleCalendarWithDaySettings:
    ...
    Attributes:
        ...
        week_day_number (DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsWeekDayNumber | Unset): Ordinal number of
            the week.
            > Required for the `DayOfWeek` schedule type.
        day_of_week (DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsDayOfWeek | Unset): Week day.
            > Required for the `DayOfWeek` schedule type.
    ...
    week_day_number: DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsWeekDayNumber | Unset = UNSET
    day_of_week: DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsDayOfWeek | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        week_day_number: DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsWeekDayNumber | Unset
        ...
        day_of_week: DiscoveryRuleMonthlyScheduleCalendarWithDaySettingsDayOfWeek | Unset
