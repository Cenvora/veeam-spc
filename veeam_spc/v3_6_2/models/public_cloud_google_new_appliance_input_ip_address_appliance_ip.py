...
class PublicCloudGoogleNewApplianceInputIpAddressApplianceIp:
    ...
    > Send only one of the following properties.
        ...
        Attributes:
            appliance_ip_address_id (None | str | Unset): ID assigned to a specific IP address.
            new_ip_address_type (PublicCloudGoogleNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset): Type of an
                IP address that must be generated automatically.
    """

    appliance_ip_address_id: None | str | Unset = UNSET
    new_ip_address_type: PublicCloudGoogleNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_ip_address_type: PublicCloudGoogleNewApplianceInputIpAddressApplianceIpNewIpAddressType | Unset
