...
class JobSessionHeatmapSession:
    """
    Attributes:
        job_name (str | Unset): Name of a job.
        server_name (str | Unset): Name of a server on which a job is configured.
        management_agent_uid (UUID | Unset): UID assigned to a management agent.
        location_name (str | Unset): Name of a location to which a job belongs.
        location_uid (UUID | Unset): UID assigned to a location to which a job belongs.
        organization_name (str | Unset): Name of an organization to which a job belongs.
        organization_uid (UUID | Unset): UID assigned to an organization to which a job belongs.
        start_time (datetime.datetime | Unset): Date and time when a job session started.
        ...
        workload_type (JobSessionHeatmapWorkloadType | Unset): Type of workloads processed by a job session.
        platform_type (JobSessionHeatmapPlatformType | Unset): Platform of processed workloads.
    """
    ...
    workload_type: JobSessionHeatmapWorkloadType | Unset = UNSET
    platform_type: JobSessionHeatmapPlatformType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        result: JobSessionHeatmapJobResult | Unset
        ...
        job_type: JobSessionHeatmapJobType | Unset
        ...
        workload_type: JobSessionHeatmapWorkloadType | Unset
        ...
        platform_type: JobSessionHeatmapPlatformType | Unset
