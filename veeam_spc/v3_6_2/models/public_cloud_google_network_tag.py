...
class PublicCloudGoogleNetworkTag:
    """
    Attributes:
        network_tag_id (str | Unset): ID assigned to a network tag.
        network_tag_name (str | Unset): Name of a network tag.
    """

    network_tag_id: str | Unset = UNSET
    network_tag_name: str | Unset = UNSET
