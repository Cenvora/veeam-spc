...
class BackupServerBackupJobNotificationSettingsType0:
    ...
    Attributes:
        send_snmp_notifications (bool | Unset): Indicates whether SNMP notifications are enabled for a job. Default:
            False.
        email_notifications (BackupServerEmailNotificationSettingsType0 | None | Unset): Email notification settings.
        vm_attribute (BackupServerNotificationVmAttributeSettingsType0 | None | Unset): VM attribute settings.
    """

    send_snmp_notifications: bool | Unset = False
    email_notifications: BackupServerEmailNotificationSettingsType0 | None | Unset = UNSET
    vm_attribute: BackupServerNotificationVmAttributeSettingsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        email_notifications: dict[str, Any] | None | Unset
        ...
        vm_attribute: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_email_notifications(data: object) -> BackupServerEmailNotificationSettingsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BackupServerEmailNotificationSettingsType0 | None | Unset, data)

        email_notifications = _parse_email_notifications(d.pop("emailNotifications", UNSET))

        def _parse_vm_attribute(data: object) -> BackupServerNotificationVmAttributeSettingsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(BackupServerNotificationVmAttributeSettingsType0 | None | Unset, data)
