...
class MacJobScheduleSettings:
    """
    Attributes:
        schedule_type (MacJobScheduleSettingsScheduleType | Unset): Type of job periodicity. Default:
            MacJobScheduleSettingsScheduleType.NOTSCHEDULED.
        daily_schedule_settings (MacDailyScheduleSettings | Unset):
        monthly_schedule_settings (MacMonthlyScheduleSettings | Unset):
        periodically_schedule_settings (MacPeriodicallyScheduleSettings | Unset):
        active_full_settings (MacActiveFullSettings | Unset):
        retry_settings (MacScheduleRetrySettings | Unset):
        backup_health_check_schedule_settings (MacBackupHealthCheckScheduleSettings | Unset):
        synthetic_full_settings (MacSyntheticFullSettings | Unset):
    """

    schedule_type: MacJobScheduleSettingsScheduleType | Unset = MacJobScheduleSettingsScheduleType.NOTSCHEDULED
    daily_schedule_settings: MacDailyScheduleSettings | Unset = UNSET
    monthly_schedule_settings: MacMonthlyScheduleSettings | Unset = UNSET
    periodically_schedule_settings: MacPeriodicallyScheduleSettings | Unset = UNSET
    active_full_settings: MacActiveFullSettings | Unset = UNSET
    retry_settings: MacScheduleRetrySettings | Unset = UNSET
    backup_health_check_schedule_settings: MacBackupHealthCheckScheduleSettings | Unset = UNSET
    synthetic_full_settings: MacSyntheticFullSettings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_type: MacJobScheduleSettingsScheduleType | Unset
