...
class BackupAgentAssignedBackupPolicy:
    """
    Attributes:
        config_uid (UUID | Unset): UID assigned to a backup policy configuration.
        backup_agent_uid (UUID | Unset): UID assigned to a Veeam backup agent.
        backup_policy_uid (UUID | Unset): UID assigned to a backup policy.
        backup_policy_id (int | Unset): System ID assigned to a backup policy.
        status (BackupAgentAssignedBackupPolicyStatus | Unset): Status of the policy assignment.
        is_custom (bool | Unset): Indicates whether a backup policy is custom.
    ...
    backup_policy_id: int | Unset = UNSET
    status: BackupAgentAssignedBackupPolicyStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: BackupAgentAssignedBackupPolicyStatus | Unset
