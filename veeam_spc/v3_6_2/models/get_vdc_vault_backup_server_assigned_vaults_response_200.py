...
if TYPE_CHECKING:
    ...
    from ..models.vdc_storage_vault import VdcStorageVault


T = TypeVar("T", bound="GetVdcVaultBackupServerAssignedVaultsResponse200")


@_attrs_define
class GetVdcVaultBackupServerAssignedVaultsResponse200:
    """
    Attributes:
        data (list[VdcStorageVault]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = VdcStorageVault.from_dict(data_item_data)
        ...
        get_vdc_vault_backup_server_assigned_vaults_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_backup_server_assigned_vaults_response_200.additional_properties = d
        return get_vdc_vault_backup_server_assigned_vaults_response_200
