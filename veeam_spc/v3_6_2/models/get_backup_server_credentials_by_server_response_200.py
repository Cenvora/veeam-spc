...
class GetBackupServerCredentialsByServerResponse200:
    """
    Attributes:
        data (list[BackupServerCredentialsRecordType0 | None]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(data: object) -> BackupServerCredentialsRecordType0 | None:
                if data is None:
                    return data
                try:
                    ...
                    pass
                return cast(BackupServerCredentialsRecordType0 | None, data)
