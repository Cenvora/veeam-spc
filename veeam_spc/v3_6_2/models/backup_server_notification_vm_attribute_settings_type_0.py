...
class BackupServerNotificationVmAttributeSettingsType0:
    ...
    Attributes:
        is_enabled (bool): Indicates whether information about successfully performed backup is written to a VM
            attribute.
        notes (None | str | Unset): Name of a VM attribute.
        append_to_existing_value (bool | Unset): Indicates whether information about successfully performed backup is
            appended to the existing value of the attribute added by the user. Default: True.
    """

    is_enabled: bool
    notes: None | str | Unset = UNSET
    append_to_existing_value: bool | Unset = True
