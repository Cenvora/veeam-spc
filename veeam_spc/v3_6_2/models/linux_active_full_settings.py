...
class LinuxActiveFullSettings:
    ...
    Attributes:
        ...
        weekly_on_days (list[LinuxActiveFullSettingsWeeklyOnDaysItem] | Unset): Name of the week day.
    """
    ...
    weekly_on_days: list[LinuxActiveFullSettingsWeeklyOnDaysItem] | Unset = UNSET
