...
class PluginUserLoginDataServiceTimeZone:
    """
    Attributes:
        id (str | Unset): ID assigned to a time zone.
        description (str | Unset): Description of a time zone.
        utc_offset_in_minutes (int | Unset): Time zone UTC offset, in minutes.
    """

    id: str | Unset = UNSET
    description: str | Unset = UNSET
    utc_offset_in_minutes: int | Unset = UNSET
