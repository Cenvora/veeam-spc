...
T = TypeVar("T", bound="VdcStorageVaultEmbedded")


@_attrs_define
class VdcStorageVaultEmbedded:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vdc_storage_vault_embedded = cls(
            country=country,
        ...
        vdc_storage_vault_embedded.additional_properties = d
        return vdc_storage_vault_embedded
