...
class BackupProxy:
    ...
    Attributes:
        ...
        name (str | Unset): Name of a backup proxy.
        version (str | Unset): Version of a backup proxy service.
        backup_server_uid (UUID | Unset): UID assigned to a Veeam Backup & Replication server.
        is_out_of_date (bool | Unset): Indicates whether a backup proxy service is outdated.
        is_disabled (bool | Unset): Indicates whether a backup proxy is disabled.
        host_uid (UUID | Unset): UID assigned to a server that performs a role of a backup proxy.
        host_name (str | Unset): Computer name of a server that performs a role of a backup proxy.
        status (BackupProxyStatus | Unset): Backup proxy status.
        type_ (BackupProxyType | Unset): Type of a backup proxy.
    """
    ...
    status: BackupProxyStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: BackupProxyStatus | Unset
