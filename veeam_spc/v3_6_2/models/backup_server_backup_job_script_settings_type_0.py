...
class BackupServerBackupJobScriptSettingsType0:
    ...
    Attributes:
        ...
        windows_scripts (BackupServerBackupJobWindowsScriptType0 | None | Unset): Paths to pre-freeze and post-thaw
            scripts for Microsoft Windows VMs.
        linux_scripts (BackupServerBackupJobLinuxScriptType0 | None | Unset): Paths to pre-freeze and post-thaw scripts
            for Linux VMs.
    """

    script_processing_mode: BackupServerBackupJobScriptProcessingMode
    windows_scripts: BackupServerBackupJobWindowsScriptType0 | None | Unset = UNSET
    linux_scripts: BackupServerBackupJobLinuxScriptType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        windows_scripts: dict[str, Any] | None | Unset
        ...
        linux_scripts: dict[str, Any] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_windows_scripts(data: object) -> BackupServerBackupJobWindowsScriptType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(BackupServerBackupJobWindowsScriptType0 | None | Unset, data)

        windows_scripts = _parse_windows_scripts(d.pop("windowsScripts", UNSET))

        def _parse_linux_scripts(data: object) -> BackupServerBackupJobLinuxScriptType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(BackupServerBackupJobLinuxScriptType0 | None | Unset, data)
