...
class SubscriptionPlanLicenses:
    """
    Attributes:
        vspc_licenses (SubscriptionPlanVspcLicenses | Unset):
        backup_and_replication_standard_edition_licenses (SubscriptionPlanBackupAndReplicationLicenses | Unset):
        backup_and_replication_enterprise_edition_licenses (SubscriptionPlanBackupAndReplicationLicenses | Unset):
        backup_and_replication_enterprise_plus_edition_licenses (SubscriptionPlanBackupAndReplicationLicenses | Unset):
        vdp_foundation_package_licenses (SubscriptionPlanDataPlatformLicenses | Unset):
        vdp_advanced_package_licenses (SubscriptionPlanDataPlatformLicenses | Unset):
        vdp_premium_package_licenses (SubscriptionPlanDataPlatformLicenses | Unset):
        cloud_connect_licenses (SubscriptionPlanCloudConnectLicenses | Unset):
        vb_365_licenses (SubscriptionPlanVB365Licenses | Unset):
        veeam_one_licenses (SubscriptionPlanVeeamOneLicenses | Unset):
    """

    vspc_licenses: SubscriptionPlanVspcLicenses | Unset = UNSET
    backup_and_replication_standard_edition_licenses: SubscriptionPlanBackupAndReplicationLicenses | Unset = UNSET
    backup_and_replication_enterprise_edition_licenses: SubscriptionPlanBackupAndReplicationLicenses | Unset = UNSET
    backup_and_replication_enterprise_plus_edition_licenses: SubscriptionPlanBackupAndReplicationLicenses | Unset = (
        UNSET
    )
    vdp_foundation_package_licenses: SubscriptionPlanDataPlatformLicenses | Unset = UNSET
    vdp_advanced_package_licenses: SubscriptionPlanDataPlatformLicenses | Unset = UNSET
    vdp_premium_package_licenses: SubscriptionPlanDataPlatformLicenses | Unset = UNSET
    cloud_connect_licenses: SubscriptionPlanCloudConnectLicenses | Unset = UNSET
    vb_365_licenses: SubscriptionPlanVB365Licenses | Unset = UNSET
    veeam_one_licenses: SubscriptionPlanVeeamOneLicenses | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        vspc_licenses: dict[str, Any] | Unset = UNSET
        if not isinstance(self.vspc_licenses, Unset):
            vspc_licenses = self.vspc_licenses.to_dict()

        backup_and_replication_standard_edition_licenses: dict[str, Any] | Unset = UNSET
        ...
        backup_and_replication_enterprise_edition_licenses: dict[str, Any] | Unset = UNSET
        ...
        backup_and_replication_enterprise_plus_edition_licenses: dict[str, Any] | Unset = UNSET
        ...
        vdp_foundation_package_licenses: dict[str, Any] | Unset = UNSET
        ...
        vdp_advanced_package_licenses: dict[str, Any] | Unset = UNSET
        ...
        vdp_premium_package_licenses: dict[str, Any] | Unset = UNSET
