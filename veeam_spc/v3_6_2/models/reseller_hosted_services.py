...
class ResellerHostedServices:
    """
    Attributes:
        backup_resources_enabled (bool | Unset): Indicates whether reseller companies can create jobs on a hosted Veeam
            Backup & Replication server.
             Default: False.
        vb_365_management_enabled (bool | Unset): Indicates whether reseller companies can use Microsoft 365 resources.
             Default: False.
        vb_public_cloud_management_enabled (bool | Unset): Indicates whether integration with Veeam Backup for Public
            Clouds is available to a reseller. Default: False.
    """

    backup_resources_enabled: bool | Unset = False
