...
class BackupServerBackupJobBackupFSExclusionsType0:
    ...
    Attributes:
        ...
        items_list (list[str] | None | Unset): Array of included or excluded files and folders.
    ...
    items_list: list[str] | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        exclusion_policy = self.exclusion_policy.value

        items_list: list[str] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_items_list(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
