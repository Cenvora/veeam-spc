...
class PluginUserLoginDataFormats:
    """
    Attributes:
        net_short_time (str | Unset): Custom format string for short time in the .NET format.
        net_long_time (str | Unset): Custom format string for long time in the .NET format.
        net_short_date (str | Unset): Custom format string for short date in the .NET format.
        short_time (str | Unset): Custom format string for short time in the PHP format.
        long_time (str | Unset): Custom format string for long time in the PHP format.
        short_date (str | Unset): Custom format string for short date in the PHP format.
    """

    net_short_time: str | Unset = UNSET
    net_long_time: str | Unset = UNSET
    net_short_date: str | Unset = UNSET
    short_time: str | Unset = UNSET
    long_time: str | Unset = UNSET
    short_date: str | Unset = UNSET
