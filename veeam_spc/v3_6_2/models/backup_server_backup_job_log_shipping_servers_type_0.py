...
class BackupServerBackupJobLogShippingServersType0:
    ...
    Attributes:
        ...
        shipping_server_ids (list[UUID] | None | Unset): Array of UID assigned to servers used to transport transaction
            logs.
    """

    auto_selection: bool = False
    shipping_server_ids: list[UUID] | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        auto_selection = self.auto_selection

        shipping_server_ids: list[str] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_shipping_server_ids(data: object) -> list[UUID] | None | Unset:
            if data is None:
                return data
