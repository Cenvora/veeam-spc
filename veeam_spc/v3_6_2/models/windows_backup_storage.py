...
class WindowsBackupStorage:
    """
    Attributes:
        compression_level (WindowsBackupStorageCompressionLevel | Unset): Compression level for the backup. Default:
            WindowsBackupStorageCompressionLevel.OPTIMAL.
        storage_optimization (WindowsBackupStorageStorageOptimization | Unset): Type of a backup target. Default:
    ...
    compression_level: WindowsBackupStorageCompressionLevel | Unset = WindowsBackupStorageCompressionLevel.OPTIMAL
    storage_optimization: WindowsBackupStorageStorageOptimization | Unset = (
        WindowsBackupStorageStorageOptimization.LOCAL1MB
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        compression_level: WindowsBackupStorageCompressionLevel | Unset
