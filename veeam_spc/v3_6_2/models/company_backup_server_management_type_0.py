...
class CompanyBackupServerManagementType0:
    ...
    Attributes:
        backup_server_quota (int | None | Unset): Number of Veeam Backup & Replication servers that a company is allowed
            to manage.
            > The `null` value indicates that the amount is unlimited.
    """

    backup_server_quota: int | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        backup_server_quota: int | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_backup_server_quota(data: object) -> int | None | Unset:
            if data is None:
                return data
