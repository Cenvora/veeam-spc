...
class BackupServerJobSessionTask:
    ...
    Attributes:
        ...
        object_uid (None | Unset | UUID): UID assigned to an object included in a job.
        object_name (None | str | Unset): Name of an object included in a job.
        total_objects (int | None | Unset): Number of objects included in a job.
        processed_objects (int | None | Unset): Number of objects processed by a job session.
        read_data_size (int | None | Unset): Size of object data that a job processes.
        transferred_data_size (int | None | Unset): Size of processed object data.
        start_time (datetime.datetime | None | Unset): Start date and time of a job session task.
        end_time (datetime.datetime | None | Unset): End date and time of a job session task.
        duration (int | None | Unset): Duration of a job session task, in seconds.
        failure_messages (list[str] | None | Unset): Messages containing information on job session task errors.
    ...
    read_data_size: int | None | Unset = UNSET
    transferred_data_size: int | None | Unset = UNSET
    start_time: datetime.datetime | None | Unset = UNSET
    end_time: datetime.datetime | None | Unset = UNSET
    duration: int | None | Unset = UNSET
    failure_messages: list[str] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        failure_messages: list[str] | None | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_read_data_size(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_transferred_data_size(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_failure_messages(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
