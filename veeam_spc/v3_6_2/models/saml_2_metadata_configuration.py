...
class Saml2MetadataConfiguration:
    ...
    Attributes:
        ...
        cache_duration (str | Unset): Time period during which remote parties may cache metadata before refetching.
            Default: 'PT1H'.
        valid_duration (str | Unset): Maximum time period during which metadata remains valid in case a refresh attempt
