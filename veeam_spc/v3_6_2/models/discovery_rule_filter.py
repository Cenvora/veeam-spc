...
class DiscoveryRuleFilter:
    """
    Attributes:
        exclusion_mask (list[str] | None | Unset): Array of applied exclusion masks. For custom discovery rules this
            property is ignored.
        ignore_inaccessible_machine (bool | Unset): Indicates whether discovery is performed among accessible computers
            only. Default: False.
        os_types (list[DiscoveryRuleFilterOsTypesType0Item] | None | Unset): Type of operating system.
        applications (list[DiscoveryRuleFilterApplicationsType0Item] | None | Unset): Applications that must run on
            discovered computers.
        custom_application (None | str | Unset): Name of an application required for the `OtherApp` application type.
            > Available only for Linux computers.
        platforms (list[DiscoveryRuleFilterPlatformsType0Item] | None | Unset): Platforms on which discovered computers
            must run.
    """

    exclusion_mask: list[str] | None | Unset = UNSET
    ignore_inaccessible_machine: bool | Unset = False
    os_types: list[DiscoveryRuleFilterOsTypesType0Item] | None | Unset = UNSET
    applications: list[DiscoveryRuleFilterApplicationsType0Item] | None | Unset = UNSET
    custom_application: None | str | Unset = UNSET
    platforms: list[DiscoveryRuleFilterPlatformsType0Item] | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        exclusion_mask: list[str] | None | Unset
        ...
        custom_application: None | str | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_exclusion_mask(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
        ...
        def _parse_os_types(data: object) -> list[DiscoveryRuleFilterOsTypesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[DiscoveryRuleFilterOsTypesType0Item] | None | Unset, data)

        os_types = _parse_os_types(d.pop("osTypes", UNSET))

        def _parse_applications(data: object) -> list[DiscoveryRuleFilterApplicationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[DiscoveryRuleFilterApplicationsType0Item] | None | Unset, data)

        applications = _parse_applications(d.pop("applications", UNSET))

        def _parse_custom_application(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_platforms(data: object) -> list[DiscoveryRuleFilterPlatformsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[DiscoveryRuleFilterPlatformsType0Item] | None | Unset, data)
