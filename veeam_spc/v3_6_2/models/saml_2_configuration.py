...
class Saml2Configuration:
    ...
    documentation](https://saml2.sustainsys.com/en/v2/config-elements/sustainsys-saml2.html).
        ...
        Attributes:
            ...
            identity_providers (list[Saml2IdentityProviderConfiguration]): Array of identity providers known to a service
                provider.
            service_certificates (list[Saml2ServiceCertificateConfiguration]): Array of certificates that a service provider
                uses for signing or decrypting SAML assertions.
            module_path (str | Unset): Base path of the SAML2 endpoints.
                 Default: '/Saml2'.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        authenticate_request_signing_behavior: str | Unset = UNSET
