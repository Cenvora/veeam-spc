...
class BackupServerPublicCloudAppliance:
    ...
    Attributes:
        ...
        resource_id (str | Unset): Resource ID of a Veeam Backup for Public Clouds appliance.
        ...
        remote_ui_access_enabled (bool | Unset): Indicates whether the Veeam Backup for Public Clouds appliance
        ...
        organization_uid (UUID | Unset): UID assigned to an organization that owns a Veeam Backup & Replication server
            on which a Veeam Backup for Public Clouds appliance is registered.
        ...
        location_uid (UUID | Unset): UID assigned to a Veeam Backup for Public Clouds appliance location.
        ...
        platform (BackupServerPublicCloudAppliancePlatform | Unset): Platform of a Veeam Backup for Public Clouds
            appliance.
        management_type (BackupServerPublicCloudApplianceManagementType | Unset): Management type of a Veeam Backup for
            Public Clouds appliance.
    """
    ...
    management_type: BackupServerPublicCloudApplianceManagementType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        management_type: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        management_type: BackupServerPublicCloudApplianceManagementType | Unset
