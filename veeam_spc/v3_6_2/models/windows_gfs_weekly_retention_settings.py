...
class WindowsGfsWeeklyRetentionSettings:
    ...
    Attributes:
        keep_weekly_backups_for_weeks (int): Number of weeks during which restore points must not be modified or
            deleted. Default: 1.
        use_full_backup_from (WindowsGfsWeeklyRetentionSettingsUseFullBackupFrom | Unset): Week day when Veeam Backup &
    ...
    use_full_backup_from: WindowsGfsWeeklyRetentionSettingsUseFullBackupFrom | Unset = (
        WindowsGfsWeeklyRetentionSettingsUseFullBackupFrom.SUNDAY
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        use_full_backup_from: str | Unset = UNSET
