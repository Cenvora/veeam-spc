...
class PublicCloudGoogleSubNetworks:
    """
    Attributes:
        sub_network_id (str | Unset): ID assigned to a subnet.
        name (str | Unset): Name of a subnet.
        range_ (str | Unset): IP address range of a subnet.
    """

    sub_network_id: str | Unset = UNSET
