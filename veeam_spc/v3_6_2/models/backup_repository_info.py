...
class BackupRepositoryInfo:
    """
    Attributes:
        parent_repository_uid (UUID | Unset): UID assigned to a scale-out backup repository which includes the backup
            repository as an extent.
        per_vm_backup_files (bool | Unset): Indicates whether the per-VM backup job option is enabled in the backup
            repository settings. VM backup files option in the repository settings is enabled. Displays if the per-VM backup
            job option is enabled or not in the backup repository settings.
        capacity (int | Unset): Total disk space of backup repository, in bytes.
        is_capacity_available (bool | Unset): Indicates whether information about total disk space is available.
        free_space (int | Unset): Free disk space of a backup repository, in bytes.
        is_free_space_available (bool | Unset): Indicates whether a backup repository has free space.
        used_space (int | Unset): Amount of used space on a backup repository, in bytes.
        is_used_space_available (bool | Unset): Indicates whether information about used space is available.
        backup_size (int | Unset): Total size of all restore points, in bytes.
        is_immutability_enabled (bool | Unset): Indicates whether immutability is enabled.
        immutability_interval (int | Unset): Duration of an immutability period, in seconds.
        type_ (BackupRepositoryInfoType | Unset): Type of a backup repository.
        cloud_repository_uid (UUID | Unset): UID assigned to a backup repository if it is used as a cloud repository.
        ...
        host_uid (UUID | Unset): UID assigned to a computer that performs a role of a backup repository.
        is_out_of_date (bool | Unset): Indicates whether a backup repository service is outdated.
        status (BackupRepositoryInfoStatus | Unset): Status of a backup repository.
        is_cloud (bool | Unset): Indicates whether a backup repository is used as a cloud repository.
    """

    parent_repository_uid: UUID | Unset = UNSET
    per_vm_backup_files: bool | Unset = UNSET
    ...
    is_immutability_enabled: bool | Unset = UNSET
    immutability_interval: int | Unset = UNSET
    type_: BackupRepositoryInfoType | Unset = UNSET
    cloud_repository_uid: UUID | Unset = UNSET
    path: str | Unset = UNSET
    host_name: str | Unset = UNSET
    host_uid: UUID | Unset = UNSET
    is_out_of_date: bool | Unset = UNSET
    status: BackupRepositoryInfoStatus | Unset = UNSET
    is_cloud: bool | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        parent_repository_uid: str | Unset = UNSET
        ...
        cloud_repository_uid: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_repository_uid: UUID | Unset
        ...
        type_: BackupRepositoryInfoType | Unset
        ...
        cloud_repository_uid: UUID | Unset
        ...
        status: BackupRepositoryInfoStatus | Unset
