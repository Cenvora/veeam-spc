...
class Saml2IdentityProviderConfiguration:
    ...
    Attributes:
        ...
        binding (Saml2IdentityProviderConfigurationBinding | Unset): Type of binding that a services provider should use
            when sending requests to an identity provider.
        allow_unsolicited_authn_response (bool | Unset): Indicates whether an identity provider can initiate sign-on
            without prior authentication request.
             Default: False.
        load_metadata (bool | Unset): Indicates whether service provider loads the identity provider metadata for it to
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        outbound_signing_algorithm: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outbound_signing_algorithm: Saml2IdentityProviderConfigurationOutboundSigningAlgorithm | Unset
