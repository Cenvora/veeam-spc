...
class EmbeddedForBackupServerJobChildrenType0:
    ...
    Attributes:
        backup_server_job (BackupServerJob | Unset):  Example: {'instanceUid': 'EDEB5975-B409-49B5-8ECE-FFFECB13494F',
            'name': 'Web server Backup to Cloud', 'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'status':
            'Success', 'type': 'BackupVm', 'lastRun': '2016-11-01T10:35:28.0000000-07:00', 'endTime':
    ...
    backup_server_job: BackupServerJob | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        backup_server_job: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_job: BackupServerJob | Unset
