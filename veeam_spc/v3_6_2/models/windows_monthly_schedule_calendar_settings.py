...
class WindowsMonthlyScheduleCalendarSettings:
    ...
    Attributes:
        ...
        day_of_week (WindowsMonthlyScheduleCalendarSettingsDayOfWeek | Unset): Name of the week day. Default:
            WindowsMonthlyScheduleCalendarSettingsDayOfWeek.SUNDAY.
        months (list[WindowsMonthlyScheduleCalendarSettingsMonthsItem] | Unset): Month.
    """

    week_day_number: WindowsMonthlyScheduleCalendarSettingsWeekDayNumber
    day_of_week: WindowsMonthlyScheduleCalendarSettingsDayOfWeek | Unset = (
        WindowsMonthlyScheduleCalendarSettingsDayOfWeek.SUNDAY
    )
    months: list[WindowsMonthlyScheduleCalendarSettingsMonthsItem] | Unset = UNSET
