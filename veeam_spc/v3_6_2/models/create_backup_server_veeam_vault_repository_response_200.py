...
T = TypeVar("T", bound="CreateBackupServerVeeamVaultRepositoryResponse200")


@_attrs_define
class CreateBackupServerVeeamVaultRepositoryResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_backup_server_veeam_vault_repository_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_backup_server_veeam_vault_repository_response_200.additional_properties = d
        return create_backup_server_veeam_vault_repository_response_200
