...
class LinuxBackupHealthCheckScheduleSettings:
    """
    Attributes:
        monthly_settings (LinuxBackupHealthCheckMonthlySchedule | Unset):
        weekly_on_days (list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item] | None | Unset): Scheduling
            settings for weekly full backup creation.
            > If the `monthlySettings` property is also provided, it is ignored.
    """

    monthly_settings: LinuxBackupHealthCheckMonthlySchedule | Unset = UNSET
    weekly_on_days: list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weekly_on_days(
            data: object,
        ) -> list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[LinuxBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item] | None | Unset, data)
