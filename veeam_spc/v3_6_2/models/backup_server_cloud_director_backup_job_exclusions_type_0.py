...
class BackupServerCloudDirectorBackupJobExclusionsType0:
    ...
    Attributes:
        vms (list[BackupServerCloudDirectorObject] | None | Unset): Array of VMs excluded from a backup job.'
        disks (list[BackupServerCloudDirectorBackupJobDisk] | None | Unset): Array of VM disks excluded from a backup
            job.
        templates (BackupServerBackupJobExclusionsTemplatesType0 | None | Unset): Excluded VM templates.
    """

    vms: list[BackupServerCloudDirectorObject] | None | Unset = UNSET
    disks: list[BackupServerCloudDirectorBackupJobDisk] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_vms(data: object) -> list[BackupServerCloudDirectorObject] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(list[BackupServerCloudDirectorObject] | None | Unset, data)

        vms = _parse_vms(d.pop("vms", UNSET))

        def _parse_disks(data: object) -> list[BackupServerCloudDirectorBackupJobDisk] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[BackupServerCloudDirectorBackupJobDisk] | None | Unset, data)
