...
class ResellerLicenseResource:
    ...
    Attributes:
        ...
        pulse_configuration_status (ResellerLicenseResourcePulseConfigurationStatus | Unset): Status of VCSP Pulse
            configuration.
        pulse_configuration_status_message (str | Unset): Status message.
        pulse_auto_connect_with_provider_token (bool | Unset): Indicates whether reseller is forced to connect to VCSP
        ...
        is_creating_new_companies_to_pulse_enabled (bool | Unset): Indicates whether a reseller can add new companies to
            VCSP Pulse.
    """

    reseller_uid: UUID | Unset = UNSET
    pulse_configuration_status: ResellerLicenseResourcePulseConfigurationStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pulse_configuration_status: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pulse_configuration_status: ResellerLicenseResourcePulseConfigurationStatus | Unset
