...
class BackupServerBackupJobSchedulePeriodically:
    ...
    Attributes:
        ...
        periodically_kind (BackupServerBackupJobPeriodicallyKindsNullable | Unset): Time unit for periodic job
            scheduling.
        frequency (int | Unset): Number of time units that define schedule periods.
        backup_window (BackupServerBackupJobWindowSetting | Unset): Array of daily schemes that define backup window.
    ...
    backup_window: BackupServerBackupJobWindowSetting | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_window: BackupServerBackupJobWindowSetting | Unset
