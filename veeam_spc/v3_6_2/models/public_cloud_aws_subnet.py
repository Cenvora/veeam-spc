...
class PublicCloudAwsSubnet:
    """
    Attributes:
        subnet_id (str | Unset): ID assigned to a subnet.
        subnet_name (str | Unset): AWS name of a subnet.
        range_ (str | Unset): Range of IP addresses present in a subnet.
        display_name (str | Unset): Display name of a subnet.
    """
