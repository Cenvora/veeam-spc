...
T = TypeVar("T", bound="GetVdcVaultBackupServerAssignedVaultResponse200")


@_attrs_define
class GetVdcVaultBackupServerAssignedVaultResponse200:
    """
    Attributes:
        data (VdcStorageVault):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VdcStorageVault.from_dict(d.pop("data"))
        ...
        get_vdc_vault_backup_server_assigned_vault_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_backup_server_assigned_vault_response_200.additional_properties = d
        return get_vdc_vault_backup_server_assigned_vault_response_200
