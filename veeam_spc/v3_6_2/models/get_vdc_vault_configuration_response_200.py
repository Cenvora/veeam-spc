...
if TYPE_CHECKING:
    ...
    from ..models.vdc_vault_configuration import VdcVaultConfiguration


T = TypeVar("T", bound="GetVdcVaultConfigurationResponse200")


@_attrs_define
class GetVdcVaultConfigurationResponse200:
    """
    Attributes:
        data (VdcVaultConfiguration):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VdcVaultConfiguration.from_dict(d.pop("data"))
        ...
        get_vdc_vault_configuration_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_vdc_vault_configuration_response_200.additional_properties = d
        return get_vdc_vault_configuration_response_200
