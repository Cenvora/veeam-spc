...
class LinuxPostgreSqlApplicationAwareProcessingSettings:
    """
    Attributes:
        processing_type (LinuxPostgreSqlApplicationAwareProcessingSettingsProcessingType | Unset): PostgreSQL database
            processing type. Default: LinuxPostgreSqlApplicationAwareProcessingSettingsProcessingType.DISABLEPROCESS.
        credentials (LinuxBaseCredentials | Unset):
        auth_type (LinuxPostgreSqlApplicationAwareProcessingSettingsAuthType | Unset): Type of credentials format.
            Default: LinuxPostgreSqlApplicationAwareProcessingSettingsAuthType.PSQLPASSWORD.
    """

    processing_type: LinuxPostgreSqlApplicationAwareProcessingSettingsProcessingType | Unset = (
    ...
    auth_type: LinuxPostgreSqlApplicationAwareProcessingSettingsAuthType | Unset = (
