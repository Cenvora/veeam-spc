...
class WindowsGfsYearlyRetentionSettings:
    ...
    Attributes:
        ...
        use_monthly_full_backup_for_the_following_month
            (WindowsGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset): Month when Veeam Backup &
    ...
    use_monthly_full_backup_for_the_following_month: (
        WindowsGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth | Unset
    ) = WindowsGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth.JAN
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        use_monthly_full_backup_for_the_following_month: str | Unset = UNSET
