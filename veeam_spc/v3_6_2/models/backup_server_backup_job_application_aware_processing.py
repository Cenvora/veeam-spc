...
class BackupServerBackupJobApplicationAwareProcessing:
    ...
    Attributes:
        ...
        app_settings (list[BackupServerBackupJobApplicationSettings] | Unset): Array of VMware vSphere objects and their
            application settings.
    """

    is_enabled: bool | Unset = False
    app_settings: list[BackupServerBackupJobApplicationSettings] | Unset = UNSET
