...
class BackupServerBackupJobApplicationAwareProcessing:
    ...
    Attributes:
        ...
        app_settings (list[BackupServerBackupJobApplicationSettingsType0 | None] | None | Unset): Array of VMware
            vSphere objects and their application settings.
    """

    is_enabled: bool | Unset = False
    app_settings: list[BackupServerBackupJobApplicationSettingsType0 | None] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_app_settings(
            data: object,
        ) -> list[BackupServerBackupJobApplicationSettingsType0 | None] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for app_settings_type_0_item_data in _app_settings_type_0:
                    ...
                    def _parse_app_settings_type_0_item(
                        data: object,
                    ) -> BackupServerBackupJobApplicationSettingsType0 | None:
                        if data is None:
                            return data
                        try:
                            ...
                            pass
                        return cast(BackupServerBackupJobApplicationSettingsType0 | None, data)
                ...
                pass
            return cast(list[BackupServerBackupJobApplicationSettingsType0 | None] | None | Unset, data)
