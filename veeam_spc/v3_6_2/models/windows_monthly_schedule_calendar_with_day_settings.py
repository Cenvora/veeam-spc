...
class WindowsMonthlyScheduleCalendarWithDaySettings:
    ...
    Attributes:
        ...
        week_day_number (WindowsMonthlyScheduleCalendarWithDaySettingsWeekDayNumber | Unset): Ordinal number of the
            week.
    ...
    week_day_number: WindowsMonthlyScheduleCalendarWithDaySettingsWeekDayNumber | Unset = (
