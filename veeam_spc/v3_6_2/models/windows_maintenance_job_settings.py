...
class WindowsMaintenanceJobSettings:
    """
    Attributes:
        backup_health_check_settings (MonthlyOrWeeklyScheduleSettings | Unset):
        full_backup_file_maintenance_settings (WindowsFullBackupFileMaintenanceSettings | Unset):
        full_health_check (bool | Unset): Indicates whether a full health check is enabled for an object storage.
            Default: False.
    """

    backup_health_check_settings: MonthlyOrWeeklyScheduleSettings | Unset = UNSET
    full_backup_file_maintenance_settings: WindowsFullBackupFileMaintenanceSettings | Unset = UNSET
    full_health_check: bool | Unset = False
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        backup_health_check_settings: dict[str, Any] | Unset = UNSET
        ...
        full_backup_file_maintenance_settings: dict[str, Any] | Unset = UNSET
