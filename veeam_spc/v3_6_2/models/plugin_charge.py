...
class PluginCharge:
    ...
    Attributes:
        ...
        charge_uid (UUID | Unset): UID assigned to an external plugin charge rate.
        display_name (str | Unset): Name of an external plugin charge rate.
        category_id (str | Unset): ID assigned to a external plugin charge rate category.
        category_display_name (str | Unset): Name of an external plugin charge rate category.
        measure_category (MeasureCategory | Unset): Measurement unit category.
    """
    ...
    category_display_name: str | Unset = UNSET
    measure_category: MeasureCategory | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        measure_category: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        measure_category: MeasureCategory | Unset
