...
class ProtectedComputerManagedByBackupServerBackup:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        target_location_tier: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_kind: ProtectedComputerManagedByBackupServerBackupJobKind | Unset
        ...
        target_location_tier: SobrRepositoryTier | Unset
