...
class LocalUserRuleDiscoveryItem:
    ...
    Attributes:
        ...
        name (str | Unset): Name of a user or group.
        display_name (str | Unset): Display name of a user or group.
        description (str | Unset): Description of a user or group.
        type_ (LocalUserRuleType | Unset): Type of a user or group.
        context_type (WinContextType | Unset): Type of a location where an account is stored.
    """
    ...
    type_: LocalUserRuleType | Unset = UNSET
    context_type: WinContextType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        context_type: WinContextType | Unset
