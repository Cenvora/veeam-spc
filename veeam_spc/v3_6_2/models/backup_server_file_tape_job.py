...
class BackupServerFileTapeJob:
    ...
    Attributes:
        ...
        incremental_media_pool_uid (UUID | Unset): UID assigned to a media pool for increment backups.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        full_media_pool_uid: UUID | Unset
        ...
        incremental_media_pool_uid: UUID | Unset
