...
class WindowsBackupAgentJob:
    ...
    Attributes:
        ...
        instance_uid (UUID | Unset): UID assigned to a Veeam Agent for Microsoft Windows job.
        ...
        name (None | str | Unset): Name of a Veeam Agent for Microsoft Windows job.
        description (None | str | Unset): Description of a Veeam Agent for Microsoft Windows job.
        ...
        last_end_time (datetime.datetime | None | Unset): Date and time when the latest job session finished.
        ...
        target_type (WindowsBackupAgentJobTargetType | Unset): Type of a location where backup files for a Veeam backup
            agent reside.
        ...
        schedule_events (list[WindowsBackupAgentJobScheduleEventsItem] | Unset): Events that trigger the backup job
            launch.
        last_modified_date (datetime.datetime | None | Unset): Date and time when settings of the backup job were last
            modified.
    ...
    target_type: WindowsBackupAgentJobTargetType | Unset = UNSET
    is_enabled: bool | Unset = UNSET
    schedule_type: BackupAgentJobScheduleType | Unset = UNSET
    schedule_events: list[WindowsBackupAgentJobScheduleEventsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_agent_uid: str | Unset = UNSET
        ...
        schedule_events: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target_type: WindowsBackupAgentJobTargetType | Unset
        ...
        schedule_type: BackupAgentJobScheduleType | Unset
        ...
        schedule_events: list[WindowsBackupAgentJobScheduleEventsItem] | Unset = UNSET
        if _schedule_events is not UNSET:
            schedule_events = []
            for schedule_events_item_data in _schedule_events:
