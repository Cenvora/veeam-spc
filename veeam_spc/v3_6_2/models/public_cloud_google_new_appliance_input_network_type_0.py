...
class PublicCloudGoogleNewApplianceInputNetworkType0:
    ...
    > If you provide the `null` value, all required resources will be created automatically.
        ...
        Attributes:
            ...
            network_tag_id (None | str | Unset): ID assigned to a network tag.
                > Provide the `null` value to create a new network tag.
    """

    network_id: str
    subnet_id: str
    network_tag_id: None | str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_network_tag_id(data: object) -> None | str | Unset:
            if data is None:
                return data
