...
class BackupServerBackupJobScheduleRetryType0:
    ...
    Attributes:
        is_enabled (bool | None | Unset): Indicates whether job retries are enabled. Default: False.
        retry_count (int | None | Unset): Number of retries set for the job.
            >Must be greater than zero.
             Default: 3.
        await_minutes (int | None | Unset): Time interval between job retries, in minutes.
            >Must be greater than zero.
             Default: 10.
    """

    is_enabled: bool | None | Unset = False
    retry_count: int | None | Unset = 3
    await_minutes: int | None | Unset = 10
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_await_minutes(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
