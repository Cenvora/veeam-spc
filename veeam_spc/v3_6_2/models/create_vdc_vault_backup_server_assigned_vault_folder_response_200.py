...
if TYPE_CHECKING:
    ...
    from ..models.vdc_storage_vault_folder import VdcStorageVaultFolder


T = TypeVar("T", bound="CreateVdcVaultBackupServerAssignedVaultFolderResponse200")


@_attrs_define
class CreateVdcVaultBackupServerAssignedVaultFolderResponse200:
    """
    Attributes:
        data (VdcStorageVaultFolder):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VdcStorageVaultFolder.from_dict(d.pop("data"))
        ...
        create_vdc_vault_backup_server_assigned_vault_folder_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_vdc_vault_backup_server_assigned_vault_folder_response_200.additional_properties = d
        return create_vdc_vault_backup_server_assigned_vault_folder_response_200
