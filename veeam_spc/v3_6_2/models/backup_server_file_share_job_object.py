...
class BackupServerFileShareJobObject:
    ...
    Attributes:
        ...
        file_share_uid (UUID | Unset): UID assigned to a file share server.
        name (str | Unset): Name of a file share.
        sources (list[BackupServerFileJobObjectSource] | Unset): Processed files and folders.
        last_session (BackupServerFileShareJobObjectLastSession | Unset):
    """
    ...
    last_session: BackupServerFileShareJobObjectLastSession | Unset = UNSET
