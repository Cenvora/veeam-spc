...
class BackupServerJobScriptsSettingsType0:
    ...
    Attributes:
        pre_command (BackupServerScriptCommand | Unset):
        post_command (BackupServerScriptCommand | Unset):
        periodicity_type (BackupServerScriptPeriodicityType | Unset): Type of script execution periodicity.
        run_script_every (int | None | Unset): Number of backup job sessions after which the scripts must be executed.
        day_of_week (list[DaysOfWeek] | None | Unset): Days of the week when the scripts must be executed.
    """

    pre_command: BackupServerScriptCommand | Unset = UNSET
    post_command: BackupServerScriptCommand | Unset = UNSET
    periodicity_type: BackupServerScriptPeriodicityType | Unset = UNSET
    run_script_every: int | None | Unset = UNSET
    day_of_week: list[DaysOfWeek] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        periodicity_type: BackupServerScriptPeriodicityType | Unset
        ...
        def _parse_run_script_every(data: object) -> int | None | Unset:
            if data is None:
                return data
        ...
        def _parse_day_of_week(data: object) -> list[DaysOfWeek] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
