...
class WindowsWorkstationModeJobSettings:
    """
    Attributes:
        schedule_setting (WindowsWorkstationJobScheduleSettings | Unset):
        retention_settings (WindowsWorkstationJobRetentionSettings | Unset):
    """

    schedule_setting: WindowsWorkstationJobScheduleSettings | Unset = UNSET
    retention_settings: WindowsWorkstationJobRetentionSettings | Unset = UNSET
