...
class SubscriptionPlanVspcLicenses:
    """
    Attributes:
        workstation_price (float | Unset): Monthly charge rate for a licensed workstation managed in Veeam Service
            Provider Console. Default: 0.0.
        server_price (float | Unset): Monthly charge rate for a licensed server managed in Veeam Service Provider
            Console. Default: 0.0.
    """
