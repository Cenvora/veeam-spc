...
class SubscriptionPlanVb365:
    """
    Attributes:
        remote_subscription_user_price (float | Unset): Charge rate for a protected remote Microsoft 365 subscription
            user. Default: 0.0.
        remote_free_subscription_users (int | Unset): Number of remote Microsoft 365 subscription users that are managed
            for free. Default: 0.
        remote_educational_user_price (float | Unset): Charge rate for a protected remote Microsoft 365 educational
            subscription user. Default: 0.0.
        remote_free_educational_users (int | Unset): Number of remote Microsoft 365 educational subscription users that
            are managed for free. Default: 0.
        remote_round_up_used_space (bool | Unset): Indicates whether cost of storage used by remote services must be
            rounded up to a full data block cost when the consumed storage space does not match data block size. Default:
            False.
        remote_standard_storage_used_space_price (float | Unset): Charge rate for a block of stored Microsoft 365 backup
            data. Default: 0.0.
        remote_standard_storage_used_space_chunk_size (int | Unset): Size of a stored Microsoft 365 backup data block.
            Default: 1.
        ...
        remote_free_standard_storage_used_space_units (SubscriptionPlanVb365RemoteFreeStandardStorageUsedSpaceUnits |
            ...
            Default: SubscriptionPlanVb365RemoteFreeStandardStorageUsedSpaceUnits.GB.
        remote_archive_storage_used_space_price (float | Unset): Charge rate for a block of Microsoft 365 backup copy
            data stored in a remote archive repository. Default: 0.0.
        remote_archive_storage_used_space_chunk_size (int | Unset): Size of a data block of Microsoft 365 backup copies
            stored in a hosted archive repository. Default: 1.
        ...
        remote_free_archive_storage_used_space_units (SubscriptionPlanVb365RemoteFreeArchiveStorageUsedSpaceUnits |
            ...
            is processed for free. Default: SubscriptionPlanVb365RemoteFreeArchiveStorageUsedSpaceUnits.GB.
        remote_repository_space_usage_algorithm (SubscriptionPlanVb365RemoteRepositorySpaceUsageAlgorithm | Unset): Type
            of remote repository storage space usage. Default:
            SubscriptionPlanVb365RemoteRepositorySpaceUsageAlgorithm.CONSUMED.
        remote_repository_allocated_space_price (float | Unset): Charge rate for one GB or TB of allocated storage space
            on a remote repository. Default: 0.0.
        remote_repository_allocated_space_units (SubscriptionPlanVb365RemoteRepositoryAllocatedSpaceUnits | Unset):
            Measurement units of allocated storage space on a remote repository. Default:
            SubscriptionPlanVb365RemoteRepositoryAllocatedSpaceUnits.GB.
        hosted_subscription_user_price (float | Unset):  Charge rate for a protected hosted Microsoft 365 subscription
            user. Default: 0.0.
        hosted_free_subscription_users (int | Unset): Number of hosted Microsoft 365 subscription user that are managed
            for free. Default: 0.
        hosted_educational_user_price (float | Unset): Charge rate for a protected hosted Microsoft 365 educational
            subscription user. Default: 0.0.
        hosted_free_educational_users (int | Unset): Number of hosted Microsoft 365 educational subscription users that
            are managed for free. Default: 0.
        hosted_round_up_used_space (bool | Unset): Indicates whether cost of storage used by hosted services must be
            rounded up to a full data block cost when the consumed storage space does not match data block size. Default:
            False.
        hosted_standard_storage_used_space_price (float | Unset): Charge rate for a block of stored hosted Microsoft 365
            backup data. Default: 0.0.
        hosted_standard_storage_used_space_chunk_size (int | Unset): Size of a stored hosted Microsoft 365 backup data
            block. Default: 1.
        ...
        hosted_free_standard_storage_used_space_units (SubscriptionPlanVb365HostedFreeStandardStorageUsedSpaceUnits |
            ...
            Default: SubscriptionPlanVb365HostedFreeStandardStorageUsedSpaceUnits.GB.
        hosted_archive_storage_used_space_price (float | Unset): Charge rate for a block of Microsoft 365 backup copy
            data stored in a hosted archive repository. Default: 0.0.
        hosted_archive_storage_used_space_chunk_size (int | Unset): Size of a data block of Microsoft 365 backup copies
            stored in a hosted archive repository. Default: 1.
        ...
        hosted_free_archive_storage_used_space_units (SubscriptionPlanVb365HostedFreeArchiveStorageUsedSpaceUnits |
            ...
            is processed for free. Default: SubscriptionPlanVb365HostedFreeArchiveStorageUsedSpaceUnits.GB.
        hosted_repository_space_usage_algorithm (SubscriptionPlanVb365HostedRepositorySpaceUsageAlgorithm | Unset): Type
            of charge rate for storage space on a hosted repository. Default:
            SubscriptionPlanVb365HostedRepositorySpaceUsageAlgorithm.CONSUMED.
        hosted_repository_allocated_space_price (float | Unset): Charge rate for one GB or TB of allocated storage space
            on a hosted repository. Default: 0.0.
        hosted_repository_allocated_space_units (SubscriptionPlanVb365HostedRepositoryAllocatedSpaceUnits | Unset):
            Measurement units of allocated storage space on a hosted repository. Default:
            SubscriptionPlanVb365HostedRepositoryAllocatedSpaceUnits.GB.
    """

    remote_subscription_user_price: float | Unset = 0.0
    remote_free_subscription_users: int | Unset = 0
    remote_educational_user_price: float | Unset = 0.0
    remote_free_educational_users: int | Unset = 0
    remote_round_up_used_space: bool | Unset = False
    remote_standard_storage_used_space_price: float | Unset = 0.0
    remote_standard_storage_used_space_chunk_size: int | Unset = 1
    remote_standard_storage_used_space_units: SubscriptionPlanVb365RemoteStandardStorageUsedSpaceUnits | Unset = (
        SubscriptionPlanVb365RemoteStandardStorageUsedSpaceUnits.GB
    )
    ...
    remote_archive_storage_used_space_price: float | Unset = 0.0
    remote_archive_storage_used_space_chunk_size: int | Unset = 1
    remote_archive_storage_used_space_units: SubscriptionPlanVb365RemoteArchiveStorageUsedSpaceUnits | Unset = (
        SubscriptionPlanVb365RemoteArchiveStorageUsedSpaceUnits.GB
    )
    ...
    remote_repository_space_usage_algorithm: SubscriptionPlanVb365RemoteRepositorySpaceUsageAlgorithm | Unset = (
        SubscriptionPlanVb365RemoteRepositorySpaceUsageAlgorithm.CONSUMED
    )
    ...
    hosted_subscription_user_price: float | Unset = 0.0
    hosted_free_subscription_users: int | Unset = 0
    hosted_educational_user_price: float | Unset = 0.0
    hosted_free_educational_users: int | Unset = 0
    hosted_round_up_used_space: bool | Unset = False
    hosted_standard_storage_used_space_price: float | Unset = 0.0
    hosted_standard_storage_used_space_chunk_size: int | Unset = 1
    hosted_standard_storage_used_space_units: SubscriptionPlanVb365HostedStandardStorageUsedSpaceUnits | Unset = (
        SubscriptionPlanVb365HostedStandardStorageUsedSpaceUnits.GB
    )
    ...
    hosted_archive_storage_used_space_price: float | Unset = 0.0
    hosted_archive_storage_used_space_chunk_size: int | Unset = 1
    hosted_archive_storage_used_space_units: SubscriptionPlanVb365HostedArchiveStorageUsedSpaceUnits | Unset = (
        SubscriptionPlanVb365HostedArchiveStorageUsedSpaceUnits.GB
    )
    ...
    hosted_repository_space_usage_algorithm: SubscriptionPlanVb365HostedRepositorySpaceUsageAlgorithm | Unset = (
        SubscriptionPlanVb365HostedRepositorySpaceUsageAlgorithm.CONSUMED
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        remote_standard_storage_used_space_units: str | Unset = UNSET
        ...
        remote_archive_storage_used_space_units: str | Unset = UNSET
        ...
        hosted_standard_storage_used_space_units: str | Unset = UNSET
        ...
        hosted_archive_storage_used_space_units: str | Unset = UNSET
