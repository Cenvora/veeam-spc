...
class IdentityProviderRoleMappingRuleEmbedded:
    ...
    Attributes:
        provider_info (IdentityProvider | Unset):  Example: {'name': 'adfs', 'displayName': 'Microsoft Entra ID
            Federation Services', 'template': 'ADFS', 'type': 'SAML2', 'organizationUid':
            '0242e3ca-1cc2-4d90-8285-0e7a9b375418', 'enabled': True}.
    """

    provider_info: IdentityProvider | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        provider_info: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_info: IdentityProvider | Unset
