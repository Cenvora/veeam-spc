...
class ConsoleLicense:
    ...
    Attributes:
        ...
        package (ConsoleLicensePackage | Unset): Product packages.
        licensee_company (str | Unset): Name of an organization to which a license is issued.
        licensee_email (str | Unset): Email address of a contact person in an organization.
    ...
    package: ConsoleLicensePackage | Unset = UNSET
    licensee_company: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_update_status: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        package: ConsoleLicensePackage | Unset
        ...
        status: ConsoleLicenseStatus | Unset
        ...
        cloud_connect: ConsoleLicenseCloudConnect | Unset
        ...
        type_: ConsoleLicenseType | Unset
        ...
        last_update_status: ConsoleLicenseLastUpdateStatus | Unset
