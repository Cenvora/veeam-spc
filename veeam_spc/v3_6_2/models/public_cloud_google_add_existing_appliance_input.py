...
class PublicCloudGoogleAddExistingApplianceInput:
    ...
    Attributes:
        ...
        network (None | PublicCloudGoogleAddExistingApplianceInputNetworkType0 | Unset): Veeam Backup for Google Cloud
    ...
    virtual_machine: PublicCloudGoogleAddExistingApplianceInputVirtualMachine
    guest_os_credentials: PublicCloudGoogleAddExistingApplianceInputGuestOsCredentials
    network: None | PublicCloudGoogleAddExistingApplianceInputNetworkType0 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_network(data: object) -> None | PublicCloudGoogleAddExistingApplianceInputNetworkType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | PublicCloudGoogleAddExistingApplianceInputNetworkType0 | Unset, data)
