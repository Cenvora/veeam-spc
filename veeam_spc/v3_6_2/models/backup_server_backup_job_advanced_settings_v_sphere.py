...
class BackupServerBackupJobAdvancedSettingsVSphere:
    ...
    Attributes:
        ...
        changed_block_tracking (BackupServerVSphereChangedBlockTrackingSettings | Unset): Changed block tracking
            settings.
    """

    enable_vm_ware_tools_quiescence: bool | Unset = False
    changed_block_tracking: BackupServerVSphereChangedBlockTrackingSettings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        changed_block_tracking: BackupServerVSphereChangedBlockTrackingSettings | Unset
