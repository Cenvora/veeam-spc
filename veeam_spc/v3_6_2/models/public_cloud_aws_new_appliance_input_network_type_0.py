...
class PublicCloudAwsNewApplianceInputNetworkType0:
    ...
    >If you send the `null` value, all required resources will be created automatically.'
        ...
        Attributes:
            ...
            security_group_id (None | str | Unset): ID assigned to a protection group. Specify the `null` value to create a
                new security group.
    """

    network_id: str
    subnet_id: str
    security_group_id: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        security_group_id: None | str | Unset
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_security_group_id(data: object) -> None | str | Unset:
            if data is None:
                return data
